...
fn test_grm_calculation() {
    // 4 samples, 3 markers
    let genotypes = vec![0, 1, 2, 1, 1, 1, 2, 1, 0, 1, 2, 1];
...
#[wasm_bindgen_test]
fn test_diversity() {
    let genotypes = vec![0, 1, 2, 1, 1, 1, 1, 2, 2, 0, 1, 1];
...
#[wasm_bindgen_test]
fn test_pca() {
    let genotypes = vec![0, 1, 2, 1, 0, 1, 1, 1, 2, 1, 2, 0, 1, 1, 2, 1, 2, 0, 1, 1];
...
fn test_selection_index() {
    ...
    let traits = vec![100.0, 50.0, 110.0, 45.0, 95.0, 55.0];
