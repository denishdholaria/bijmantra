...
int compute_blup(
    ...
    (void)y; (void)x; (void)z; (void)a_inv; (void)var_a; (void)var_e;
...
int compute_grm_vanraden2(
    ...
    (void)genotypes; (void)g; (void)n; (void)m;
...
int compute_dominance_matrix(
    ...
    (void)genotypes; (void)d; (void)n; (void)m;
...
int reml_estimate(
    ...
    (void)y; (void)x; (void)z; (void)a; (void)method; (void)max_iter; (void)tol;
