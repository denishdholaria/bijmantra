...
class SearchService {
  ...
  private async _buildIndex(): Promise<void> {
    ...
    this.index.pages = [
      ...
      { id: 'seedlots', title: 'Seed Lots', path: '/seedlots', type: 'page', icon: 'package', keywords: ['inventory'] },
      ...
      // AI
      { id: 'ai-assistant', title: 'REEVU', path: '/ai-assistant', type: 'page', icon: '💬', keywords: ['chat', 'help', 'ai assistant', 'reevu'] },
