...
class APIClient {
  ...
  async getProgram(programDbId: string) {
    return this.request<BrAPIResponse<any>>(
  ...
  async getCrossStats() {
    return this.request<BrAPIResponse<any>>("/brapi/v2/crosses/stats");
  }
  ...
  async uploadImageFile(file: File) {
    ...
    return this.request<BrAPIResponse<{ imageURL: string }>>('/brapi/v2/images/upload', {
      method: 'POST',
      body: formData,
    })
  }
  ...
  async getQCCertificates() {
    return this.request<{ certificates: any[] }>(
  ...
  async getTraceabilityTransfers() {
    return this.request<{ status: string; data: any[]; count: number }>(
  ...
  async submitDispatch(dispatchId: string) {
    return this.request<any>(`/api/v2/dispatch/orders/${dispatchId}/submit`, {
      method: "POST",
    });
  }
  ...
  async markDispatchDelivered(dispatchId: string, notes: string = "") {
    return this.request<any>(
      `/api/v2/dispatch/orders/${dispatchId}/deliver?notes=${encodeURIComponent(notes)}`,
      { method: "POST" },
    );
  }
  ...
  async cancelDispatch(dispatchId: string, reason: string) {
    return this.request<any>(
      `/api/v2/dispatch/orders/${dispatchId}/cancel?reason=${encodeURIComponent(reason)}`,
      { method: "POST" },
    );
  }
  ...
  async holdBatch(batchId: string, reason: string) {
    return this.request<any>(
      `/api/v2/processing/batches/${batchId}/hold?reason=${encodeURIComponent(reason)}`,
      { method: "POST" },
    );
  }

  async resumeBatch(batchId: string) {
    return this.request<any>(`/api/v2/processing/batches/${batchId}/resume`, {
      method: "POST",
    });
  }
  ...
  async rejectBatch(batchId: string, reason: string) {
    return this.request<any>(
      `/api/v2/processing/batches/${batchId}/reject?reason=${encodeURIComponent(reason)}`,
      { method: "POST" },
    );
  }
  ...
  async terminateLicense(licenseId: string, reason: string) {
    return this.request<any>(
      `/api/v2/licensing/licenses/${licenseId}/terminate?reason=${encodeURIComponent(reason)}`,
      {
        method: "PUT",
      },
    );
  ...
  async createVariantSet(data: {
    ...
    return this.request<any>("/api/v2/genotyping/variantsets", {
      method: "POST",
      body: JSON.stringify(data),
    });
  }
  ...
  async getVendorOrders(params?: {
    ...
    return this.request<any>(
      `/api/v2/genotyping/vendor/orders?${searchParams}`,
    );
  }
  ...
  async createVendorOrder(data: {
    ...
    return this.request<any>("/api/v2/genotyping/vendor/orders", {
      method: "POST",
      body: JSON.stringify(data),
    });
  }
  ...
  async updateVendorOrderStatus(vendorOrderDbId: string, status: string) {
    return this.request<any>(
      `/api/v2/genotyping/vendor/orders/${vendorOrderDbId}/status`,
  ...
  async createPlannedCross(data: {
    ...
    return this.request<any>("/api/v2/crossing-planner", {
      method: "POST",
      body: JSON.stringify(data),
    });
  }
  ...
  async updatePlannedCrossStatus(
    ...
    return this.request<any>(`/api/v2/crossing-planner/${crossId}/status`, {
      method: "PUT",
  ...
  async createField(data: {
    ...
    return this.request<any>("/api/v2/field-map", {
      method: "POST",
      body: JSON.stringify(data),
    });
  }
  ...
  async getFieldPlots(
    fieldId: string,
    params?: { status?: string; trialId?: string },
  ) {
    const searchParams = new URLSearchParams();
    if (params?.status) searchParams.append("status", params.status);
    if (params?.trialId) searchParams.append("trial_id", params.trialId);
    return this.request<any>(
      `/api/v2/field-map/${fieldId}/plots?${searchParams}`,
    );
  }

  async updateFieldPlot(
    fieldId: string,
    plotId: string,
    data: Record<string, any>,
  ) {
    return this.request<any>(`/api/v2/field-map/${fieldId}/plots/${plotId}`, {
      method: "PUT",
      body: JSON.stringify(data),
    });
  }
  ...
  async createPlannedTrial(data: {
    ...
    return this.request<any>("/api/v2/trial-planning", {
      method: "POST",
      body: JSON.stringify(data),
    });
  }
  ...
  async approvePlannedTrial(trialId: string, approvedBy: string) {
    return this.request<any>(
      `/api/v2/trial-planning/${trialId}/approve?approved_by=${encodeURIComponent(approvedBy)}`,
      { method: "POST" },
    );
  }

  async startPlannedTrial(trialId: string) {
    return this.request<any>(`/api/v2/trial-planning/${trialId}/start`, {
      method: "POST",
    });
  }

  async completePlannedTrial(trialId: string) {
    return this.request<any>(`/api/v2/trial-planning/${trialId}/complete`, {
      method: "POST",
    });
  }
  ...
  async cancelPlannedTrial(trialId: string, reason: string) {
    return this.request<any>(
      `/api/v2/trial-planning/${trialId}/cancel?reason=${encodeURIComponent(reason)}`,
      { method: "POST" },
    );
  }
  ...
  async createQualityIssue(data: {
    ...
    return this.request<any>("/api/v2/data-quality/issues", {
      method: "POST",
      body: JSON.stringify(data),
    });
  }
  ...
  async resolveQualityIssue(
    ...
    return this.request<any>(`/api/v2/data-quality/issues/${issueId}/resolve`, {
      method: "POST",
  ...
  async ignoreQualityIssue(issueId: string, reason: string) {
    return this.request<any>(
      `/api/v2/data-quality/issues/${issueId}/ignore?reason=${encodeURIComponent(reason)}`,
      { method: "POST" },
    );
  }

  async reopenQualityIssue(issueId: string) {
    return this.request<any>(`/api/v2/data-quality/issues/${issueId}/reopen`, {
      method: "POST",
    });
  }
  ...
  async runDataValidation(entity?: string) {
    ...
    return this.request<any>(`/api/v2/data-quality/validate${params}`, {
      method: "POST",
    });
  }
  ...
  async getValidationHistory(limit?: number) {
    ...
    return this.request<any>(
      `/api/v2/data-quality/validation-history${params}`,
    );
  }
  ...
  async createQualityRule(data: {
    ...
    return this.request<any>("/api/v2/data-quality/rules", {
      method: "POST",
      body: JSON.stringify(data),
    });
  }
  ...
  async toggleQualityRule(ruleId: string, enabled: boolean) {
    return this.request<any>(
      `/api/v2/data-quality/rules/${ruleId}/toggle?enabled=${enabled}`,
      { method: "PUT" },
    );
  }
  ...
  async calculateLD(data: {
    ...
    return this.request<any>("/api/v2/gwas/ld", {
      method: "POST",
      body: JSON.stringify(data),
    });
  }
  ...
  async ldPruning(data: {
    ...
    return this.request<any>("/api/v2/gwas/ld/pruning", {
      method: "POST",
      body: JSON.stringify(data),
    });
  }
  ...
  async getTrialNetworkSites(params?: {
    season?: string;
    status?: string;
    country?: string;
    region?: string;
  ...
  async compareTrialNetworkSites(siteIds: string[]) {
    return this.request<any>("/api/v2/trial-network/compare", {
      method: "POST",
  ...
  async searchGermplasmAdvanced(params?: {
    query?: string;
    species?: string;
    origin?: string;
    collection?: string;
  ...
  async getMolecularBreedingSchemes(params?: {
    scheme_type?: string;
    status?: string;
  }) {
    const searchParams = new URLSearchParams();
  ...
  async getMolecularBreedingLines(params?: {
    scheme_id?: string;
  ...
  async updateCalendarEventStatus(eventId: string, status: string) {
    return this.request<any>(
      `/api/v2/resources/calendar/${eventId}/status?status=${status}`,
      {
        method: "PATCH",
      },
    );
  ...
  async getCrossingPlannerCross(crossId: string) {
    return this.request<{ metadata: any; result: any }>(
      `/api/v2/crossing-planner/${crossId}`,
    );
  }
  ...
  async updateCrossingPlannerStatus(
    crossId: string,
    status: string,
    actualProgeny?: number,
  ) {
  ...
  async getDefaultWeights() {
    return this.request<{ status: string; data: Record<string, number> }>(
  ...
  async createVariant(data: any) {
    return this.request<BrAPIResponse<any>>("/brapi/v2/variants", {
      method: "POST",
      body: JSON.stringify(data),
    });
  }
  ...
  async createMap(data: any) {
    return this.request<BrAPIResponse<any>>("/brapi/v2/maps", {
      method: "POST",
      body: JSON.stringify(data),
    });
  }
  ...
  async getMethods(params?: {
    ...
    const searchParams = new URLSearchParams();
    if (params?.methodDbId)
      searchParams.append("methodDbId", params.methodDbId);
    if (params?.methodClass)
      searchParams.append("methodClass", params.methodClass);
    if (params?.methodName)
      searchParams.append("methodName", params.methodName);
  ...
  async deleteScale(scaleDbId: string) {
    return this.request(`/brapi/v2/scales/${scaleDbId}`, {
      method: "DELETE",
    });
  }
  ...
  async getObservationLevels(params?: {
    ...
    if (params?.pageSize)
      searchParams.append("pageSize", String(params.pageSize));
    return this.request<BrAPIListResponse<any>>(
      `/brapi/v2/observationlevels?${searchParams}`,
    );
  }
  ...
  async getObservationsTable(params?: {
    ...
    const searchParams = new URLSearchParams();
    if (params?.studyDbId) searchParams.append("studyDbId", params.studyDbId);
    params?.observationUnitDbId?.forEach((id) =>
      searchParams.append("observationUnitDbId", id),
    );
    params?.observationVariableDbId?.forEach((id) =>
      searchParams.append("observationVariableDbId", id),
    );
    params?.germplasmDbId?.forEach((id) =>
      searchParams.append("germplasmDbId", id),
    );
    return this.request<BrAPIResponse<any>>(
      `/brapi/v2/observations/table?${searchParams}`,
    );
  }
  ...
  async getObservationUnitsTable(params?: {
    ...
    if (params?.observationLevel)
      searchParams.append("observationLevel", params.observationLevel);
    return this.request<BrAPIResponse<any>>(
      `/brapi/v2/observationunits/table?${searchParams}`,
    );
  }
  ...
  async getSeedlotTransactions(params?: {
    ...
    const searchParams = new URLSearchParams();
    if (params?.seedLotDbId)
      searchParams.append("seedLotDbId", params.seedLotDbId);
    if (params?.transactionDbId)
      searchParams.append("transactionDbId", params.transactionDbId);
    if (params?.germplasmDbId)
      searchParams.append("germplasmDbId", params.germplasmDbId);
    if (params?.page !== undefined)
      searchParams.append("page", String(params.page));
    if (params?.pageSize)
      searchParams.append("pageSize", String(params.pageSize));
    return this.request<BrAPIListResponse<any>>(
      `/brapi/v2/seedlots/transactions?${searchParams}`,
    );
  }

  async getSeedlotTransactionsById(
    seedLotDbId: string,
    params?: { page?: number; pageSize?: number },
  ) {
    const searchParams = new URLSearchParams();
    ...
    if (params?.pageSize)
      searchParams.append("pageSize", String(params.pageSize));
    return this.request<BrAPIListResponse<any>>(
      `/brapi/v2/seedlots/${seedLotDbId}/transactions?${searchParams}`,
    );
  }
  ...
  async brapiSearch(entity: string, searchRequest: any) {
    return this.request<BrAPIResponse<{ searchResultsDbId: string }>>(
      `/brapi/v2/search/${entity}`,
      {
        method: "POST",
        body: JSON.stringify(searchRequest),
      },
  ...
  async getBrAPIVendorOrders(params?: {
    orderId?: string;
    submissionId?: string;
    page?: number;
    pageSize?: number;
    ...
    if (params?.pageSize)
      searchParams.append("pageSize", String(params.pageSize));
    return this.request<BrAPIListResponse<any>>(
      `/brapi/v2/vendor/orders?${searchParams}`,
    );
  }
  ...
  async getBrAPIVendorOrderStatus(orderId: string) {
    return this.request<BrAPIResponse<any>>(
      `/brapi/v2/vendor/orders/${orderId}/status`,
    );
  }
  ...
  async getBrAPIVendorPlateSubmission(submissionId: string) {
    return this.request<BrAPIResponse<any>>(
      `/brapi/v2/vendor/plates/${submissionId}`,
    );
  }
  ...
  async deleteBrAPIImages(imageDbIds: string[]) {
    return this.request<BrAPIResponse<{ deletedImageDbIds: string[] }>>(
      "/brapi/v2/delete/images",
      {
        method: "POST",
  ...
  async deleteBrAPIObservations(observationDbIds: string[]) {
    return this.request<BrAPIResponse<{ deletedObservationDbIds: string[] }>>(
      "/brapi/v2/delete/observations",
      {
        method: "POST",
  ...
  async getFieldScans(params?: {
    ...
    return this.request<{ scans: any[]; total: number }>(
  ...
  async exportFieldScans(format: "json" | "csv" = "json", studyId?: string) {
    ...
    return this.request<{ format: string; data: any[]; count: number }>(
      `/api/v2/field-scanner/export?${params}`,
    );
  }

  async getPlotScanHistory(plotId: string) {
    return this.request<{ plot_id: string; scans: any[]; total: number }>(
      `/api/v2/field-scanner/plot/${plotId}/history`,
    );
  }
  ...
  async getLabelTemplates(labelType?: string) {
    ...
    return this.request<{ templates: any[]; total: number }>(
  ...
  async getLabelData(
    ...
    if (params?.limit) searchParams.append("limit", String(params.limit));
    return this.request<{ data: any[]; total: number; source_type: string }>(
  ...
  async getQuickEntryOptions(optionType: string) {
    return this.request<{ options: any[]; type: string }>(
  ...
  async getPhenologyRecords(params?: {
    ...
    if (params?.offset) searchParams.append("offset", String(params.offset));
    const query = searchParams.toString();
    return this.request<{ records: any[]; total: number }>(
  ...
  async getPhenologyObservations(recordId: string) {
    return this.request<{ observations: any[]; total: number }>(
      `/api/v2/phenology/records/${recordId}/observations`,
    );
  }
  ...
  async getPlotHistoryPlots(params?: {
    ...
    if (params?.offset) searchParams.append("offset", String(params.offset));
    const query = searchParams.toString();
    return this.request<{ plots: any[]; total: number }>(
  ...
  async getStatisticsTrials() {
    return this.request<{ trials: any[]; total: number }>(
      "/api/v2/statistics/trials",
    );
  }

  async getStatisticsTraits() {
    return this.request<{ traits: any[]; total: number }>(
  ...
  async getStatisticsCorrelations(params?: {
    trial_id?: string;
    trait_ids?: string;
  }) {
    const searchParams = new URLSearchParams();
  ...
  async getCrossingProjects(params?: {
    programDbId?: string;
    commonCropName?: string;
    page?: number;
    pageSize?: number;
    ...
    return this.request<{
      ...
      metadata: { pagination: { totalCount: number } };
  ...
  async updateCrossingProject(
    ...
    return this.request<{
      result: { crossingProjectDbId: string; crossingProjectName: string };
    }>(`/brapi/v2/crossingprojects/${crossingProjectDbId}`, {
      method: "PUT",
      body: JSON.stringify(data),
    });
  ...
  async getGermplasmAttributes(params?: {
    ...
    if (params?.attributeCategory)
      searchParams.append("attributeCategory", params.attributeCategory);
    if (params?.page !== undefined)
      searchParams.append("page", params.page.toString());
    if (params?.pageSize)
      searchParams.append("pageSize", params.pageSize.toString());
  ...
  async getAttributeCategories() {
    return this.request<{ result: { data: string[] } }>(
  ...
  async createGermplasmAttribute(data: {
    ...
    return this.request<{
      result: { data: Array<{ attributeDbId: string; attributeName: string }> };
    }>("/brapi/v2/attributes", {
      method: "POST",
      body: JSON.stringify([data]),
    });
  ...
  async predictCrossBreedingValue(data: {
    ...
    }>("/api/v2/breeding-value/predict-cross", {
      method: "POST",
      body: JSON.stringify(data),
    });
  }
  ...
  async rankBreedingCandidates(data: {
    ...
    }>("/api/v2/breeding-value/rank-candidates", {
      method: "POST",
      body: JSON.stringify(data),
    });
  }
  ...
  async listBreedingValueAnalyses() {
    return this.request<{
      ...
      count: number;
    }>("/api/v2/breeding-value/analyses");
  }
  ...
  async getBreedingValueAnalysis(analysisId: string) {
    ...
    }>(`/api/v2/breeding-value/analyses/${analysisId}`);
  }

  // ============ PHENOTYPE ANALYSIS API ============

  async getPhenotypeStats(data: { values: number[]; trait_name?: string }) {
    return this.request<{
      status: string;
      data: {
        mean: number;
  ...
  async calculateGeneticCorrelation(data: {
    ...
    return this.request<{
      status: string;
      data: { correlation: number; p_value: number; interpretation: string };
    }>("/api/v2/phenotype/correlation", {
      method: "POST",
      body: JSON.stringify(data),
    });
  }
  ...
  async calculateSelectionResponse(data: {
    ...
    return this.request<{
      status: string;
      data: { response: number; percent_gain: number };
    }>("/api/v2/phenotype/selection-response", {
      method: "POST",
      body: JSON.stringify(data),
    });
  }
  ...
  async getPhenotypeMethods() {
    ...
    }>("/api/v2/phenotype/methods");
  }

  // ============ PHENOTYPE COMPARISON API ============

  async getGermplasmForComparison(params?: {
    program_id?: string;
    trial_id?: string;
    limit?: number;
  }) {
    ...
    if (params?.program_id)
      searchParams.append("programDbId", params.program_id);
  ...
  async getObservationsForGermplasm(germplasmDbIds: string[]) {
    ...
    }>(`/brapi/v2/search/observations/${searchId.result.searchResultsDbId}`);
  }
  ...
  async getTraitsForComparison() {
    ...
    }>("/brapi/v2/variables?pageSize=100");
  }
  ...
  async getFieldPlotData(params: {
    ...
    }>(`/brapi/v2/observationunits${query ? `?${query}` : ""}`);
  }
  ...
  async getChatStatus(): Promise<{
    ...
    providers: Record<
      string,
      { available: boolean; model: string; configured: boolean }
    >;
  }> {
...
class VisionAPI {
  ...
  async getCrops() {
    return fetch("/api/v2/vision/crops").then((r) => r.json()) as Promise<{
      success: boolean;
      crops: Array<{
        code: string;
        name: string;
  ...
  async getModels(params?: { crop?: string; task?: string; status?: string }) {
    ...
    if (params?.status) searchParams.append("status", params.status);
    const query = searchParams.toString();
    return fetch(`/api/v2/vision/models${query ? `?${query}` : ""}`).then((r) =>
      r.json(),
    ) as Promise<{ success: boolean; count: number; models: any[] }>;
  }
  ...
  async getDatasets(params?: { crop?: string; status?: string }) {
    ...
    if (params?.status) searchParams.append("status", params.status);
    const query = searchParams.toString();
    return fetch(`/api/v2/vision/datasets${query ? `?${query}` : ""}`).then(
      (r) => r.json(),
    ) as Promise<{ success: boolean; count: number; datasets: any[] }>;
  }
}
...
class DiseaseAPI {
  async getDiseases(params?: { crop?: string; disease_type?: string }) {
    const searchParams = new URLSearchParams();
    if (params?.crop) searchParams.append("crop", params.crop);
    if (params?.disease_type)
      searchParams.append("disease_type", params.disease_type);
    const query = searchParams.toString();
    return fetch(`/api/v2/disease/diseases${query ? `?${query}` : ""}`).then(
      (r) => r.json(),
    ) as Promise<{ status: string; data: any[]; count: number }>;
  }

  async getDisease(diseaseId: string) {
    return fetch(`/api/v2/disease/diseases/${diseaseId}`).then((r) =>
      r.json(),
    ) as Promise<{ status: string; data: any }>;
  }

  async getStatistics() {
    return fetch("/api/v2/disease/statistics").then((r) =>
      r.json(),
    ) as Promise<{ status: string; data: any }>;
  }
  ...
  async getGenes(params?: { disease_id?: string; gene_type?: string }) {
    ...
    if (params?.disease_id)
      searchParams.append("disease_id", params.disease_id);
    if (params?.gene_type) searchParams.append("gene_type", params.gene_type);
    const query = searchParams.toString();
    return fetch(`/api/v2/disease/genes${query ? `?${query}` : ""}`).then((r) =>
      r.json(),
    ) as Promise<{ status: string; data: any[]; count: number }>;
  }

  async getReactionScale() {
    return fetch("/api/v2/disease/reaction-scale").then((r) =>
      r.json(),
    ) as Promise<{ status: string; data: any }>;
  }
}
...
class CropHealthAPI {
  async getTrials(params?: {
    ...
    const query = searchParams.toString();
    return fetch(`/api/v2/crop-health/trials${query ? `?${query}` : ""}`).then(
      (r) => r.json(),
    ) as Promise<{ status: string; data: any[]; count: number }>;
  }

  async getTrial(trialId: string) {
    return fetch(`/api/v2/crop-health/trials/${trialId}`).then((r) =>
      r.json(),
    ) as Promise<{ status: string; data: any }>;
  }
  ...
  async getAlerts(params?: {
    ...
    if (params?.alert_type)
      searchParams.append("alert_type", params.alert_type);
    if (params?.acknowledged !== undefined)
      searchParams.append("acknowledged", String(params.acknowledged));
    if (params?.location) searchParams.append("location", params.location);
    const query = searchParams.toString();
    return fetch(`/api/v2/crop-health/alerts${query ? `?${query}` : ""}`).then(
      (r) => r.json(),
    ) as Promise<{
      status: string;
      data: any[];
  ...
  async acknowledgeAlert(
    alertId: string,
    data?: { acknowledged?: boolean; notes?: string },
  ) {
  ...
  async getSummary() {
    return fetch("/api/v2/crop-health/summary").then((r) =>
      r.json(),
    ) as Promise<{
      status: string;
      data: {
  ...
  async getTrends(days?: number) {
    ...
    return fetch(`/api/v2/crop-health/trends${query}`).then((r) =>
      r.json(),
    ) as Promise<{ status: string; data: any[]; period_days: number }>;
  }

  async getLocations() {
    return fetch("/api/v2/crop-health/locations").then((r) =>
      r.json(),
    ) as Promise<{ status: string; data: string[]; count: number }>;
  }

  async getCrops() {
    return fetch("/api/v2/crop-health/crops").then((r) => r.json()) as Promise<{
      status: string;
      data: string[];
      count: number;
    }>;
...
class NotificationsAPI {
  async getNotifications(params?: {
    ...
    if (params?.offset) searchParams.append("offset", String(params.offset));
    const query = searchParams.toString();
    return fetch(`/api/v2/notifications${query ? `?${query}` : ""}`).then((r) =>
      r.json(),
    ) as Promise<{
      status: string;
      data: Array<{
  ...
  async getUnreadCount() {
    return fetch("/api/v2/notifications/unread-count").then((r) =>
      r.json(),
    ) as Promise<{
      status: string;
      count: number;
  ...
  async getSummary() {
    return fetch("/api/v2/notifications/summary").then((r) =>
      r.json(),
    ) as Promise<{
      status: string;
      data: {
...
class YieldMapAPI {
  async getStudies(params?: {
    ...
    const query = searchParams.toString();
    return fetch(`/api/v2/yield-map/studies${query ? `?${query}` : ""}`).then(
      (r) => r.json(),
    );
  }
  ...
  async getFieldPlotData(params: {
    ...
    const query = searchParams.toString();
    return fetch(
      `/api/v2/yield-map/studies/${params.study_id}/plots${query ? `?${query}` : ""}`,
    ).then((r) => r.json());
  }
  ...
  async getStats(studyId: string): Promise<{
    ...
    return fetch(`/api/v2/yield-map/studies/${studyId}/stats`).then((r) =>
      r.json(),
    );
  }
  ...
  async getTraits(studyId: string): Promise<{
    ...
    return fetch(`/api/v2/yield-map/studies/${studyId}/traits`).then((r) =>
      r.json(),
    );
  }

  async getSpatialAnalysis(studyId: string): Promise<any> {
    return fetch(`/api/v2/yield-map/studies/${studyId}/spatial-analysis`).then(
      (r) => r.json(),
    );
  }
}
...
class DataValidationAPI {
  async getIssues(params?: {
    ...
    if (params?.offset) searchParams.append("offset", String(params.offset));
    const query = searchParams.toString();
    return fetch(`/api/v2/data-validation${query ? `?${query}` : ""}`).then(
      (r) => r.json(),
    ) as Promise<{
      status: string;
      data: Array<{
  ...
  async getStats() {
    return fetch("/api/v2/data-validation/stats").then((r) =>
      r.json(),
    ) as Promise<{
      status: string;
      data: {
  ...
  async getRules(enabled?: boolean) {
    ...
    return fetch(`/api/v2/data-validation/rules${query}`).then((r) =>
      r.json(),
    ) as Promise<{
      status: string;
      data: Array<{
  ...
  async exportReport(format?: string) {
    ...
    return fetch(`/api/v2/data-validation/export${query}`).then((r) =>
      r.json(),
    );
  }
}
...
class ProfileAPI {
  ...
  async getPreferences() {
    return fetch("/api/v2/profile/preferences").then((r) =>
      r.json(),
    ) as Promise<{
      status: string;
      data: {
  ...
  async revokeSession(sessionId: string) {
    return fetch(`/api/v2/profile/sessions/${sessionId}`, {
      method: "DELETE",
    }).then((r) => r.json());
  }
...
class TeamManagementAPI {
  async getMembers(params?: {
    ...
    if (params?.search) searchParams.append("search", params.search);
    const query = searchParams.toString();
    return fetch(`/api/v2/teams/members${query ? `?${query}` : ""}`).then((r) =>
      r.json(),
    ) as Promise<{
      status: string;
      data: Array<{
  ...
  async deleteTeam(teamId: string) {
    return fetch(`/api/v2/teams/${teamId}`, { method: "DELETE" }).then((r) =>
      r.json(),
    );
  }
  ...
  async resendInvite(inviteId: string) {
    return fetch(`/api/v2/teams/invites/${inviteId}/resend`, {
      method: "POST",
    }).then((r) => r.json());
  }

  async deleteInvite(inviteId: string) {
    return fetch(`/api/v2/teams/invites/${inviteId}`, {
      method: "DELETE",
    }).then((r) => r.json());
  }
...
class DataDictionaryAPI {
  async getEntities() {
    return fetch("/api/v2/data-dictionary/entities").then((r) =>
      r.json(),
    ) as Promise<{
      status: string;
      data: Array<{
  ...
  async getEntity(entityId: string) {
    return fetch(`/api/v2/data-dictionary/entities/${entityId}`).then((r) =>
      r.json(),
    ) as Promise<{
      status: string;
      data: {
  ...
  async searchFields(params?: { search?: string; entity?: string }) {
    ...
    const query = searchParams.toString();
    return fetch(
      `/api/v2/data-dictionary/fields${query ? `?${query}` : ""}`,
    ).then((r) => r.json());
  }
  ...
  async exportDictionary(format?: string) {
    const query = format ? `?format=${format}` : "";
    return fetch(`/api/v2/data-dictionary/export${query}`).then((r) =>
      r.json(),
    );
  }
}
...
class GermplasmCollectionAPI {
  async getCollections(params?: {
    ...
    if (params?.status) searchParams.append("status", params.status);
    const query = searchParams.toString();
    return fetch(`/api/v2/collections${query ? `?${query}` : ""}`).then((r) =>
      r.json(),
    ) as Promise<{
      status: string;
      data: Array<{
...
class CollaborationAPI {
  async getTeamMembers() {
    return fetch("/api/v2/collaboration/team-members").then((r) =>
      r.json(),
    ) as Promise<
      Array<{
        id: string;
  ...
  async getSharedItems(itemType?: string) {
    ...
    return fetch(`/api/v2/collaboration/shared-items${query}`).then((r) =>
      r.json(),
    ) as Promise<
      Array<{
        id: string;
  ...
  async getActivityFeed(limit?: number, offset?: number) {
    ...
    const query = params.toString();
    return fetch(
      `/api/v2/collaboration/activity${query ? `?${query}` : ""}`,
    ).then((r) => r.json()) as Promise<
      Array<{
        id: string;
        user: string;
  ...
  async getConversations() {
    return fetch("/api/v2/collaboration/conversations").then((r) =>
      r.json(),
    ) as Promise<
      Array<{
        id: string;
  ...
  async getMessages(conversationId: string, limit?: number, offset?: number) {
    ...
    const query = params.toString();
    return fetch(
      `/api/v2/collaboration/messages/${conversationId}${query ? `?${query}` : ""}`,
    ).then((r) => r.json()) as Promise<
      Array<{
        id: string;
        sender: string;
  ...
  async getStats() {
    return fetch("/api/v2/collaboration/stats").then((r) =>
      r.json(),
    ) as Promise<{
      team_members: number;
      online_now: number;
...
class OfflineSyncAPI {
  async getPendingChanges(status?: string) {
    const query = status ? `?status=${status}` : "";
    return fetch(`/api/v2/offline-sync/pending-changes${query}`).then((r) =>
      r.json(),
    ) as Promise<
      Array<{
        id: string;
  ...
  async getCachedData() {
    return fetch("/api/v2/offline-sync/cached-data").then((r) =>
      r.json(),
    ) as Promise<
      Array<{
        category: string;
  ...
  async getStats() {
    return fetch("/api/v2/offline-sync/stats").then((r) =>
      r.json(),
    ) as Promise<{
  ...
  async getSettings() {
    return fetch("/api/v2/offline-sync/settings").then((r) =>
      r.json(),
    ) as Promise<{
      auto_sync: boolean;
  ...
  async getStorageQuota() {
    return fetch("/api/v2/offline-sync/storage-quota").then((r) =>
      r.json(),
    ) as Promise<{
...
class SystemSettingsAPI {
  async getAllSettings() {
    return fetch("/api/v2/system-settings/all").then((r) =>
      r.json(),
    ) as Promise<{
      general: {
        site_name: string;
  ...
  async getSystemStatus() {
    return fetch("/api/v2/system-settings/status").then((r) =>
      r.json(),
    ) as Promise<{
      task_queue: {
        pending: number;
...
class BackupAPI {
  ...
  async getStats() {
    return fetch("/api/v2/backup/stats").then((r) =>
      r.json(),
    ) as Promise<BackupStats>;
  }
...
class WorkflowsAPI {
  async listWorkflows(params?: { status?: string; enabled?: boolean }) {
    ...
    const query = searchParams.toString();
    return fetch(`/api/v2/workflows${query ? `?${query}` : ""}`).then((r) =>
      r.json(),
    ) as Promise<{
      status: string;
      data: Workflow[];
  ...
  async getWorkflow(workflowId: string) {
    return fetch(`/api/v2/workflows/${workflowId}`).then((r) =>
      r.json(),
    ) as Promise<{
      status: string;
      data: Workflow;
  ...
  async getWorkflowRuns(params?: {
    ...
    const query = searchParams.toString();
    return fetch(
      `/api/v2/workflows/runs/history${query ? `?${query}` : ""}`,
    ).then((r) => r.json()) as Promise<{
      status: string;
      data: WorkflowRun[];
      total: number;
  ...
  async listTemplates() {
    return fetch("/api/v2/workflows/templates/list").then((r) =>
      r.json(),
    ) as Promise<{
      status: string;
  ...
  async useTemplate(templateId: string, name: string) {
    return fetch(
      `/api/v2/workflows/templates/${templateId}/use?name=${encodeURIComponent(name)}`,
      {
        method: "POST",
      },
    ).then((r) => r.json()) as Promise<{
...
class LanguagesAPI {
  async listLanguages(enabledOnly: boolean = false) {
    ...
    return fetch(`/api/v2/languages?${params}`).then((r) =>
      r.json(),
    ) as Promise<{
      status: string;
      data: Language[];
  ...
  async getLanguage(languageCode: string) {
    return fetch(`/api/v2/languages/${languageCode}`).then((r) =>
      r.json(),
    ) as Promise<{
      status: string;
      data: Language;
  ...
  async listTranslationKeys(params?: {
    ...
    const query = searchParams.toString();
    return fetch(
      `/api/v2/languages/translations/keys${query ? `?${query}` : ""}`,
    ).then((r) => r.json()) as Promise<{
      status: string;
      data: TranslationKey[];
      total: number;
  ...
  async createTranslationKey(key: string, enValue: string) {
    return fetch(
      `/api/v2/languages/translations/keys?key=${encodeURIComponent(key)}&en_value=${encodeURIComponent(enValue)}`,
      {
        method: "POST",
      },
    ).then((r) => r.json()) as Promise<{
...
class CollaborationHubAPI {
  ...
  async createWorkspace(
    ...
    return fetch(`/api/v2/collaboration-hub/workspaces?${params}`, {
      method: "POST",
    }).then((r) => r.json());
  }
  ...
  async getActivities(
    ...
    return fetch(`/api/v2/collaboration-hub/activities?limit=${limit}`).then(
      (r) => r.json(),
    );
  }
  ...
  async createTask(
    ...
    if (description) params.append("description", description);
    if (priority) params.append("priority", priority);
    return fetch(`/api/v2/collaboration-hub/tasks?${params}`, {
      method: "POST",
    }).then((r) => r.json());
  }
  ...
  async updateTask(
    ...
    return fetch(`/api/v2/collaboration-hub/tasks/${taskId}?${params}`, {
      method: "PATCH",
    }).then((r) => r.json());
  }
...
class AnalyticsAPI {
  ...
  async getGeneticGain(
    programId?: string,
  ): Promise<{ data: GeneticGainData[] }> {
    const params = programId ? `?program_id=${programId}` : "";
    return fetch(`/api/v2/analytics/genetic-gain${params}`).then((r) =>
      r.json(),
    );
  }

  async getHeritabilities(
    trialId?: string,
  ): Promise<{ data: HeritabilityData[] }> {
    const params = trialId ? `?trial_id=${trialId}` : "";
    return fetch(`/api/v2/analytics/heritabilities${params}`).then((r) =>
      r.json(),
    );
  }
  ...
  async getCorrelations(
    traitIds?: string[],
  ): Promise<{ data: CorrelationMatrix }> {
    const params = traitIds?.length ? `?trait_ids=${traitIds.join(",")}` : "";
    return fetch(`/api/v2/analytics/correlations${params}`).then((r) =>
      r.json(),
    );
  }

  async getSelectionResponse(
    programId?: string,
  ): Promise<{ data: SelectionResponseData[] }> {
    const params = programId ? `?program_id=${programId}` : "";
    return fetch(`/api/v2/analytics/selection-response${params}`).then((r) =>
      r.json(),
    );
  }
  ...
  async computeGBLUP(params: {
    ...
    return fetch(`/api/v2/analytics/compute/gblup?${query}`, {
      method: "POST",
    }).then((r) => r.json());
  }
...
class ReportsAPI {
  ...
  async createSchedule(
    ...
    return fetch(`/api/v2/reports/schedules?${params}`, {
      method: "POST",
    }).then((r) => r.json());
  }
  ...
  async toggleSchedule(
    ...
    return fetch(`/api/v2/reports/schedules/${scheduleId}?enabled=${enabled}`, {
      method: "PATCH",
    }).then((r) => r.json());
  }

  async runSchedule(scheduleId: string): Promise<GeneratedReport> {
    return fetch(`/api/v2/reports/schedules/${scheduleId}/run`, {
      method: "POST",
    }).then((r) => r.json());
  }

  async deleteSchedule(scheduleId: string): Promise<void> {
    return fetch(`/api/v2/reports/schedules/${scheduleId}`, {
      method: "DELETE",
    }).then(() => {});
  }
}
...
class DataSyncAPI {
  ...
  async sync(
    action: string = "full_sync",
  ): Promise<{ status: string; message: string }> {
    return fetch(`/api/v2/data-sync/sync?action=${action}`, {
      method: "POST",
    }).then((r) => r.json());
  }
  ...
  async upload(): Promise<{ status: string; uploaded: number }> {
    return fetch("/api/v2/data-sync/upload", { method: "POST" }).then((r) =>
      r.json(),
    );
  }

  async deletePending(itemId: string): Promise<void> {
    return fetch(`/api/v2/data-sync/pending/${itemId}`, {
      method: "DELETE",
    }).then(() => {});
  }

  async clearOfflineData(category: string): Promise<void> {
    return fetch(`/api/v2/data-sync/offline-data/${category}`, {
      method: "DELETE",
    }).then(() => {});
  }
  ...
  async updateSettings(settings: Partial<SyncSettings>): Promise<SyncSettings> {
    ...
    return fetch(`/api/v2/data-sync/settings?${params}`, {
      method: "PATCH",
    }).then((r) => r.json());
  }
}
...
class GeneticGainAPI {
  async getPrograms(): Promise<{
    data: GeneticGainBreedingProgram[];
    count: number;
  }> {
  ...
  async getProgram(
    programId: string,
  ): Promise<{ data: GeneticGainBreedingProgram }> {
    return fetch(`/api/v2/genetic-gain/programs/${programId}`).then((r) =>
      r.json(),
    );
  }
  ...
  ): Promise<{ data: GeneticGainCycleData }> {
  ...
  ): Promise<{ data: GeneticGainReleaseData }> {
  ...
  ): Promise<{ data: GeneticGainResult }> {
    return fetch(
...
class SpatialAPI {
  ...
  async getPlots(
    ...
    return fetch(`/api/v2/spatial/fields/${fieldId}/plots`).then((r) =>
      r.json(),
    );
  }
...
class PopulationGeneticsAPI {
  async getPopulations(
    ...
    const query = params.toString() ? `?${params}` : "";
    return fetch(`/api/v2/population-genetics/populations${query}`).then((r) =>
      r.json(),
    );
  }
  ...
  async getStructure(
    ...
    return fetch(`/api/v2/population-genetics/structure?${params}`).then((r) =>
      r.json(),
    );
  }
  ...
  async getPCA(populationIds?: string[]): Promise<PCAResult> {
    const params = populationIds?.length
      ...
      : "";
    return fetch(`/api/v2/population-genetics/pca${params}`).then((r) =>
      r.json(),
    );
  }
  ...
  async getFst(populationIds?: string[]): Promise<FstAnalysis> {
    const params = populationIds?.length
      ? `?population_ids=${populationIds.join(",")}`
      : "";
    return fetch(`/api/v2/population-genetics/fst${params}`).then((r) =>
      r.json(),
    );
  }
  ...
  async getMigration(populationIds?: string[]): Promise<MigrationAnalysis> {
    const params = populationIds?.length
      ? `?population_ids=${populationIds.join(",")}`
      : "";
    return fetch(`/api/v2/population-genetics/migration${params}`).then((r) =>
      r.json(),
    );
  }
...
class TrialNetworkAPI {
  async getSites(params?: {
    ...
    return fetch(`/api/v2/trial-network/sites${queryStr}`).then((r) =>
      r.json(),
    );
  }
  ...
  async getStatistics(season?: string): Promise<{ data: TrialNetworkStats }> {
    ...
    return fetch(`/api/v2/trial-network/statistics${query}`).then((r) =>
      r.json(),
    );
  }

  async getSharedGermplasm(
    minSites?: number,
    crop?: string,
  ): Promise<{ germplasm: SharedGermplasm[] }> {
    const params = new URLSearchParams();
    if (minSites) params.append("min_sites", String(minSites));
    if (crop) params.append("crop", crop);
    const query = params.toString() ? `?${params}` : "";
    return fetch(`/api/v2/trial-network/germplasm${query}`).then((r) =>
      r.json(),
    );
  }
  ...
  async getPerformance(
    ...
    return fetch(`/api/v2/trial-network/performance${query}`).then((r) =>
      r.json(),
    );
  }
...
class ProgenyAPI {
  ...
  async getProgeny(germplasmId: string): Promise<{ data: ProgenyItem[] }> {
    return fetch(`/api/v2/progeny/germplasm/${germplasmId}/progeny`).then((r) =>
      r.json(),
    );
  }
...
class ParentSelectionAPI {
  async getParents(params?: {
    ...
    if (params?.pageSize)
      queryParams.append("pageSize", String(params.pageSize));
    const query = queryParams.toString() ? `?${queryParams}` : "";
    return fetch(`/api/v2/parent-selection/parents${query}`).then((r) =>
      r.json(),
    );
  }

  async getParent(parentId: string): Promise<{ data: Parent }> {
    return fetch(`/api/v2/parent-selection/parents/${parentId}`).then((r) =>
      r.json(),
    );
  }
  ...
  async getRecommendations(params?: {
    ...
    if (params?.type) queryParams.append("type", params.type);
    const query = queryParams.toString() ? `?${queryParams}` : "";
    return fetch(`/api/v2/parent-selection/recommendations${query}`).then((r) =>
      r.json(),
    );
  }
...
class GeneticDiversityAPI {
  async getPopulations(params?: {
    crop?: string;
    region?: string;
  }): Promise<{ data: DiversityPopulation[] }> {
    const queryParams = new URLSearchParams();
    if (params?.crop) queryParams.append("crop", params.crop);
    if (params?.region) queryParams.append("region", params.region);
    const query = queryParams.toString() ? `?${queryParams}` : "";
    return fetch(`/api/v2/genetic-diversity/populations${query}`).then((r) =>
      r.json(),
    );
  }
  ...
  async getPopulation(
    ...
    return fetch(`/api/v2/genetic-diversity/populations/${populationId}`).then(
      (r) => r.json(),
    );
  }
  ...
  async getDistances(
    populationIds?: string[],
  ): Promise<{ data: DistanceMatrix[] }> {
    const query = populationIds?.length
      ? `?population_ids=${populationIds.join(",")}`
      : "";
    return fetch(`/api/v2/genetic-diversity/distances${query}`).then((r) =>
      r.json(),
    );
  }
  ...
  async getAMOVA(
    populationIds?: string[],
  ): Promise<{ data: { variance_components: AMOVAResult } }> {
    const query = populationIds?.length
      ? `?population_ids=${populationIds.join(",")}`
      : "";
    return fetch(`/api/v2/genetic-diversity/amova${query}`).then((r) =>
      r.json(),
    );
  }
  ...
  async getAdmixture(
    k?: number,
    populationIds?: string[],
  ): Promise<{ data: AdmixtureResult }> {
    const params = new URLSearchParams();
    if (k) params.append("k", String(k));
    if (populationIds?.length)
      params.append("population_ids", populationIds.join(","));
    const query = params.toString() ? `?${params}` : "";
    return fetch(`/api/v2/genetic-diversity/admixture${query}`).then((r) =>
      r.json(),
    );
  }
...
class GermplasmComparisonAPI {
  async listGermplasm(params?: {
    ...
    const query = searchParams.toString();
    return fetch(
      `/api/v2/germplasm-comparison${query ? `?${query}` : ""}`,
    ).then((r) => r.json());
  }

  async getGermplasm(germplasmId: string): Promise<ComparisonGermplasm> {
    return fetch(`/api/v2/germplasm-comparison/entry/${germplasmId}`).then(
      (r) => r.json(),
    );
  }
  ...
  async getMarkers(
    ...
    const query = crop ? `?crop=${crop}` : "";
    return fetch(`/api/v2/germplasm-comparison/markers${query}`).then((r) =>
      r.json(),
    );
  }
  ...
  async getStatistics(): Promise<{
    ...
    return fetch("/api/v2/germplasm-comparison/statistics").then((r) =>
      r.json(),
    );
  }
...
class BreedingPipelineAPI {
  ...
  async getStatistics(params?: {
    program_id?: string;
    crop?: string;
  }): Promise<{ data: PipelineStatistics }> {
    const queryParams = new URLSearchParams();
    if (params?.program_id) queryParams.append("program_id", params.program_id);
    if (params?.crop) queryParams.append("crop", params.crop);
    const query = queryParams.toString() ? `?${queryParams}` : "";
    return fetch(`/api/v2/breeding-pipeline/statistics${query}`).then((r) =>
      r.json(),
    );
  }

  async getStageSummary(): Promise<{
    data: Array<{
      stage_id: string;
      stage_name: string;
      order: number;
    ...
    return fetch("/api/v2/breeding-pipeline/stage-summary").then((r) =>
      r.json(),
    );
  }
...
class YieldPredictorAPI {
  async getPredictions(params?: {
    ...
    const query = queryParams.toString() ? `?${queryParams}` : "";
    return fetch(`/api/v2/genomic-selection/yield-predictions${query}`).then(
      (r) => r.json(),
    );
  }
...
class BreedingValueCalculatorAPI {
  async getIndividuals(
    trait?: string,
  ): Promise<{ data: BreedingValueIndividual[] }> {
    const query = trait ? `?trait=${trait}` : "";
    return fetch(`/api/v2/breeding-value/individuals${query}`).then((r) =>
      r.json(),
    );
  }
  ...
  async getAnalysis(
    ...
    return fetch(`/api/v2/breeding-value/analyses/${analysisId}`).then((r) =>
      r.json(),
    );
  }
}
...
class StabilityAnalysisAPI {
  async getVarieties(params?: {
    ...
    const query = searchParams.toString();
    return fetch(`/api/v2/stability/varieties${query ? `?${query}` : ""}`).then(
      (r) => r.json(),
    );
  }
  ...
  > {
    return fetch(`/api/v2/stability/varieties/${varietyId}`).then((r) =>
      r.json(),
    );
  }
...
class FieldBookAPI {
  ...
  async getStudyEntries(
    ...
    return fetch(`/api/v2/field-book/studies/${studyId}/entries`).then((r) =>
      r.json(),
    );
  }

  async getStudyTraits(
    studyId: string,
  ): Promise<{ success: boolean; study_id: string; traits: FieldBookTrait[] }> {
    return fetch(`/api/v2/field-book/studies/${studyId}/traits`).then((r) =>
      r.json(),
    );
  }
  ...
  async getProgress(
    ...
    return fetch(`/api/v2/field-book/studies/${studyId}/progress${query}`).then(
      (r) => r.json(),
    );
  }
  ...
  async getSummary(
    ...
    return fetch(`/api/v2/field-book/studies/${studyId}/summary`).then((r) =>
      r.json(),
    );
  }
...
class NurseryManagementAPI {
  async getNurseries(params?: {
    ...
    if (params?.status) searchParams.append("status", params.status);
    const query = searchParams.toString();
    return fetch(`/api/v2/nursery/nurseries${query ? `?${query}` : ""}`).then(
      (r) => r.json(),
    );
  }
  ...
  > {
    return fetch(`/api/v2/nursery/nurseries/${nurseryId}`).then((r) =>
      r.json(),
    );
  }
  ...
  async getSummary(
    ...
    return fetch(`/api/v2/nursery/nurseries/${nurseryId}/summary`).then((r) =>
      r.json(),
    );
  }
...
class SeedInventoryEnhancedAPI {
  async getLots(params?: {
    ...
    const query = searchParams.toString();
    return fetch(`/api/v2/seed-inventory/lots${query ? `?${query}` : ""}`).then(
      (r) => r.json(),
    );
  }
  ...
  async getViabilityHistory(
    ...
    return fetch(`/api/v2/seed-inventory/viability/${lotId}`).then((r) =>
      r.json(),
    );
  }
...
class SeedlingBatchAPI {
  ...
  async getBatch(
    ...
    return fetch(`/api/v2/nursery-management/batches/${batchId}`).then((r) =>
      r.json(),
    );
  }
...
class AbioticStressAPI {
  ...
  async getStressType(stressId: string): Promise<StressType> {
    return fetch(`/api/v2/abiotic/stress-types/${stressId}`).then((r) =>
      r.json(),
    );
  }
  ...
  async getGenes(params?: {
    ...
    if (params?.search) searchParams.set("search", params.search);
    const query = searchParams.toString();
    return fetch(`/api/v2/abiotic/genes${query ? `?${query}` : ""}`).then((r) =>
      r.json(),
    );
  }
...
class FieldMapAPI {
  async getFields(params?: {
    ...
    if (params?.search) searchParams.set("search", params.search);
    const query = searchParams.toString();
    return fetch(`/api/v2/field-map/fields${query ? `?${query}` : ""}`).then(
      (r) => r.json(),
    );
  }
  ...
  async getPlot(fieldId: string, plotId: string): Promise<Plot> {
    return fetch(`/api/v2/field-map/fields/${fieldId}/plots/${plotId}`).then(
      (r) => r.json(),
    );
  }
  ...
  async deleteAttribute(attributeDbId: string): Promise<void> {
...
class TrialPlanningAPI {
  ...
  async getTrial(trialId: string): Promise<PlannedTrial> {
    return fetch(`/api/v2/trial-planning/trials/${trialId}`).then((r) =>
      r.json(),
    );
  }
  ...
  async approveTrial(
    ...
    return fetch(
      `/api/v2/trial-planning/trials/${trialId}/approve?approved_by=${encodeURIComponent(approvedBy)}`,
      {
        method: "POST",
      },
    ).then((r) => r.json());
  ...
  async startTrial(trialId: string): Promise<PlannedTrial> {
    return fetch(`/api/v2/trial-planning/trials/${trialId}/start`, {
      method: "POST",
    }).then((r) => r.json());
  }

  async completeTrial(trialId: string): Promise<PlannedTrial> {
    return fetch(`/api/v2/trial-planning/trials/${trialId}/complete`, {
      method: "POST",
    }).then((r) => r.json());
  }
  ...
  async cancelTrial(trialId: string, reason: string): Promise<PlannedTrial> {
    return fetch(
      `/api/v2/trial-planning/trials/${trialId}/cancel?reason=${encodeURIComponent(reason)}`,
      {
        method: "POST",
      },
    ).then((r) => r.json());
  ...
  async getTimeline(year?: number): Promise<PlannedTrial[]> {
    ...
    return fetch(`/api/v2/trial-planning/timeline${query}`).then((r) =>
      r.json(),
    );
  }
  ...
  async getResources(trialId: string): Promise<any[]> {
    return fetch(`/api/v2/trial-planning/trials/${trialId}/resources`).then(
      (r) => r.json(),
    );
  }
  ...
  async addResource(
    trialId: string,
    data: { type: string; name: string; quantity: number },
  ): Promise<any> {
...
class PedigreeAnalysisAPI {
  ...
  ): Promise<{ success: boolean; message: string } & PedigreeStats> {
  ...
  async getIndividual(
    individualId: string,
  ): Promise<{ success: boolean } & PedigreeIndividual> {
    return fetch(`/api/v2/pedigree/individual/${individualId}`).then((r) =>
      r.json(),
    );
  }
  ...
  ): Promise<{ success: boolean } & AncestorResult> {
    return fetch(
...
class PerformanceRankingAPI {
  ...
  async getEntry(
    entryId: string,
  ): Promise<{ status: string; data: RankedEntry }> {
    return fetch(`/api/v2/performance-ranking/entries/${entryId}`).then((r) =>
      r.json(),
    );
  }
  ...
  async getTrials(
    programId?: string,
  ): Promise<{ status: string; data: RankingTrial[] }> {
    const query = programId ? `?program_id=${programId}` : "";
    return fetch(`/api/v2/performance-ranking/trials${query}`).then((r) =>
      r.json(),
    );
  }
}
...
class SelectionDecisionsAPI {
  ...
  async getCandidate(
    candidateId: string,
  ): Promise<{ status: string; data: SelectionCandidate }> {
    return fetch(`/api/v2/selection-decisions/candidates/${candidateId}`).then(
      (r) => r.json(),
    );
  }
  ...
  async getHistory(params?: {
    ...
    const query = searchParams.toString();
    return fetch(
      `/api/v2/selection-decisions/history${query ? `?${query}` : ""}`,
    ).then((r) => r.json());
  }
  ...
  async getTrials(
    programId?: string,
  ): Promise<{ status: string; data: SelectionTrial[] }> {
    const query = programId ? `?program_id=${programId}` : "";
    return fetch(`/api/v2/selection-decisions/trials${query}`).then((r) =>
      r.json(),
    );
  }
}
...
class MolecularBreedingAPI {
  async getSchemes(params?: {
    ...
    const searchParams = new URLSearchParams();
    if (params?.scheme_type)
      searchParams.set("scheme_type", params.scheme_type);
    if (params?.status) searchParams.set("status", params.status);
    const query = searchParams.toString();
    return fetch(
      `/api/v2/molecular-breeding/schemes${query ? `?${query}` : ""}`,
    ).then((r) => r.json());
  }

  async getScheme(
    schemeId: string,
  ): Promise<{ success: boolean; data: BreedingScheme }> {
    return fetch(`/api/v2/molecular-breeding/schemes/${schemeId}`).then((r) =>
      r.json(),
    );
  }
  ...
  async getLines(params?: {
    ...
    if (params?.foreground_status)
      searchParams.set("foreground_status", params.foreground_status);
    const query = searchParams.toString();
    return fetch(
      `/api/v2/molecular-breeding/lines${query ? `?${query}` : ""}`,
    ).then((r) => r.json());
  }

  async getStatistics(): Promise<{
    success: boolean;
    data: MolecularBreedingStatistics;
  }> {
    return fetch("/api/v2/molecular-breeding/statistics").then((r) => r.json());
  }

  async getPyramidingMatrix(
    schemeId: string,
  ): Promise<{ success: boolean; data: any }> {
    return fetch(`/api/v2/molecular-breeding/pyramiding/${schemeId}`).then(
      (r) => r.json(),
    );
  }
}
...
class HaplotypeAnalysisAPI {
  async getBlocks(params?: {
    ...
    if (params?.min_length)
      searchParams.set("min_length", params.min_length.toString());
    const query = searchParams.toString();
    return fetch(`/api/v2/haplotype/blocks${query ? `?${query}` : ""}`).then(
      (r) => r.json(),
    );
  }
  ...
  async getBlock(
    ...
    success: boolean;
    data: HaplotypeBlock & { haplotypes: Haplotype[] };
  }> {
    return fetch(`/api/v2/haplotype/blocks/${blockId}`).then((r) => r.json());
  }

  async getBlockHaplotypes(
    blockId: string,
  ): Promise<{
    success: boolean;
    block_id: string;
    ...
    return fetch(`/api/v2/haplotype/blocks/${blockId}/haplotypes`).then((r) =>
      r.json(),
    );
  }
  ...
  async getAssociations(params?: {
    ...
    success: boolean;
    count: number;
    associations: HaplotypeAssociation[];
  }> {
    const searchParams = new URLSearchParams();
    if (params?.trait) searchParams.set("trait", params.trait);
    if (params?.chromosome) searchParams.set("chromosome", params.chromosome);
    const query = searchParams.toString();
    return fetch(
      `/api/v2/haplotype/associations${query ? `?${query}` : ""}`,
    ).then((r) => r.json());
  }

  async getFavorableHaplotypes(
    trait?: string,
  ): Promise<{ success: boolean; count: number; favorable_haplotypes: any[] }> {
    const query = trait ? `?trait=${trait}` : "";
    return fetch(`/api/v2/haplotype/favorable${query}`).then((r) => r.json());
  }

  async getDiversity(): Promise<{
    success: boolean;
    data: HaplotypeDiversitySummary;
  }> {
...
class QTLMappingAPI {
  async getQTLs(params?: {
    ...
    const query = searchParams.toString();
    return fetch(`/api/v2/qtl-mapping/qtls${query ? `?${query}` : ""}`).then(
      (r) => r.json(),
    );
  }
  ...
  async getCandidateGenes(
    ...
    return fetch(`/api/v2/qtl-mapping/qtls/${qtlId}/candidates`).then((r) =>
      r.json(),
    );
  }
  ...
  async getGWASResults(params?: {
    ...
    const query = searchParams.toString();
    return fetch(`/api/v2/qtl-mapping/gwas${query ? `?${query}` : ""}`).then(
      (r) => r.json(),
    );
  }
  ...
  async getLODProfile(chromosome: string, trait?: string): Promise<any> {
    const query = trait ? `?trait=${trait}` : "";
    return fetch(`/api/v2/qtl-mapping/lod-profile/${chromosome}${query}`).then(
      (r) => r.json(),
    );
  }

  async getGOEnrichment(
    qtlIds?: string[],
  ): Promise<{ enrichment: GOEnrichment[] }> {
    const query = qtlIds ? `?qtl_ids=${qtlIds.join(",")}` : "";
    return fetch(`/api/v2/qtl-mapping/go-enrichment${query}`).then((r) =>
      r.json(),
    );
  }
...
class GenomicSelectionAPI {
  ...
  async getModel(modelId: string): Promise<GSModel> {
    return fetch(`/api/v2/genomic-selection/models/${modelId}`).then((r) =>
      r.json(),
    );
  }
  ...
  async getPredictions(
    ...
    const query = searchParams.toString();
    return fetch(
      `/api/v2/genomic-selection/models/${modelId}/predictions${query ? `?${query}` : ""}`,
    ).then((r) => r.json());
  }
...
class FieldLayoutAPI {
  ...
  async getStudy(studyId: string): Promise<{ data: FieldStudy }> {
    return fetch(`/api/v2/field-layout/studies/${studyId}`).then((r) =>
      r.json(),
    );
  }
  ...
  async getLayout(studyId: string): Promise<{
    ...
    return fetch(`/api/v2/field-layout/studies/${studyId}/layout`).then((r) =>
      r.json(),
    );
  }
...
class TrialSummaryAPI {
  ...
  async getTrial(trialId: string): Promise<{ data: TrialInfo }> {
    return fetch(`/api/v2/trial-summary/trials/${trialId}`).then((r) =>
      r.json(),
    );
  }
  ...
  async getSummary(trialId: string): Promise<{
    ...
    return fetch(`/api/v2/trial-summary/trials/${trialId}/summary`).then((r) =>
      r.json(),
    );
  }
  ...
  async getTopPerformers(
    ...
    const query = searchParams.toString();
    return fetch(
      `/api/v2/trial-summary/trials/${trialId}/top-performers${query ? `?${query}` : ""}`,
    ).then((r) => r.json());
  }

  async getTraitSummary(
    trialId: string,
  ): Promise<{ data: TraitSummaryItem[] }> {
    return fetch(`/api/v2/trial-summary/trials/${trialId}/traits`).then((r) =>
      r.json(),
    );
  }
  ...
  async getLocationPerformance(
    trialId: string,
  ): Promise<{ data: LocationPerformance[] }> {
    return fetch(`/api/v2/trial-summary/trials/${trialId}/locations`).then(
      (r) => r.json(),
    );
  }

  async getStatistics(trialId: string): Promise<TrialStatistics> {
    return fetch(`/api/v2/trial-summary/trials/${trialId}/statistics`).then(
      (r) => r.json(),
    );
  }
...
class DataVisualizationAPI {
  ...
  async getChart(chartId: string): Promise<{ data: ChartConfig }> {
    return fetch(`/api/v2/visualizations/charts/${chartId}`).then((r) =>
      r.json(),
    );
  }
  ...
  async getChartData(chartId: string, limit?: number): Promise<ChartData> {
    const query = limit ? `?limit=${limit}` : "";
    return fetch(`/api/v2/visualizations/charts/${chartId}/data${query}`).then(
      (r) => r.json(),
    );
  }
  ...
  async exportChart(
    ...
    return fetch(
      `/api/v2/visualizations/charts/${chartId}/export?${searchParams}`,
      {
        method: "POST",
      },
    ).then((r) => r.json());
...
class AnalyticsDashboardAPI {
  async getAnalytics(params?: {
    ...
    if (params?.year_start)
      searchParams.set("year_start", params.year_start.toString());
    if (params?.year_end)
      searchParams.set("year_end", params.year_end.toString());
    const query = searchParams.toString();
    return fetch(`/api/v2/analytics${query ? `?${query}` : ""}`).then((r) =>
      r.json(),
    );
  }
  ...
  async getGeneticGain(params?: {
    ...
    const query = searchParams.toString();
    return fetch(
      `/api/v2/analytics/genetic-gain${query ? `?${query}` : ""}`,
    ).then((r) => r.json());
  }
  ...
  async getHeritabilities(params?: {
    ...
    const query = searchParams.toString();
    return fetch(
      `/api/v2/analytics/heritabilities${query ? `?${query}` : ""}`,
    ).then((r) => r.json());
  }
  ...
  async getCorrelations(params?: {
    ...
    const query = searchParams.toString();
    return fetch(
      `/api/v2/analytics/correlations${query ? `?${query}` : ""}`,
    ).then((r) => r.json());
  }
  ...
  async getSelectionResponse(params?: {
    ...
    if (params?.generations)
      searchParams.set("generations", params.generations.toString());
    const query = searchParams.toString();
    return fetch(
      `/api/v2/analytics/selection-response${query ? `?${query}` : ""}`,
    ).then((r) => r.json());
  }
  ...
  async getInsights(params?: {
    ...
    if (params?.limit) searchParams.set("limit", params.limit.toString());
    const query = searchParams.toString();
    return fetch(`/api/v2/analytics/insights${query ? `?${query}` : ""}`).then(
      (r) => r.json(),
    );
  }
  ...
  async getVeenaSummary(programId?: string): Promise<{
    ...
    const query = programId ? `?program_id=${programId}` : "";
    return fetch(`/api/v2/analytics/veena-summary${query}`).then((r) =>
      r.json(),
    );
  }
}
...
class PhenotypeComparisonAPI {
  ...
  async getStatistics(germplasmIds?: string[]): Promise<any> {
    const query = germplasmIds
      ...
      : "";
    return fetch(`/api/v2/phenotype-comparison/statistics${query}`).then((r) =>
      r.json(),
    );
  }
}
...
class GermplasmAttributesAPI {
  async getAttributes(params?: {
    ...
    const query = searchParams.toString();
    return fetch(`/brapi/v2/attributes${query ? `?${query}` : ""}`).then((r) =>
      r.json(),
    );
  }
...
class CrossingProjectsAPI {
  async getProjects(params?: {
    ...
    if (params?.page) searchParams.set("page", params.page.toString());
    const query = searchParams.toString();
    return fetch(`/brapi/v2/crossingprojects${query ? `?${query}` : ""}`).then(
      (r) => r.json(),
    );
  }
  ...
  async getProject(
    crossingProjectDbId: string,
  ): Promise<{ result: CrossingProject }> {
    return fetch(`/brapi/v2/crossingprojects/${crossingProjectDbId}`).then(
      (r) => r.json(),
    );
  }
...
class HarvestPlannerAPI {
  async getTasks(params?: {
    ...
    const query = searchParams.toString();
    return fetch(`/api/v2/harvest/tasks${query ? `?${query}` : ""}`).then((r) =>
      r.json(),
    );
  }
  ...
  async updateTask(
    taskId: string,
    data: Partial<HarvestTask>,
  ): Promise<{ data: HarvestTask }> {
...
class VarietyComparisonAPI {
  ...
  async getVariety(varietyId: string): Promise<{ data: VarietyData }> {
    return fetch(`/api/v2/variety-comparison/varieties/${varietyId}`).then(
      (r) => r.json(),
    );
  }
...
class SampleTrackingAPI {
  async getSamples(params?: {
    ...
    if (params?.search) searchParams.set("search", params.search);
    const query = searchParams.toString();
    return fetch(`/api/v2/samples/tracking${query ? `?${query}` : ""}`).then(
      (r) => r.json(),
    );
  }
...
class SeedRequestAPI {
  async getRequests(params?: {
    ...
    const query = searchParams.toString();
    return fetch(`/api/v2/seed-requests${query ? `?${query}` : ""}`).then((r) =>
      r.json(),
    );
  }
  ...
  async clearDefaultWorkspace(
    ...
    try {
      ...
      if (!response.ok) {
        return {
          status: "error",
          message: "Failed to clear default workspace",
        };
      }
      return response.json();
    } catch {
...
class WarehouseAPI {
  ...
  async getLocations(params?: {
    ...
    if (params?.status) searchParams.append("status", params.status);
    const query = searchParams.toString();
    return fetch(`${this.baseUrl}/locations${query ? `?${query}` : ""}`).then(
      (r) => r.json(),
    );
  }
  ...
  async getLocation(locationId: string): Promise<StorageLocation> {
    return fetch(`${this.baseUrl}/locations/${locationId}`).then((r) =>
      r.json(),
    );
  }
...
class GDDAPI {
  async calculate(params: {
    ...
    return fetch(`/api/v2/gdd/calculate?${query}`, { method: "POST" }).then(
      (r) => r.json(),
    );
  }
  ...
  async predictGrowthStages(params: {
    ...
    return fetch(`/api/v2/gdd/predict/growth-stages?${query}`, {
      method: "POST",
    }).then((r) => r.json());
  }

  async getFieldSummary(fieldId: string) {
    return fetch(`/api/v2/gdd/field/${fieldId}/summary`).then((r) => r.json());
  }
  ...
  async getFieldHistory(fieldId: string, startDate: string, endDate: string) {
    ...
    return fetch(`/api/v2/gdd/field/${fieldId}/history?${query}`).then((r) =>
      r.json(),
    );
  }

  async getFieldPredictions(fieldId: string) {
    return fetch(`/api/v2/gdd/field/${fieldId}/predictions`).then((r) =>
      r.json(),
    );
  }

  async createFieldPrediction(fieldId: string, data: any) {
    return fetch(`/api/v2/gdd/field/${fieldId}/predict`, {
      method: "POST",
      headers: { "Content-Type": "application/json" },
      body: JSON.stringify(data),
    }).then((r) => r.json());
...
export const gddAPI = new GDDAPI();


// ============================================
// CROP INTELLIGENCE - YIELD PREDICTION API
// ============================================
...
class CropIntelligenceYieldPredictionAPI {
  private getAuthHeaders(): HeadersInit {
    const token = apiClient.getToken();
    return {
      "Content-Type": "application/json",
  ...
  async get(id: number): Promise<YieldPredictionRecord> {
    return fetch(`/api/v2/future/yield-prediction/${id}`, {
      headers: this.getAuthHeaders(),
    }).then((r) => r.json());
  }

  async create(data: YieldPredictionCreate): Promise<YieldPredictionRecord> {
    return fetch("/api/v2/future/yield-prediction", {
      method: "POST",
      headers: this.getAuthHeaders(),
      body: JSON.stringify(data),
    }).then((r) => r.json());
  ...
  async getByField(fieldId: number): Promise<YieldPredictionRecord[]> {
    return fetch(`/api/v2/future/yield-prediction/field/${fieldId}`, {
      headers: this.getAuthHeaders(),
    }).then((r) => r.json());
  }

  async getLatestByField(fieldId: number): Promise<YieldPredictionRecord> {
    return fetch(`/api/v2/future/yield-prediction/field/${fieldId}/latest`, {
      headers: this.getAuthHeaders(),
    }).then((r) => r.json());
  }

  async getByTrial(trialId: number): Promise<YieldPredictionRecord[]> {
    return fetch(`/api/v2/future/yield-prediction/trial/${trialId}`, {
      headers: this.getAuthHeaders(),
    }).then((r) => r.json());
  }
}

export const cropIntelligenceYieldPredictionAPI =
  new CropIntelligenceYieldPredictionAPI();
...
class GxEAnalysisAPI {
  ...
  async runFinlayWilkinson(data: GxEDataInput): Promise<{
    ...
    return fetch("/api/v2/gxe/finlay-wilkinson", {
      method: "POST",
      headers: this.getAuthHeaders(),
      body: JSON.stringify(data),
    }).then((r) => r.json());
  ...
  async getMethods(): Promise<{
    ...
    return fetch("/api/v2/gxe/methods", {
      headers: this.getAuthHeaders(),
    }).then((r) => r.json());
  }
}

export const gxeAnalysisAPI = new GxEAnalysisAPI();
