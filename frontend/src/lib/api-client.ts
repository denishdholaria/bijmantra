...
class APIClient extends ApiClientCore {
  ...
  markerAssistedService: MarkerAssistedService;
  ...
  genomicsPipelineService: GenomicsPipelineService;
  ...
  public crossPredictionService: CrossPredictionService;
  ...
  // Phase 11: Science Engines
  public biosimulationService: BiosimulationService;
  public economicsService: EconomicsService;
  ...
  public lunarService: LunarService;
  public researchService: ResearchService;

  public agronomyService: AgronomyService;
  ...
  constructor(config: { baseURL: string; token?: string }) {
    ...
    this.mcpdService = new MCPDService(this);
    this.grinService = new GRINService(this);
    ...
    this.aiConfigurationService = new AIConfigurationService(this);
    this.chatHealthService = new ChatHealthService(this);
    ...
    this.markerAssistedService = new MarkerAssistedService(this);
    ...
    this.genomicsPipelineService = new GenomicsPipelineService(this);
    ...
    this.crossPredictionService = new CrossPredictionService(this);
    ...
    // Phase 11: Science Engines
    this.biosimulationService = new BiosimulationService(this);
    this.economicsService = new EconomicsService(this);
    this.calculatorService = new CalculatorService(this);
    ...
    // Space Division Init
    this.marsService = new MarsService(this);
    this.lunarService = new LunarService(this);
    ...
    // Agronomy Service
    this.agronomyService = new AgronomyService(this);
  }
