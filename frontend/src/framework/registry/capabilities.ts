...
export const capabilityManifests: CapabilityManifest[] = [
  ...
  },
  {
    ...
    ownerDomain: 'germplasm',
    supportingDomains: ['intelligence', 'knowledge'],
    lifecycle: 'active',
    ...
    backendRoutes: ['/brapi/v2/germplasm/*', '/api/v2/germplasm/*', '/api/v2/seed-bank/*'],
    dataScopes: ['organization', 'collection', 'accession', 'material_transfer'],
    requiredPermissions: ['germplasm.read', 'germplasm.passport.manage'],
    suggestedRoles: ['germplasm_curator', 'seed_bank_manager', 'research_lead'],
    auditEvents: ['germplasm.mcpd_exported', 'germplasm.mcpd_imported'],
  },
];
