 ...
 * Defines the 5 main pathways: Plant Breeding, Seed Commerce, Innovation Lab, Gene Bank, Administration.
 */
...
export const workspaces: Workspace[] = [
  // Workspace 1: Plant Breeding (BrAPI-Aligned)
  {
    ...
    longDescription: 'Comprehensive plant breeding platform with BrAPI-compatible interoperability. Manage breeding programs, trials, crosses, germplasm, and genomic analysis.',
    icon: 'Wheat',
  ...
  // Workspace 2: Seed Commerce
  {
    id: 'seed-ops',
    name: 'Seed Commerce',
    description: 'Lab, processing, inventory, dispatch, licensing',
    longDescription: 'Complete seed commerce workflows including lab testing, quality processing, inventory management, dispatch logistics, DUS testing, traceability, and variety licensing.',
    icon: 'Factory',
    color: 'from-blue-500 to-indigo-600',
    bgColor: 'bg-blue-50 dark:bg-blue-950/30',
    landingRoute: '/seed-operations/dashboard',
  ...
  // ============================================================================
  // Prakriti (Environment) Gateways
  // ============================================================================

  // Workspace 6: Atmosphere (Climate)
  {
    id: 'atmosphere',
    name: 'Atmosphere',
    description: 'Weather, Climate, Air Quality',
    longDescription: 'Meteorological and climatological monitoring. Track weather patterns, long-term climate risks, GDD accumulation, and air quality metrics.',
    icon: 'CloudSun',
    color: 'from-sky-400 to-blue-500',
    bgColor: 'bg-sky-50 dark:bg-sky-950/30',
    landingRoute: '/weather',
    modules: ['atmosphere-core'],
    targetUsers: ['Climate Scientists', 'Farm Managers'],
    pageCount: 5,
    isBrAPIAligned: false,
  },

  // Workspace 7: Hydrology (Water)
  {
    id: 'hydrology',
    name: 'Hydrology',
    description: 'Irrigation, Water Resources',
    longDescription: 'Water resource management. Monitor irrigation schedules, reservoir levels, soil moisture balance, and drought indices.',
    icon: 'Droplets',
    color: 'from-blue-400 to-cyan-500',
    bgColor: 'bg-cyan-50 dark:bg-cyan-950/30',
    landingRoute: '/water-irrigation',
    modules: ['hydrology-core'],
    targetUsers: ['Irrigation Managers', 'Agronomists'],
    pageCount: 4,
    isBrAPIAligned: false,
  },

  // Workspace 8: Lithosphere (Land/Soil)
  {
    id: 'lithosphere',
    name: 'Lithosphere',
    description: 'Soil Health, Topography, Maps',
    longDescription: 'Geospatial and soil analysis. Manage soil health data, nutrient maps, topography, and land use planning.',
    icon: 'Mountain',
    color: 'from-amber-700 to-orange-800',
    bgColor: 'bg-orange-50 dark:bg-orange-950/30',
    landingRoute: '/soil-nutrients',
    modules: ['lithosphere-core'],
    targetUsers: ['Soil Scientists', 'Field Managers'],
    pageCount: 4,
    isBrAPIAligned: false,
  },

  // Workspace 9: Biosphere (Ecology)
  {
    id: 'biosphere',
    name: 'Biosphere',
    description: 'Biodiversity, Ecology, Carbon',
    longDescription: 'Ecological monitoring. Track biodiversity, beneficial insects, pest pressure, and carbon sequestration metrics.',
    icon: 'Leaf',
    color: 'from-emerald-400 to-green-500',
    bgColor: 'bg-green-50 dark:bg-green-950/30',
    landingRoute: '/sustainability',
    modules: ['biosphere-core'],
    targetUsers: ['Ecologists', 'Sustainability Officers'],
    pageCount: 3,
    isBrAPIAligned: false,
  },
];
...
export const workspaceModules: WorkspaceModule[] = [
  ...
  // BrAPI Germplasm Module
  {
    ...
    pages: [
      ...
      { id: 'crossing-planner', name: 'Cross Planning', route: '/crossingplanner' },
  ...
  // Seed Bank Module
  {
    ...
    pages: [
      ...
      { id: 'accessions', name: 'Accession Search', route: '/seed-bank/accessions' },
  ...
  // ============================================================================
  // Prakriti Sphere Modules
  // ============================================================================

  // Atmosphere Core (Prakriti)
  {
    id: 'atmosphere-core',
    name: 'Atmosphere Core',
    description: 'Weather, Climate, GDD, Solar',
    icon: 'CloudSun',
    route: '/weather',
    isBrAPI: false,
    workspaces: ['atmosphere'],
    pages: [
       { id: 'earth-dashboard', name: 'Dashboard', route: '/weather' },
       { id: 'weather', name: 'Weather Forecast', route: '/weather-forecast' },
       { id: 'climate', name: 'Climate Analysis', route: '/sun-earth-systems' },
       { id: 'gdd', name: 'Growing Degrees', route: '/crop-intelligence/gdd-tracker' },
       { id: 'solar-dashboard', name: 'Solar Dashboard', route: '/sun-earth-systems' },
    ]
  },

  // Hydrology Core (Prakriti)
  {
    id: 'hydrology-core',
    name: 'Hydrology Core',
    description: 'Irrigation, Drought, Water',
    icon: 'Droplets',
     route: '/water-irrigation',
    isBrAPI: false,
    workspaces: ['hydrology'],
    pages: [
       { id: 'irrigation', name: 'Irrigation Planner', route: '/water-irrigation' },
       { id: 'drought', name: 'Drought Monitor', route: '/water-irrigation' },
       // { id: 'water-balance', name: 'Water Balance', route: '/earth-systems/water-balance' }, 
    ]
  },

  // Lithosphere Core (Prakriti)
  {
    id: 'lithosphere-core',
    name: 'Lithosphere Core',
    description: 'Soil, Land, Maps',
    icon: 'Mountain',
     route: '/soil-nutrients',
    isBrAPI: false,
    workspaces: ['lithosphere'],
    pages: [
       { id: 'soil', name: 'Soil Data', route: '/soil-nutrients' },
       { id: 'field-map-env', name: 'Field Map', route: '/field-map' },
       { id: 'inputs', name: 'Input Log', route: '/soil-nutrients' },
    ]
  },

  // Biosphere Core (Prakriti)
  {
    id: 'biosphere-core',
    name: 'Biosphere Core',
    description: 'Ecology, Carbon, Biodiversity',
    icon: 'Leaf',
    route: '/sustainability',
    isBrAPI: false,
    workspaces: ['biosphere'],
    pages: [
       { id: 'sustainability', name: 'Sustainability', route: '/sustainability' },
       { id: 'carbon', name: 'Carbon Dashboard', route: '/soil-nutrients/carbon' },
       { id: 'pest-monitor', name: 'Pest Monitor', route: '/pest-monitor' },
    ]
  },
  ...
  // Lab Testing Module (Seed Commerce)
  {
    id: 'lab-testing',
    name: 'Lab Testing',
  ...
  // Processing Module (Seed Commerce)
  {
    id: 'processing',
    name: 'Processing',
  ...
  // Inventory Module (Seed Commerce)
  {
    id: 'inventory',
    name: 'Inventory',
  ...
  // Traceability Module (Seed Commerce)
  {
    id: 'traceability',
    name: 'Traceability',
  ...
  // DUS Testing Module (Seed Commerce)
  {
    id: 'dus-testing',
    name: 'DUS Testing',
  ...
  // Licensing Module (Seed Commerce)
  {
    id: 'licensing',
    name: 'Licensing',
    ...
    pages: [
      ...
      // Additional Seed Commerce pages
  ...
  // Developer Module (Administration)
  {
    ...
    pages: [
      ...
      { id: 'ai-assistant', name: 'REEVU', route: '/ai-assistant' },
