...
export const workspaces: Workspace[] = [
  ...
  // Workspace 6: Atmosphere (Climate)
  {
    ...
    landingRoute: '/earth-systems/weather',
  ...
  // Workspace 7: Hydrology (Water)
  {
    ...
    landingRoute: '/earth-systems/irrigation',
  ...
  // Workspace 8: Lithosphere (Land/Soil)
  {
    ...
    landingRoute: '/earth-systems/soil',
  ...
  // Workspace 9: Biosphere (Ecology)
  {
    ...
    bgColor: 'bg-green-50 dark:bg-green-950/30',
    landingRoute: '/earth-systems/sustainability',
...
export const workspaceModules: WorkspaceModule[] = [
  ...
  // Atmosphere Core (Prakriti)
  {
    ...
    pages: [
       { id: 'earth-dashboard', name: 'Dashboard', route: '/earth-systems' },
       { id: 'weather', name: 'Weather Forecast', route: '/earth-systems/weather' },
       { id: 'climate', name: 'Climate Analysis', route: '/earth-systems/climate' },
       { id: 'gdd', name: 'Growing Degrees', route: '/earth-systems/gdd' },
       { id: 'solar-dashboard', name: 'Solar Dashboard', route: '/sun-earth-systems' },
  ...
  // Hydrology Core (Prakriti)
  {
    ...
    icon: 'Droplets',
    route: '/earth-systems/irrigation',
    isBrAPI: false,
  ...
  // Biosphere Core (Prakriti)
  {
    ...
    icon: 'Leaf',
    route: '/earth-systems/sustainability',
    isBrAPI: false,
    workspaces: ['biosphere'],
    pages: [
       { id: 'sustainability', name: 'Sustainability', route: '/earth-systems/sustainability' },
       { id: 'carbon', name: 'Carbon Dashboard', route: '/earth-systems/carbon' },
       { id: 'pest-monitor', name: 'Pest Monitor', route: '/pest-monitor' },
    ]
  },
