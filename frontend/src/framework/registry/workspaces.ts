...
export const workspaceModules: WorkspaceModule[] = [
  ...
  // Hydrology Core (Prakriti)
  {
    ...
    pages: [
       { id: 'irrigation', name: 'Irrigation Planner', route: '/irrigation' },
  ...
  // Lithosphere Core (Prakriti)
  {
    ...
    pages: [
       { id: 'soil', name: 'Soil Data', route: '/soil' },
  ...
  // Lab Testing Module (Seed Industry)
  {
    ...
    icon: 'FlaskConical',
    route: '/seed-ops/samples',
    isBrAPI: false,
    workspaces: ['seed-ops'],
    pages: [
      { id: 'lab-samples', name: 'Lab Samples', route: '/seed-ops/samples' },
      { id: 'lab-tests', name: 'Lab Tests', route: '/seed-ops/testing' },
      { id: 'certificates', name: 'Certificates', route: '/seed-ops/certificates' },
    ],
  },
  ...
  // Processing Module (Seed Industry)
  {
    ...
    icon: 'Shield',
    route: '/seed-ops/quality-gate',
    isBrAPI: false,
    workspaces: ['seed-ops'],
    pages: [
      { id: 'quality-gate', name: 'Quality Gate Scanner', route: '/seed-ops/quality-gate' },
      { id: 'batches', name: 'Processing Batches', route: '/seed-ops/batches' },
      { id: 'stages', name: 'Processing Stages', route: '/seed-ops/stages' },
    ],
  },
  ...
  // Inventory Module (Seed Industry)
  {
    ...
    workspaces: ['seed-ops'],
    pages: [
      { id: 'seed-lots-inv', name: 'Seed Lots', route: '/seed-ops/lots' },
      { id: 'warehouse', name: 'Warehouse Management', route: '/seed-ops/warehouse' },
      { id: 'stock-alerts', name: 'Stock Alerts', route: '/seed-ops/alerts' },
  ...
  // Dispatch Module (Seed Industry)
  {
    ...
    icon: 'Truck',
    route: '/seed-ops/dispatch',
    isBrAPI: false,
    workspaces: ['seed-ops'],
    pages: [
      { id: 'create-dispatch', name: 'Create Dispatch', route: '/seed-ops/dispatch' },
      { id: 'dispatch-history', name: 'Dispatch History', route: '/seed-ops/dispatch-history' },
      { id: 'firms', name: 'Firms/Dealers', route: '/seed-ops/firms' },
    ],
  },
  ...
  // Traceability Module (Seed Industry)
  {
    ...
    icon: 'QrCode',
    route: '/seed-ops/track',
    isBrAPI: false,
    workspaces: ['seed-ops', 'genebank'],
    pages: [
      { id: 'track-lot', name: 'Track Lot', route: '/seed-ops/track' },
      { id: 'lineage', name: 'Lineage View', route: '/seed-ops/lineage' },
  ...
  // Licensing Module (Seed Industry)
  {
    ...
    icon: 'FileCheck',
    route: '/seed-ops/varieties',
    isBrAPI: false,
    workspaces: ['seed-ops'],
    pages: [
      { id: 'varieties', name: 'Varieties', route: '/seed-ops/varieties' },
      { id: 'agreements', name: 'License Agreements', route: '/seed-ops/agreements' },
