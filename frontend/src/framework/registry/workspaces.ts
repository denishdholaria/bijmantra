 ...
 * Defines the 5 main pathways: Plant Breeding, Seed Business, Innovation Lab, Gene Bank, Administration.
 * 
...
export const workspaces: Workspace[] = [
  ...
  // Workspace 2: Seed Business
  {
    id: 'seed-ops',
    name: 'Seed Business',
    description: 'Lab, processing, inventory, dispatch',
    longDescription: 'Complete seed business operations including lab testing, quality processing, inventory management, dispatch logistics, DUS testing, and variety licensing.',
    icon: 'Factory',
...
export const workspaceModules: WorkspaceModule[] = [
  ...
  // Environment Module
  {
    ...
    pages: [
      ...
      // Additional environment pages
      { id: 'weather', name: 'Weather', route: '/weather' },
      { id: 'weather-forecast', name: 'Weather Forecast', route: '/weather-forecast' },
      { id: 'soil', name: 'Soil', route: '/soil' },
      { id: 'irrigation', name: 'Irrigation', route: '/irrigation' },
  ...
  // Sensors Module
  {
    ...
    pages: [
      ...
      // Additional sensor pages
      { id: 'sensor-aggregates', name: 'Aggregates', route: '/sensor-networks/aggregates' },
      { id: 'sensor-telemetry', name: 'Telemetry', route: '/sensor-networks/telemetry' },
    ],
  },

  // Lab Testing Module (Seed Business)
  {
    id: 'lab-testing',
    name: 'Lab Testing',
  ...
  // Processing Module (Seed Business)
  {
    id: 'processing',
    name: 'Processing',
  ...
  // Inventory Module (Seed Business)
  {
    id: 'inventory',
    name: 'Inventory',
  ...
  // Traceability Module (Seed Business)
  {
    id: 'traceability',
    name: 'Traceability',
  ...
  // DUS Testing Module (Seed Business)
  {
    id: 'dus-testing',
    name: 'DUS Testing',
  ...
  // Licensing Module (Seed Business)
  {
    id: 'licensing',
    name: 'Licensing',
