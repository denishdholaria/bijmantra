 ...
 */
export type DivisionStatus = 'active' | 'preview' | 'planned' | 'visionary';

/**
 * Domain Mode for filtering modules
 */
export type DomainMode = 'all' | 'breeding' | 'operations' | 'research' | 'admin';
