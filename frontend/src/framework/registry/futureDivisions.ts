...
const promotedDivisionIds = new Set([
  'crop-intelligence',
  'soil-nutrients',
  'crop-protection',
  'water-irrigation',
...
] satisfies FutureDivision[];

export const futureDivisions: FutureDivision[] = futureDivisionCatalog.filter(
  (division) => !promotedDivisionIds.has(division.id)
);
