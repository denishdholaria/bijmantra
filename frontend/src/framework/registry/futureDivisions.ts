    ...
    sections: [
      {
        ...
        items: [
          ...
          { id: 'soil-tests', name: 'Soil Test Interpreter', route: '/soil-nutrients/tests', isAbsolute: true },
      ...
      },
      {
        ...
        isAbsolute: true,
        items: [
          { id: 'scorecard', name: 'Health Scorecard', route: '/soil-nutrients/scorecard', isAbsolute: true },
    ...
    sections: [
      {
        id: 'irrigation',
        name: 'Irrigation',
        route: '/water-irrigation/schedule',
        icon: 'Droplets',
        isAbsolute: true,
        items: [
          { id: 'scheduler', name: 'Irrigation Scheduler', route: '/water-irrigation/schedule', isAbsolute: true },
