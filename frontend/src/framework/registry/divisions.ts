...
export const divisions: Division[] = [
  ...
  // Division 3: Environment (Merged: Earth Systems + Sun-Earth Systems)
  // Comprehensive environmental monitoring for agriculture
  {
    id: 'environment',
    name: 'Environment',
    ...
    sections: [
      ...
      },
      {
        ...
        isAbsolute: true,
        items: [
          { id: 'sun-dashboard', name: 'Solar Dashboard', route: '/sun-earth-systems', isAbsolute: true },
          { id: 'solar-activity', name: 'Solar Activity', route: '/sun-earth-systems/solar-activity', isAbsolute: true },
          { id: 'photoperiod', name: 'Photoperiod', route: '/sun-earth-systems/photoperiod', isAbsolute: true },
          { id: 'uv-index', name: 'UV Index', route: '/sun-earth-systems/uv-index', isAbsolute: true },
        ],
      },
    ],
  },
  ...
  // Complete seed business operations: Lab, Processing, Inventory, Dispatch, DUS, Licensing
  {
    id: 'seed-commerce',
    name: 'Seed Commerce',
