...
export const divisions: Division[] = [
  ...
  // Division 2: Plant Sciences (Active)
    ...
    sections: [
      ...
      // Subgroup: Crossing
      {
        ...
        items: [
          ...
          { id: 'cross-planning', name: 'Cross Planning', route: '/crossingplanner', isAbsolute: true },
      ...
      // Subgroup: Phenotyping
      {
        ...
        icon: 'Microscope',
        isAbsolute: true,
        domains: ['breeding', 'research', 'operations'],
        items: [
      ...
      // Subgroup: Breeding Methods
      {
        id: 'breeding-methods',
        name: 'Breeding Methods',
        route: '/breeding-values',
        icon: 'FlaskConical',
        isAbsolute: true,
        items: [
      ...
      // Subgroup: Multi-Environment Analysis
      {
        id: 'multi-env',
        name: 'Multi-Env Analysis',
        route: '/genetic-correlation',
        icon: 'Globe',
        isAbsolute: true,
        items: [
      ...
      // Subgroup: Analysis & Diagnostics (merged Analysis + Analysis Tools)
      {
        id: 'analysis',
      ...
      // Subgroup: Plant Vision (AI Image Analysis)
      {
        id: 'plant-vision',
        name: 'Plant Vision',
        route: '/plant-vision',
        ...
        domains: ['research', 'breeding'],
        items: [
          { id: 'vision-dashboard', name: 'Vision Dashboard', route: '/plant-vision', isAbsolute: true },
          { id: 'vision-inference', name: 'Live Inference', route: '/plant-vision/inference', isAbsolute: true },
          { id: 'vision-datasets', name: 'Datasets', route: '/plant-vision/datasets', isAbsolute: true },
          { id: 'vision-training', name: 'Model Training', route: '/plant-vision/training', isAbsolute: true },
          { id: 'vision-models', name: 'Model Registry', route: '/plant-vision/models', isAbsolute: true },
        ],
      },
    ],
  },

  // Division 3: Crop Intelligence (Preview)
  {
    id: 'crop-intelligence',
    name: 'Crop Intelligence',
    description: 'Crop selection, calendars, yield prediction, and suitability analysis',
    icon: 'Wheat',
    route: '/crop-intelligence',
    component: lazy(() => import('@/divisions/crop-intelligence')),
    requiredPermissions: ['read:crop_intelligence'],
    status: 'preview',
    version: '0.1.0',
    sections: [
      { id: 'dashboard', name: 'Dashboard', route: '/crop-intelligence', icon: 'LayoutDashboard', isAbsolute: true },
      { id: 'crop-suitability', name: 'Crop Suitability', route: '/crop-intelligence/crop-suitability', icon: 'Target', isAbsolute: true },
      { id: 'gdd-tracker', name: 'GDD Tracker', route: '/crop-intelligence/gdd-tracker', icon: 'ThermometerSun', isAbsolute: true },
      { id: 'crop-calendar', name: 'Crop Calendar', route: '/crop-intelligence/crop-calendar', icon: 'Calendar', isAbsolute: true },
      { id: 'yield-prediction', name: 'Yield Prediction', route: '/crop-intelligence/yield-prediction', icon: 'TrendingUp', isAbsolute: true },
    ],
  },

  // Division 4: Soil & Nutrients (Preview)
  {
    id: 'soil-nutrients',
    name: 'Soil & Nutrients',
    description: 'Soil health, test interpretation, prescriptions, and carbon tracking',
    icon: 'Mountain',
    route: '/soil-nutrients',
    component: lazy(() => import('@/divisions/soil-nutrients')),
    requiredPermissions: ['read:soil_nutrients'],
    status: 'preview',
    version: '0.1.0',
    sections: [
      { id: 'dashboard', name: 'Dashboard', route: '/soil-nutrients', icon: 'LayoutDashboard', isAbsolute: true },
      { id: 'soil-tests', name: 'Soil Tests', route: '/soil-nutrients/soil-tests', icon: 'FlaskConical', isAbsolute: true },
      { id: 'soil-health', name: 'Soil Health', route: '/soil-nutrients/soil-health', icon: 'Heart', isAbsolute: true },
      { id: 'prescriptions', name: 'Prescriptions', route: '/soil-nutrients/prescriptions', icon: 'ClipboardList', isAbsolute: true },
      { id: 'carbon', name: 'Carbon Tracker', route: '/soil-nutrients/carbon', icon: 'Leaf', isAbsolute: true },
    ],
  },

  // Division 5: Crop Protection (Preview)
  {
    id: 'crop-protection',
    name: 'Crop Protection',
    description: 'Pest observations, disease risk, spray planning, and IPM guidance',
    icon: 'Shield',
    route: '/crop-protection',
    component: lazy(() => import('@/divisions/crop-protection')),
    requiredPermissions: ['read:crop_protection'],
    status: 'preview',
    version: '0.1.0',
    sections: [
      { id: 'dashboard', name: 'Dashboard', route: '/crop-protection', icon: 'LayoutDashboard', isAbsolute: true },
      { id: 'pest-observations', name: 'Pest Observations', route: '/crop-protection/pest-observations', icon: 'Bug', isAbsolute: true },
      { id: 'disease-risk-forecast', name: 'Disease Risk Forecast', route: '/crop-protection/disease-risk-forecast', icon: 'Radar', isAbsolute: true },
      { id: 'spray-applications', name: 'Spray Applications', route: '/crop-protection/spray-applications', icon: 'SprayCan', isAbsolute: true },
      { id: 'ipm-strategies', name: 'IPM Strategies', route: '/crop-protection/ipm-strategies', icon: 'Target', isAbsolute: true },
    ],
  },

  // Division 6: Water & Irrigation (Preview)
  {
    id: 'water-irrigation',
    name: 'Water & Irrigation',
    description: 'Irrigation scheduling, water balance, and soil moisture intelligence',
    icon: 'Droplets',
    route: '/water-irrigation',
    component: lazy(() => import('@/divisions/water-irrigation')),
    requiredPermissions: ['read:water_irrigation'],
    status: 'preview',
    version: '0.1.0',
    sections: [
      { id: 'dashboard', name: 'Dashboard', route: '/water-irrigation', icon: 'LayoutDashboard', isAbsolute: true },
      { id: 'schedules', name: 'Irrigation Schedules', route: '/water-irrigation/schedules', icon: 'CalendarClock', isAbsolute: true },
      { id: 'balance', name: 'Water Balance', route: '/water-irrigation/balance', icon: 'Scale', isAbsolute: true },
      { id: 'moisture', name: 'Soil Moisture', route: '/water-irrigation/moisture', icon: 'Activity', isAbsolute: true },
    ],
  },

  // Division 7: Seed Commerce (Active)
  // Complete seed commerce workflows: Lab, Processing, Inventory, Dispatch, DUS, Licensing
  {
    id: 'seed-commerce',
    name: 'Seed Commerce',
  ...
  // Genetic resources preservation and germplasm conservation module
  {
    ...
    sections: [
      ...
      {
        id: 'accessions',
        name: 'Accession Search',
        route: '/seed-bank/accessions',
        icon: 'Sprout',
        isAbsolute: true,
        items: [
          { id: 'all', name: 'Accession Search', route: '/seed-bank/accessions', isAbsolute: true },
  ...
  // Division 9: Sensor Networks (Active)
  {
    id: 'sensor-networks',
  ...
  // Division 10: Tools & Utilities
  {
    ...
    sections: [
      ...
      },
      {
        ...
        isAbsolute: true,
        items: [
          { id: 'ai-assistant', name: 'REEVU', route: '/ai-assistant', isAbsolute: true },
  ...
  // Division 12: Space Research (Active)
  {
    id: 'space-research',
    name: 'Space Research',
    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          ...
          { id: 'api-explorer', name: 'API Explorer', route: '/api-explorer', icon: 'Code', isAbsolute: true },
        ],
      },
      {
        id: 'system',
...
// ============================================================================
// Helper Functions (Re-exported from service layer)
// ============================================================================

export {
  getDivision,
  getDivisionsByStatus,
  getNavigableDivisions,
