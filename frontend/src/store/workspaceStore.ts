  ...
  persist(
    (set, get) => ({
      ...
      setActiveWorkspace: (workspaceId: WorkspaceId) => {
        ...
        apiClient.workspacePreferencesService.recordWorkspaceSwitch(workspaceId).catch(console.error);
      },
      ...
      setDefaultWorkspace: (workspaceId: WorkspaceId | null) => {
        ...
        // Sync with backend
        if (workspaceId) {
          apiClient.workspacePreferencesService.setDefaultWorkspace(workspaceId).catch(console.error);
        } else {
          apiClient.workspacePreferencesService.clearDefaultWorkspace().catch(console.error);
        }
      },
