...
export type WorkspaceId = 
  ...
  | 'seed-ops'    // Internal compatibility id for Seed Commerce
  ...
  // Prakriti Gateways (Earth Systems)
  | 'atmosphere'  // Climate, Weather, GDD
  | 'hydrology'   // Water, Irrigation
  | 'lithosphere' // Soil, Land
  | 'biosphere';  // Biodiversity, Ecology
