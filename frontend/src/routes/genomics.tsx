...
const Markers = lazy(() => import('@/pages/Markers').then(m => ({ default: m.Markers })));
...
const PhenomicUpload = lazy(() => import('@/pages/PhenomicUpload').then(m => ({ default: m.PhenomicUpload })));
...
export const genomicsRoutes: RouteObject[] = [
  ...
  { path: '/markers', element: wrap(Markers) },
  ...
  { path: '/phenomic-upload', element: wrap(PhenomicUpload) },
