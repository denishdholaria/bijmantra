...
export const futureRoutes: RouteObject[] = [
  ...
  { path: '/earth-systems', element: wrap(SoilAnalysis) },
  { path: '/earth-systems/weather', element: wrap(Weather) },
  { path: '/earth-systems/climate', element: wrap(WeatherForecast) },
  { path: '/earth-systems/gdd', element: wrap(CropIntelligenceGDDTracker) },
  { path: '/earth-systems/drought', element: wrap(AbioticStress) },
  { path: '/earth-systems/soil', element: wrap(SoilAnalysis) },
  { path: '/earth-systems/inputs', element: wrap(FertilizerCalculator) },
  { path: '/earth-systems/irrigation', element: wrap(IrrigationPlanner) },
  { path: '/earth-systems/map', element: wrap(Weather) },
  ...
  { path: '/sensor-networks/telemetry', element: wrap(SensorNetworksLiveData) },
  { path: '/sensor-networks/aggregates', element: wrap(SensorNetworksDashboard) },
  { path: '/sensor-networks/environment-link', element: wrap(SensorNetworksDevices) },
  ...
  // Sustainability
  { path: '/sustainability', element: wrap(SoilNutrientsCarbonTracker) },
