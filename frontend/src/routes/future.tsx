...
const SensorDashboard = lazy(() => import('@/pages/SensorDashboard').then(m => ({ default: m.SensorDashboard })));
...
export const futureRoutes: RouteObject[] = [
  ...
  // Sensor Networks
  { path: '/sensor-networks', element: wrapWithAppShell(SensorDashboard) },
  { path: '/sensor-networks/dashboard', element: wrapWithAppShell(SensorDashboard) },
  ...
  { path: '/sensor-networks/aggregates', element: wrapWithAppShell(SensorDashboard) },
