...
const SpatialAnalysis = lazy(() => import('@/archive/pages/SpatialAnalysis').then(m => ({ default: m.SpatialAnalysis })));
...
// Note: Programs lazy import was moved above with the wrap function
...
export const breedingRoutes: RouteObject[] = [
  ...
  { path: '/performance-ranking', element: wrap(PerformanceRanking) },
  ...
  { path: '/spatial-analysis', element: wrap(SpatialAnalysis) },
];
