...
const PlantVisionStrategy = lazy(() =>
  import("@/divisions/plant-sciences/pages/PlantVisionStrategy").then((m) => ({
    default: m.PlantVisionStrategy,
  })),
);
...
export const aiRoutes: RouteObject[] = [
  ...
  { path: "/plant-vision/strategy", element: wrapInShellLayout(PlantVisionStrategy) },
