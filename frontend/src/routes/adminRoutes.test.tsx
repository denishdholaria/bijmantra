...
describe('Admin routes', () => {
  it('registers AI diagnostics as a superuser-only route', () => {
    expect(getRoute('/ai-diagnostics')).toBeDefined()
    expect(getProtectedRouteProps('/ai-diagnostics')).toMatchObject({ requireSuperuser: true })
  })
