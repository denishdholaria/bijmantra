...
const Inspiration = lazy(() => import('@/archive/pages/Inspiration').then(m => ({ default: m.Inspiration })));
...
const Tips = lazy(() => import('@/archive/pages/Tips').then(m => ({ default: m.Tips })));
const Bioinformatics = lazy(() => import('@/archive/pages/Bioinformatics').then(m => ({ default: m.Bioinformatics })));
...
export const coreRoutes: RouteObject[] = [
  ...
  { path: '/vision-dashboard', element: <Navigate to="/ai-vision" replace /> },
  { path: '/vision/datasets', element: wrap(VisionDatasets) },
  { path: '/vision/annotate/:datasetId', element: wrap(VisionAnnotate) },
  { path: '/vision/training', element: wrap(VisionTraining) },
  { path: '/vision/registry', element: wrap(VisionRegistry) },
  ...
  { path: '/help/docs', element: wrap(Help) },
