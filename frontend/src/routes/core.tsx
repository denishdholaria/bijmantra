...
const MahasarthiDwar = lazy(() => import('@/pages/MahasarthiDwar').then(m => ({ default: m.MahasarthiDwar })));
...
export const coreRoutes: RouteObject[] = [
  ...
  { path: '/gateway', element: <ProtectedRoute><MahasarthiDwar /></ProtectedRoute> },
