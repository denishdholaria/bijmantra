...
const SeedBankAccessions = lazy(() => import('@/pages/SeedBankAccessionSearch').then(m => ({ default: m.SeedBankAccessionSearch })));
...
const canonicalSeedOperationsRoutes: RouteObject[] = [
  ...
  { path: '/seed-operations/samples', element: wrap(SeedOpsLabSamples) },
  { path: '/seed-operations/testing', element: wrap(SeedOpsLabTesting) },
  { path: '/seed-operations/certificates', element: wrap(SeedOpsCertificates) },
  { path: '/seed-operations/quality-gate', element: wrap(SeedOpsQualityGate) },
  { path: '/seed-operations/batches', element: wrap(SeedOpsBatches) },
  { path: '/seed-operations/stages', element: wrap(SeedOpsStages) },
  { path: '/seed-operations/lots', element: wrap(SeedOpsLots) },
  { path: '/seed-operations/warehouse', element: wrap(SeedOpsWarehouse) },
  { path: '/seed-operations/alerts', element: wrap(SeedOpsAlerts) },
  { path: '/seed-operations/dispatch', element: wrap(SeedOpsDispatch) },
  { path: '/seed-operations/dispatch-history', element: wrap(SeedOpsDispatchHistory) },
  { path: '/seed-operations/firms', element: wrap(SeedOpsFirms) },
  { path: '/seed-operations/track', element: wrap(SeedOpsTrack) },
  { path: '/seed-operations/lineage', element: wrap(SeedOpsLineage) },
  { path: '/seed-operations/varieties', element: wrap(SeedOpsVarieties) },
  { path: '/seed-operations/agreements', element: wrap(SeedOpsAgreements) },
];

const legacySeedOpsAliasRoutes: RouteObject[] = canonicalSeedOperationsRoutes.map(route => ({
  ...route,
  path: route.path?.replace('/seed-operations', '/seed-ops'),
}));

export const seedOpsRoutes: RouteObject[] = [
  // Seed Commerce canonical routes plus legacy seed-ops aliases
  ...canonicalSeedOperationsRoutes,
  ...legacySeedOpsAliasRoutes,
