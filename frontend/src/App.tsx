...
const EarthSystemsYieldPrediction = lazy(() => import('@/divisions/earth-systems/pages/YieldPrediction'))
...
// Soil & Nutrients Division - lazy loaded
...
// Water & Irrigation Division - lazy loaded
...
function AppRoutes() {
  ...
  // Theme is now managed by themeStore with synchronous initialization
  // No useEffect needed here - theme is applied before React renders
  // See: frontend/src/store/themeStore.ts
  ...
  return (
    <Routes>
        ...
        />
        <Route
          path="/earth-systems/yield-prediction"
          element={
            <ProtectedRoute>
              <Layout>
                <Suspense fallback={<div className="p-8 text-center">Loading...</div>}>
                  <EarthSystemsYieldPrediction />
                </Suspense>
              </Layout>
            </ProtectedRoute>
          }
        />
        <Route
          path="/earth-systems/carbon"
          element={
            <ProtectedRoute>
              <Layout>
                <Suspense fallback={<div className="p-8 text-center">Loading...</div>}>
                  {(() => {
                    const CarbonDashboard = lazy(() => import('@/divisions/earth-systems/pages/CarbonDashboard').then(m => ({ default: m.CarbonDashboard })));
        ...
        />
        <Route
          path="/earth-systems/sustainability"
          element={
            <ProtectedRoute>
              <Layout>
                <Suspense fallback={<div className="p-8 text-center">Loading...</div>}>
                  {(() => {
                    const SustainabilityMetrics = lazy(() => import('@/divisions/earth-systems/pages/SustainabilityMetrics').then(m => ({ default: m.SustainabilityMetrics })));
        ...
        {/* Mini-gateway for 83+ Plant Sciences pages                    */}
        {/* @see docs/gupt/think-tank/think-tank.md §5.1                 */}
        {/* ============================================================ */}
        <Route
          path="/plant-sciences"
          element={
        ...
        <Route path="/crop-intelligence/gdd" element={<ProtectedRoute><Layout><Suspense fallback={<div className="p-8 text-center">Loading...</div>}><EarthSystemsGDD /></Suspense></Layout></ProtectedRoute>} />
        ...
        <Route path="/soil-nutrients" element={<ProtectedRoute><Layout><Suspense fallback={<div className="p-8 text-center">Loading...</div>}><SoilNutrientsDashboard /></Suspense></Layout></ProtectedRoute>} />
        <Route path="/soil-nutrients/soil-tests" element={<ProtectedRoute><Layout><Suspense fallback={<div className="p-8 text-center">Loading...</div>}><SoilNutrientsSoilTests /></Suspense></Layout></ProtectedRoute>} />
        <Route path="/soil-nutrients/soil-health" element={<ProtectedRoute><Layout><Suspense fallback={<div className="p-8 text-center">Loading...</div>}><SoilNutrientsSoilHealth /></Suspense></Layout></ProtectedRoute>} />
        
        {/* Tier 1: Crop Protection */}
        <Route path="/crop-protection" element={<ProtectedRoute><Layout><Suspense fallback={<div className="p-8 text-center">Loading...</div>}><CropProtectionDashboard /></Suspense></Layout></ProtectedRoute>} />
        ...
        <Route path="/water-irrigation" element={<ProtectedRoute><Layout><Suspense fallback={<div className="p-8 text-center">Loading...</div>}><WaterIrrigationDashboard /></Suspense></Layout></ProtectedRoute>} />
        <Route path="/water-irrigation/schedules" element={<ProtectedRoute><Layout><Suspense fallback={<div className="p-8 text-center">Loading...</div>}><WaterIrrigationSchedules /></Suspense></Layout></ProtectedRoute>} />
        <Route path="/water-irrigation/balance" element={<ProtectedRoute><Layout><Suspense fallback={<div className="p-8 text-center">Loading...</div>}><WaterIrrigationBalance /></Suspense></Layout></ProtectedRoute>} />
        <Route path="/water-irrigation/moisture" element={<ProtectedRoute><Layout><Suspense fallback={<div className="p-8 text-center">Loading...</div>}><WaterIrrigationMoisture /></Suspense></Layout></ProtectedRoute>} />
        ...
        {/* Catch all - Redirect to Gateway instead of 404 for unknown routes to keep user in flow */}
        <Route path="*" element={<Navigate to="/gateway" replace />} />
      </Routes>
  )
}
