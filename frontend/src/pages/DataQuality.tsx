...
export function DataQuality() {
  ...
  const { data: issuesData, isLoading: issuesLoading } = useQuery({
    ...
    queryFn: async () => {
      try {
        ...
        return await apiClient.dataQualityService.getQualityIssues(params)
      } catch {
  ...
  const { data: metricsData } = useQuery({
    ...
    queryFn: async () => {
      try {
        return await apiClient.dataQualityService.getQualityMetrics()
      } catch {
        return []
      }
    },
...
interface QualityStats {
  ...
  const stats = statsData || { totalIssues: 0, openIssues: 0, resolvedIssues: 0, resolutionRate: 0, ignoredIssues: 0 }
