		...
		<div className="flex flex-col h-[calc(100dvh-3rem)]">
			...
			{!effectiveBackend.ready && (
				...
				>
					...
					<span className="text-xs text-amber-700 dark:text-amber-400">Add your AI provider API key to get started</span>
			...
			<div className="flex-1 overflow-y-auto overscroll-contain">
				{messages.length === 0 ? (
					<div className="flex flex-col items-center justify-center h-full px-6 py-12">
						...
						<p className="text-sm text-slate-500 dark:text-slate-400 mb-8 text-center max-w-md">Your intelligent breeding assistant. Ask about trials, germplasm, genetic data, or get breeding recommendations.</p>
