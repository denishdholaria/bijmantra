...
export function Events() {
  ...
  const { data, isLoading, error } = useQuery({
    ...
    queryFn: () => apiClient.eventsService.getEvents(selectedStudy === 'all' ? undefined : selectedStudy, page, pageSize),
  })

  const createMutation = useMutation({
    mutationFn: () => apiClient.eventsService.createEvent({
        ...
        <CardContent className="p-0">
          {isLoading ? (
            ...
            <div className="p-12 text-center">
              ...
              <Button variant="outline" onClick={() => queryClient.invalidateQueries({ queryKey: ['events'] })}>
