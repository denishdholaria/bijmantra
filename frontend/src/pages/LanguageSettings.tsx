...
export function LanguageSettings() {
  ...
  const languages = useMemo(() => (languagesData?.data || []) as Language[], [languagesData])
  ...
  const stats = statsData?.data as LanguageStats | undefined
  ...
  const translationKeys = useMemo(() => (keysData?.data || []) as TranslationKey[], [keysData])
  ...
  const selectedLang = useMemo(() => languages.find((l) => l.code === selectedLanguage), [languages, selectedLanguage])
