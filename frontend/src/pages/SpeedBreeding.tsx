...
export function SpeedBreeding() {
  ...
  const { data: protocols = [], isLoading: loadingProtocols } = useQuery({
    ...
    queryFn: () => apiClient.getSpeedBreedingProtocols({
