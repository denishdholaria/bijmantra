 ...
 * Dual License: AGPL-3.0 + Commercial (January 2025)
 */
    ...
    <div className="space-y-6 animate-fade-in max-w-4xl mx-auto">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-muted-foreground mt-1">Dual License: AGPL-3.0 + Commercial (January 2025)</p>
        </div>
        <Link to="/privacy">
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          ...
          <div className="text-center pt-2">
            <a href="mailto:hello@bijmantra.org?subject=Bijmantra Commercial License Inquiry">
              <Button>
      ...
      <Card className="border-2 border-red-200 bg-gradient-to-br from-red-50 to-orange-50">
        ...
        <CardContent className="space-y-4">
          ...
          <div className="bg-white/70 rounded-lg p-4 text-center">
            ...
            <p className="text-red-600 font-semibold mt-2">— The Founder</p>
          </div>
        </CardContent>
      </Card>
      ...
      <Card className="border-green-200 bg-green-50">
        <CardContent className="pt-6">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            ...
            <a href="mailto:hello@bijmantra.org">
