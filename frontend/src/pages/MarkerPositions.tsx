...
export function MarkerPositions() {
  ...
  const { data: mapsData } = useQuery({
    ...
    queryFn: () => apiClient.getMaps({ pageSize: 50 }),
  })
  ...
  return (
    <div className="space-y-6 animate-fade-in">
      ...
      {error ? (
        <Card><CardContent className="py-12 text-center"><p className="text-red-500">Error loading marker positions: {(error as Error).message}</p></CardContent></Card>
