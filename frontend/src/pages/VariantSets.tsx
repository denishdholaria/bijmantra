...
export function VariantSets() {
  ...
  return (
    <div className="space-y-6 animate-fade-in">
      ...
      {error ? (
        <Card><CardContent className="py-12 text-center"><p className="text-red-500">Error loading variant sets: {(error as Error).message}</p></CardContent></Card>
