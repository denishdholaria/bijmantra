...
import { 
  ...
  ArrowLeft, TrendingUp, Clock, AlertCircle, RefreshCw
} from 'lucide-react';
...
export function VisionRegistry() {
  ...
  const fetchData = useCallback(async () => {
    ...
    try {
      ...
      setError('Failed to load model registry. Please check your connection.');
    } finally {
      setLoading(false);
    }
  }, []);
  ...
  }, [debouncedSearchQuery, cropFilter, sortBy]);
