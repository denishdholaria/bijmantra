...
export function Observations() {
  ...
  const { data, isLoading, error } = useQuery({
    ...
    queryFn: () => apiClient.observationService.getObservations(selectedStudy === 'all' ? undefined : selectedStudy, page, pageSize),
    enabled: true,
  })

  const studies = studiesData?.result?.data || []
  const observations: Observation[] = data?.result?.data || []
        ...
        <CardContent className="p-0">
          {isLoading ? (
            ...
            <div className="p-12 text-center">
              ...
              <Button variant="outline" onClick={() => queryClient.invalidateQueries({ queryKey: ['observations'] })}>
