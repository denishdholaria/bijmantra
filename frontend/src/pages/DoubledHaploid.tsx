...
export function DoubledHaploid() {
  ...
  const { data: protocols = [], isLoading: loadingProtocols } = useQuery({
    ...
    queryFn: () => apiClient.doubledHaploidService.getProtocols({
  ...
  const { data: batches = [], isLoading: loadingBatches } = useQuery({
    queryKey: ['dh-batches'],
    queryFn: () => apiClient.doubledHaploidService.getBatches()
  })

  // Fetch statistics
  const { data: stats, isLoading: loadingStats } = useQuery({
    queryKey: ['dh-statistics'],
    queryFn: () => apiClient.doubledHaploidService.getStatistics()
  })
