...
export function PedigreeViewer() {
  ...
  const renderTreeNode = (node: PedigreeNode, depth: number = 0): React.ReactNode => {
    const indent = depth * 40
    const colors = [
      'bg-green-100 border-green-500 dark:bg-green-900/20 dark:border-green-700',
      'bg-blue-100 border-blue-500 dark:bg-blue-900/20 dark:border-blue-700',
      'bg-purple-100 border-purple-500 dark:bg-purple-900/20 dark:border-purple-700',
      'bg-orange-100 border-orange-500 dark:bg-orange-900/20 dark:border-orange-700'
    ]
  ...
  if (error && !useMockData) {
    return (
      <div className="p-12 text-center">
        ...
        <h3 className="text-lg font-semibold text-red-600 dark:text-red-400 mb-2">Error Loading Pedigree</h3>
