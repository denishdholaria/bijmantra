    ...
    <div className="space-y-4 lg:space-y-6 animate-fade-in">
      <div className="bg-gradient-to-r from-blue-600 to-cyan-600 rounded-xl lg:rounded-2xl shadow-xl p-4 lg:p-8 text-white">
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
          ...
          <Link
            to="/studies/new"
            className="px-4 lg:px-6 py-2 lg:py-3 bg-white text-blue-600 rounded-lg font-semibold hover:bg-blue-50 transition-colors shadow-lg hover:shadow-xl text-sm lg:text-base whitespace-nowrap"
          >
            ➕ New Study
          </Link>
        </div>
      ...
      <div className="bg-white rounded-lg shadow overflow-hidden">
        {isLoading ? (
          <div className="text-center py-12 text-gray-500">Loading studies...</div>
        ) : error ? (
          <div className="text-center py-12 text-red-500">Error loading studies</div>
        ) : studies.length === 0 ? (
              ...
              <table className="min-w-full divide-y divide-gray-200" style={{ minWidth: '640px' }}>
                ...
                <tbody className="bg-white divide-y divide-gray-200">
                  {studies.map((study: any) => (
                    <tr key={study.studyDbId} className="hover:bg-gray-50">
