...
const changelog: ChangelogEntry[] = [
  ...
  },
  {
    ...
    date: '2025-11-30',
    changes: [
      { type: 'added', description: 'REEVU with multi-provider support' },
  ...
  },
  {
    ...
    changes: [
      ...
      { type: 'added', description: 'Low-connectivity field capture' },
      { type: 'added', description: '201 official BrAPI v2.1 operations published' },
    ],
  },
]
