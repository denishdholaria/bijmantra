        ...
        <div className="relative z-10 flex flex-col justify-between p-12 xl:p-16 w-full">
          ...
          <div>
            <div className="flex items-center gap-4 mb-4">
              <div className="w-16 h-16 bg-white/20 backdrop-blur-sm rounded-2xl flex items-center justify-center shadow-2xl overflow-hidden p-3">
      ...
      <div className="w-full lg:w-1/2 xl:w-2/5 flex items-center justify-center p-6 sm:p-12 bg-gradient-to-br from-prakruti-dhool-50 via-white to-prakruti-patta-pale/30 dark:from-prakruti-dhool-900 dark:via-prakruti-dhool-900 dark:to-prakruti-patta/10 font-sans">
        <div className="w-full max-w-md animate-fade-in">
          ...
          <div className="lg:hidden text-center mb-8">
            <div className="inline-flex items-center justify-center w-20 h-20 bg-gradient-to-br from-prakruti-patta to-prakruti-patta-dark rounded-2xl shadow-lg mb-4 overflow-hidden p-4">
              <img src="/icons/icon-192x192.png" alt="Bijmantra" className="w-full h-full object-contain filter drop-shadow-md invert brightness-0" />
            </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  required
                  autoComplete="off"
                  className="w-full pl-12 pr-12 py-3.5 bg-white dark:bg-slate-800 text-gray-900 dark:text-white border-2 border-gray-200 dark:border-slate-700 rounded-xl focus:outline-none focus:ring-2 focus:ring-green-500/20 focus:border-green-500 transition-all placeholder-gray-400 dark:placeholder-gray-500"
                  placeholder="••••••••"
                />
                <button
                  type="button"
          ...
          <div className="mt-6 p-4 bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-800 rounded-xl">
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1">
                <p className="text-sm font-semibold text-amber-800 dark:text-amber-200 mb-2">Demo Credentials</p>
                <div className="space-y-1 text-xs text-amber-700 dark:text-amber-300">
                  <p><span className="font-medium">Email:</span> <span className="font-mono">demo@bijmantra.org</span></p>
                  <p><span className="font-medium">Password:</span> <span className="font-mono">Demo123!</span></p>
                </div>
              </div>
              <button
                type="button"
