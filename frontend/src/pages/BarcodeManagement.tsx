    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-gray-600 dark:text-gray-400 mt-1">Generate, scan, and manage barcodes</p>
        </div>
          ...
          <CardContent className="pt-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-500 dark:text-gray-400">Total Barcodes</p>
              </div>
            </div>
          </CardContent>
        </Card>
      ...
      <Tabs defaultValue="scanner" className="space-y-4">
          ...
          <Card>
            <CardContent className="p-0">
              {isLoading ? (
                ...
                <div className="p-8 text-center text-gray-500 dark:text-gray-400">No barcodes found</div>
              ) : (
                  ...
                  <table className="w-full">
                    <thead className="bg-gray-50 dark:bg-slate-900 border-b dark:border-slate-700">
                      <tr>
                        ...
                        <th className="px-4 py-3 text-center text-xs font-medium text-gray-500 dark:text-gray-400 uppercase">Scans</th>
                    ...
                    <tbody className="divide-y dark:divide-slate-700">
                      {filteredBarcodes.map((barcode) => (
                        <tr key={barcode.id} className="hover:bg-gray-50 dark:hover:bg-slate-700">
                          ...
                          <td className="px-4 py-3 text-center">
                            {barcode.active ? (
                              <Badge className="bg-green-100 dark:bg-green-900/40 text-green-800 dark:text-green-300">Active</Badge>
                            ) : (
        ...
        <TabsContent value="history">
          <Card>
            ...
            <CardContent className="p-0">
              {scans.length === 0 ? (
                <div className="p-8 text-center text-gray-500 dark:text-gray-400">No scan history</div>
              ) : (
                <div className="overflow-x-auto">
                  <table className="w-full">
                    <thead className="bg-gray-50 dark:bg-slate-900 border-b dark:border-slate-700">
                      <tr>
                        ...
                        <th className="px-4 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase">Entity</th>
                        <th className="px-4 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase">Scanned By</th>
                      </tr>
                    </thead>
                    <tbody className="divide-y dark:divide-slate-700">
                      {scans.map((scan: any) => (
                        <tr key={scan.id} className="hover:bg-gray-50 dark:hover:bg-slate-700">
                          <td className="px-4 py-3 text-sm text-gray-600 dark:text-gray-400">
                          ...
                          <td className="px-4 py-3 text-sm text-gray-600 dark:text-gray-400">{scan.scanned_by}</td>
                        </tr>
                      ))}
                    </tbody>
                  </table>
