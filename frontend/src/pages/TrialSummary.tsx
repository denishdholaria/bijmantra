...
import { apiClient, TrialInfo, TopPerformer, TraitSummaryItem, LocationPerformance } from '@/lib/api-client'
...
export function TrialSummary() {
  ...
  const { data: trialsData, isLoading: trialsLoading } = useQuery({
    ...
    queryFn: () => apiClient.trialSummaryService.getTrials(),
  })
  ...
  const { data: summaryData, isLoading: summaryLoading } = useQuery({
    ...
    queryFn: () => apiClient.trialSummaryService.getSummary(selectedTrial),
  ...
  const handleExport = async () => {
    try {
      const result = await apiClient.trialSummaryService.exportSummary(selectedTrial, 'pdf')
