...
export function BreedingValues() {
  ...
  const calculateMutation = useMutation({
    mutationFn: async () => {
      const phenotypes: Array<{ id: string; value: number }> = [
        { id: 'G001', value: 5.2 },
        { id: 'G002', value: 5.8 },
        { id: 'G003', value: 4.5 },
        { id: 'G004', value: 4.2 },
  ...
  const methods: MethodOption[] = (methodsData?.data?.length ? methodsData.data.map(methodOption => ({
    id: (methodOption.id || methodOption.code || methodOption.name).toUpperCase(),
    name: methodOption.name,
    description: methodOption.description,
  })) : [
    ...
    { id: 'SSBLUP', name: 'ssGBLUP', description: 'Single-Step GBLUP combining pedigree and genomic' },
  ])
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              <p className="font-medium text-blue-800">
                ...
                {method === 'SSBLUP' && 'Single-Step GBLUP (ssGBLUP)'}
              </p>
