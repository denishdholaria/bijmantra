    ...
    <div className="space-y-8 animate-fade-in max-w-5xl mx-auto">
          ...
          <div className="bg-white/70 dark:bg-slate-800/70 rounded-xl p-6 max-w-3xl mx-auto">
            <div className="prose prose-green dark:prose-invert max-w-none">
              <p className="text-foreground leading-relaxed text-lg">
                ...
                At the age of twelve, while most children were playing cricket, a young boy (Denish Dholaria) in Gujarat, India 
              ...
              <div className="bg-emerald-50 dark:bg-emerald-900/30 rounded-lg p-4 mt-6 border-l-4 border-emerald-500">
                ...
                <p className="text-emerald-600 dark:text-emerald-400 font-semibold mt-2">— The Founder</p>
              </div>
            </div>
          </div>
        </CardContent>
      ...
      <Card>
        <CardHeader className="text-center pb-2">
          ...
          <CardTitle className="text-2xl">Hare Krishna</CardTitle>
          <CardDescription className="text-base">
            Creator & Lead Developer
            <span className="text-xs block mt-1 opacity-70">(Denish Dholaria)</span>
          </CardDescription>
        </CardHeader>
      ...
      <Card className="border-2 border-blue-200 dark:border-blue-800 bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-blue-950/30 dark:to-indigo-950/30">
        <CardHeader className="text-center pb-2">
          ...
          <CardTitle className="text-xl text-blue-800 dark:text-blue-300">Teachers Who Shaped This Work</CardTitle>
        ...
        <CardContent className="space-y-4">
          <p className="text-center text-foreground max-w-2xl mx-auto">
            The knowledge carried forward was shaped by exceptional educators. Gratitude 
            for their patience, wisdom, and dedication to teaching remains eternal.
          </p>
          ...
          <p className="text-center text-sm text-muted-foreground italic mt-4">
            Whatever is known came from teachers. Whatever errors exist are the creator's alone.
          </p>
        </CardContent>
      </Card>
      ...
      <Card className="border-2 border-rose-200 dark:border-rose-800 bg-gradient-to-br from-rose-50 via-pink-50 to-orange-50 dark:from-rose-950/30 dark:via-pink-950/30 dark:to-orange-950/30">
        <CardHeader className="text-center pb-2">
          ...
          <CardTitle className="text-xl text-rose-800 dark:text-rose-300"> Inspiration </CardTitle>
          ...
          <div className="text-center">
            <Link to="/inspiration">
              <Button variant="outline" className="border-rose-300 text-rose-700 hover:bg-rose-50 dark:border-rose-700 dark:text-rose-300 dark:hover:bg-rose-950/50">
                <span className="mr-2">🏛️</span> Visit the Inspiration Wall
              </Button>
            </Link>
          </div>
        </CardContent>
      ...
      <div className="text-center py-8 space-y-4">
        ...
        <div className="flex items-center justify-center gap-4 flex-wrap">
          ...
          <Link to="/inspiration">
            <Button variant="outline" className="border-rose-300 text-rose-700 hover:bg-rose-50 dark:border-rose-700 dark:text-rose-300 dark:hover:bg-rose-950/50">
              <span className="mr-2">🏛️</span> Inspiration Wall
            </Button>
          </Link>
          <Link to="/vision">
        ...
        <div className="mt-6 space-y-1">
          <p className="text-xs text-muted-foreground">
            © 2025 Bijmantra by Denish Dholaria • Open Source Agricultural Research Platform
          </p>
          <p className="text-xs text-muted-foreground">
