...
import { AlertCircle, Cloud, Droplets, Wind, Sun, Thermometer, Calendar, Activity } from 'lucide-react'
...
export function Weather() {
  ...
  const { data: forecast, isLoading, error } = useQuery({
    ...
    queryFn: () => apiClient.getWeatherForecast(selectedLocation, locationName, forecastDays),
