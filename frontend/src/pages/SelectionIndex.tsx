 ...
 * Calculate breeding selection indices
 */
...
const defaultTraits: Trait[] = [
  { id: 't1', name: 'Yield', weight: 40, heritability: 0.65, economicValue: 100, direction: 'higher' },
  { id: 't2', name: 'Plant Height', weight: 15, heritability: 0.80, economicValue: 20, direction: 'lower' },
  { id: 't3', name: 'Days to Maturity', weight: 20, heritability: 0.75, economicValue: 30, direction: 'lower' },
  { id: 't4', name: 'Disease Resistance', weight: 25, heritability: 0.50, economicValue: 50, direction: 'higher' },
]

const mockGermplasm: GermplasmScore[] = [
  { id: 'g1', name: 'IR64', traitValues: { t1: 6.5, t2: 95, t3: 115, t4: 7 } },
  { id: 'g2', name: 'Nipponbare', traitValues: { t1: 5.8, t2: 110, t3: 125, t4: 5 } },
  { id: 'g3', name: 'Kasalath', traitValues: { t1: 4.2, t2: 130, t3: 140, t4: 8 } },
  { id: 'g4', name: 'Azucena', traitValues: { t1: 5.5, t2: 145, t3: 135, t4: 6 } },
  { id: 'g5', name: 'Moroberekan', traitValues: { t1: 4.8, t2: 140, t3: 130, t4: 9 } },
  { id: 'g6', name: 'CO39', traitValues: { t1: 6.2, t2: 85, t3: 110, t4: 4 } },
  { id: 'g7', name: 'IRBB21', traitValues: { t1: 5.9, t2: 100, t3: 118, t4: 8 } },
  { id: 'g8', name: 'Swarna', traitValues: { t1: 7.0, t2: 90, t3: 145, t4: 6 } },
]

export function SelectionIndex() {
  const [traits, setTraits] = useState<Trait[]>(defaultTraits)
  const [germplasm, setGermplasm] = useState<GermplasmScore[]>(mockGermplasm)
  ...
  const calculateIndex = () => {
    // Normalize trait values and calculate index scores
    ...
    setGermplasm(scored)
    setCalculated(true)
    toast.success('Selection index calculated')
  }
        ...
        <Card>
          ...
          <CardContent className="space-y-6">
            ...
            <div className="p-4 bg-muted rounded-lg space-y-2">
              <h4 className="font-medium">Index Formula</h4>
              <p className="text-xs font-mono">
                I = Σ(w<sub>i</sub> × h²<sub>i</sub> × z<sub>i</sub>)
              </p>
              <p className="text-xs text-muted-foreground">
                where w = weight, h² = heritability, z = standardized value
              </p>
            </div>
          ...
          <Table>
            <TableHeader>
              <TableRow>
                ...
                {traits.map(t => (
                  <TableHead key={t.id} className="text-right">{t.name}</TableHead>
                ))}
