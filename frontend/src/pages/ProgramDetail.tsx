...
export function ProgramDetail() {
  ...
  const deleteMutation = useMutation({
    mutationFn: () => apiClient.programService.deleteProgram(programDbId!),
    onSuccess: () => {
    ...
    return (
      <div className="max-w-4xl mx-auto">
        <div className="bg-white dark:bg-slate-800 rounded-xl shadow-lg border border-gray-100 dark:border-slate-700 p-12 text-center">
          ...
          <Link
            to="/programs"
            className="inline-flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-green-600 to-emerald-600 dark:from-green-700 dark:to-emerald-700 text-white rounded-lg hover:from-green-700 hover:to-emerald-700 font-semibold shadow-lg transition-all"
          >
            ← Back to Programs
          </Link>
        </div>
