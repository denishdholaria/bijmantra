    ...
    <div className="max-w-5xl mx-auto space-y-6 animate-fade-in">
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-2xl lg:text-3xl font-bold text-gray-900">{program.programName}</h1>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <Card>
            ...
            <CardContent>
              {program.objective ? (
                <p className="text-gray-700 leading-relaxed whitespace-pre-wrap">{program.objective}</p>
              ) : (
            ...
            <CardContent>
              <dl className="space-y-4">
                <div>
                  ...
                  <dd className="text-sm text-gray-900 font-mono mt-1 bg-muted px-2 py-1 rounded">
                    {program.programDbId}
                  </dd>
                </div>
                {program.abbreviation && (
                  <div>
                    ...
                    <dd className="text-gray-900 mt-1">{program.abbreviation}</dd>
                  </div>
                )}
                {program.leadPersonDbId && (
                  <div>
                    <dt className="text-sm font-semibold text-muted-foreground">Lead Person</dt>
                    <dd className="text-gray-900 mt-1">{program.leadPersonDbId}</dd>
                  </div>
                )}
              </dl>
            </CardContent>
