...
export function Programs() {
  ...
  const { data, isLoading, error } = useQuery({
    ...
    queryFn: () => apiClient.getPrograms(page, pageSize),
  })
    ...
    <div className="space-y-4 lg:space-y-6">
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-gray-600 mt-1 text-sm lg:text-base">Manage your breeding programs</p>
        </div>
        <Button asChild>
      ...
      <Card>
        ...
        {isLoading ? (
          ...
          <div className="p-12 text-center">
            ...
            <h3 className="text-lg font-semibold text-red-600 mb-2">Error Loading Programs</h3>
          ...
          <div className="p-12 text-center">
            ...
            <p className="text-gray-600 mb-6 max-w-md mx-auto">Get started by creating your first breeding program to organize your trials and studies</p>
            <Link
              to="/programs/new"
              ...
              <table className="w-full min-w-[640px]">
                ...
                <tbody className="bg-white divide-y divide-gray-200">
                  {programs.map((program: any) => (
                    <tr key={program.programDbId} className="hover:bg-gray-50 transition-colors">
