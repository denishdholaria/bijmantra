    ...
    try {
      ...
      if (useHybridMode && chromeAIAvailable && isSimpleQuery(content)) {
        ...
        try {
          ...
          console.error('Chrome AI failed, falling back to cloud:', chromeError)
    ...
    <div className="space-y-6 animate-fade-in">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-2">
          ...
          <Link to="/ai-settings">
            <Button variant="outline" size="sm" aria-label="Settings">⚙️ Settings</Button>
          </Link>
        </div>
      </div>
                ...
                {includeData && (
                  <div className="text-xs space-y-1">
                    {loadingData ? (
                      ...
                      <>
                        <p className="text-green-600 dark:text-green-400">✓ Data context loaded</p>
                        ...
                        <Button 
                          ...
                          aria-label="Refresh data context"
                        >
                          🔄 Refresh
                        </Button>
                      </>
                    ) : (
                      <p className="text-yellow-600 dark:text-yellow-400">⚠️ No data available (backend may be offline)</p>
                    )}
                  </div>
                )}
              </div>
              ...
              <div className="mt-4 pt-4 border-t space-y-3">
                ...
                <div className="text-xs space-y-1">
                  {chromeAIStatus?.apis.languageModel === 'readily' ? (
                    <p className="text-green-600 dark:text-green-400">✓ Chrome AI available</p>
                  ) : chromeAIStatus?.apis.languageModel === 'after-download' ? (
                    <p className="text-yellow-600 dark:text-yellow-400">⏳ Chrome AI needs download</p>
                  ) : (
          ...
          <Card className="lg:col-span-3 flex flex-col h-[600px]">
            <CardHeader className="pb-2 flex-shrink-0">
              <div className="flex items-center justify-between">
                ...
                <Button variant="ghost" size="sm" onClick={clearChat} aria-label="Clear chat">🗑️ Clear</Button>
              </div>
            </CardHeader>
