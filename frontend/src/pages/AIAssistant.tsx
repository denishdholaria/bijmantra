        ...
        <Card className="border-yellow-200 bg-yellow-50">
          <CardContent className="pt-6">
            <div className="text-center space-y-4">
              ...
              <h3 className="text-xl font-bold">Configure AI to Get Started</h3>
              <p className="text-muted-foreground max-w-md mx-auto">
                Add your AI provider API key to enable intelligent data analysis, 
                breeding recommendations, and natural language queries.
              </p>
              <Link to="/ai-settings">
                <Button>⚙️ Configure AI Settings</Button>
              </Link>
            </div>
          </CardContent>
        </Card>
