...
const sampleBatches: NurseryBatch[] = [
  { id: 'NB001', germplasm: 'Elite Variety 2024', sowingDate: '2024-11-15', expectedTransplant: '2024-12-15', quantity: 500, germinated: 475, healthy: 450, status: 'ready', location: 'Greenhouse A' },
  { id: 'NB002', germplasm: 'High Yield Line A', sowingDate: '2024-11-20', expectedTransplant: '2024-12-20', quantity: 300, germinated: 280, healthy: 265, status: 'growing', location: 'Greenhouse A' },
  { id: 'NB003', germplasm: 'Disease Resistant B', sowingDate: '2024-11-25', expectedTransplant: '2024-12-25', quantity: 400, germinated: 350, healthy: 340, status: 'germinating', location: 'Greenhouse B' },
  { id: 'NB004', germplasm: 'Test Line 001', sowingDate: '2024-11-28', expectedTransplant: '2024-12-28', quantity: 200, germinated: 0, healthy: 0, status: 'sowing', location: 'Greenhouse B' },
  { id: 'NB005', germplasm: 'Variety 2023', sowingDate: '2024-11-01', expectedTransplant: '2024-12-01', quantity: 600, germinated: 580, healthy: 560, status: 'transplanted', location: 'Field A' },
]

export function NurseryManagement() {
  const [batches, setBatches] = useState<NurseryBatch[]>(sampleBatches)
