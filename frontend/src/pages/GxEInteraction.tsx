...
import { gxeAnalysisAPI, type GxEResult } from '@/lib/api-client'
...
// TODO: Replace with trial selection UI that fetches real trial data
...
export function GxEInteraction() {
  ...
  const { data: methodsData } = useQuery({
    ...
    queryFn: () => gxeAnalysisAPI.getMethods(),
    staleTime: 1000 * 60 * 60, // Cache for 1 hour
  })

  // For now, use demo data with a clear indicator
  // Future: Add trial/study selector to fetch real observations
