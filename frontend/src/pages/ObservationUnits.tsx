...
export function ObservationUnits() {
  ...
  const { data, isLoading, error } = useQuery({
    ...
    queryFn: () => apiClient.observationService.getObservationUnits(selectedStudy === 'all' ? undefined : selectedStudy, page, pageSize),
  })

  const studies = studiesData?.result?.data || []
  const units: ObservationUnit[] = data?.result?.data || []
    ...
    return (
      <div className="flex items-center justify-center h-[50vh]">
        <div className="text-center">
          ...
          <p className="text-muted-foreground">Please select a workspace to view observation units.</p>
        </div>
      </div>
    )
  }
        ...
        <CardContent className="p-0">
          {isLoading ? (
            ...
            <div className="p-12 text-center">
              ...
              <Button variant="outline" onClick={() => queryClient.invalidateQueries({ queryKey: ['observationunits'] })}>
