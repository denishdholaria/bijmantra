    ...
    <div className="space-y-6 animate-fade-in max-w-4xl mx-auto">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Bijmantra is developed by R.E.E.V.A.i</CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-muted-foreground">Founder, R.E.E.V.A.i</p>
          ...
          <p className="text-sm text-muted-foreground">
            R.E.E.V.A.i (Redefining Excellence & Empowering Visionary Artificial Intelligence) 
            is dedicated to building intelligent tools for agriculture and plant breeding.
            The name is inspired by my daughter REEVA - representing hope, innovation, and the future.
          </p>
        </CardContent>
      </Card>
