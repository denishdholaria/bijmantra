    ...
    <div className="space-y-6 animate-fade-in max-w-4xl mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <Card className="hover:shadow-md transition-shadow">
          <CardContent className="pt-6 text-center">
            ...
            <h3 className="font-semibold mt-3">REEVU</h3>
            <p className="text-sm text-muted-foreground mt-1">
              Get instant answers to your questions
            </p>
            <Link to="/ai-assistant">
              <Button className="mt-4" size="sm">Ask REEVU</Button>
            </Link>
          </CardContent>
        </Card>
        <Card className="hover:shadow-md transition-shadow">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Bijmantra is created by Hare Krishna</CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h3 className="font-semibold text-lg">Hare Krishna</h3>
      ...
      <Card>
        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <a 
              href="https://gitlab.com/denishdholaria/bijmantraorg/issues" 
              target="_blank" 
              rel="noopener noreferrer"
              className="p-4 bg-muted rounded-lg hover:bg-muted/80 transition-colors flex items-center gap-3"
            >
            ...
            <a 
              href="https://gitlab.com/denishdholaria/bijmantraorg/discussions" 
              target="_blank" 
              rel="noopener noreferrer"
              className="p-4 bg-muted rounded-lg hover:bg-muted/80 transition-colors flex items-center gap-3"
            >
        ...
        <CardContent className="pt-4">
          <div className="flex items-center gap-3 text-sm text-muted-foreground">
            ...
            <p>
              ...
              For urgent matters, please use REEVU for immediate help.
            </p>
          </div>
        </CardContent>
      </Card>
