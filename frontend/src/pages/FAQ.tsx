...
const faqItems: FAQItem[] = [
  // Getting Started
  {
    ...
    answer: 'Bijmantra is a modern plant breeding management platform with BrAPI-compatible interoperability. It helps breeders manage their breeding programs, trials, germplasm, and phenotypic data. The name "Bijmantra" comes from Sanskrit, meaning "seed mantra" - reflecting our mission to empower plant breeders.',
    category: 'getting-started'
  },
  {
    id: 'gs-2',
    question: 'Do I need a backend server?',
    answer: 'Bijmantra works in "demo mode" without a backend server, allowing you to explore the interface. For full functionality with data persistence, you\'ll need to connect to a BrAPI-compatible backend server. The app automatically detects if a backend is available.',
    category: 'getting-started'
  },
  {
    id: 'gs-3',
  ...
  },
  {
    ...
    answer: 'Bijmantra is low-connectivity aware rather than broadly offline-first. After login, some field workflows can buffer draft work and sync when connectivity returns, but offline behavior depends on the specific surface and deployment.',
    category: 'data'
  },
  ...
  // AI Features
  {
    ...
    answer: 'REEVU is Bijmantra\'s primary in-app AI for breeding analysis, scientific reasoning, and recommendations. It can run through managed providers configured in AI Settings. Chrome Built-in AI remains available as a secondary local option for on-device help when supported by your browser.',
    category: 'ai'
  },
  {
    id: 'ai-2',
    question: 'Do I need an API key for AI features?',
    answer: 'Not always. If your organization has already configured a managed REEVU provider, you can use REEVU without adding your own key. If no managed provider is configured yet, an administrator can add one in Settings → AI Settings. Chrome Built-in AI runs locally in your browser and does not require an API key.',
    category: 'ai'
  },
  {
    id: 'ai-3',
  ...
  // Technical
  {
    ...
    answer: 'BrAPI (Breeding API) is a standardized RESTful web service specification for plant breeding data. It enables interoperability between breeding databases and tools. Bijmantra supports BrAPI v2.1 interoperability for data exchange.',
    category: 'technical'
  },
  {
    id: 'tech-2',
    question: 'Can I connect to my existing BrAPI server?',
    answer: 'Yes. Bijmantra can connect to BrAPI v2.1 compatible servers. Configure the server URL in Settings. The app will use that server for data storage and retrieval.',
    category: 'technical'
  },
  {
    id: 'tech-3',
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  Ask REEVU or check the documentation
                </p>
              </div>
            </div>
            <div className="flex gap-2">
              <Link to="/ai-assistant">
                <Button>🤖 Ask REEVU</Button>
              </Link>
              <Link to="/glossary">
