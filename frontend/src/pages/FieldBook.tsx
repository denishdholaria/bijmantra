...
import { fieldBookAPI } from '@/lib/api-client'
...
export function FieldBook() {
  ...
  const { data: traitsData } = useQuery({
    ...
    queryFn: () => fieldBookAPI.getStudyTraits(selectedStudyId),
    enabled: !!selectedStudyId,
  })
  ...
  const { data: progressData } = useQuery({
    ...
    queryFn: () => fieldBookAPI.getProgress(selectedStudyId),
    enabled: !!selectedStudyId,
  })
  ...
  const recordObservationMutation = useMutation({
    mutationFn: (data: { studyId: string; plotId: string; traitId: string; value: any }) =>
      fieldBookAPI.recordObservation({
