...
import { ChevronLeft, ChevronRight, Save, Grid3X3, BarChart3, Clipboard } from 'lucide-react'
...
export function FieldBook() {
  const [selectedStudyId] = useState<string>('STD-001')
  ...
  // Fetch studies
  const { isLoading: studiesLoading } = useQuery({
