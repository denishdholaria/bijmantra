...
import { germplasmCollectionAPI } from '@/lib/api-client'
...
export function GermplasmCollection() {
  ...
  const { data: collectionsData, isLoading } = useQuery({
    ...
    queryFn: () => germplasmCollectionAPI.getCollections({ search: search || undefined }),
  })

  // Fetch stats
  const { data: statsData } = useQuery({
    queryKey: ['germplasm-collection-stats'],
    queryFn: () => germplasmCollectionAPI.getStats(),
  })
