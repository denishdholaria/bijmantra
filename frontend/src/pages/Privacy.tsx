      ...
      <Card className="border-green-200 bg-green-50 dark:bg-green-900/20 dark:border-green-800">
        <CardContent className="pt-6">
          <div className="flex items-start gap-4">
            ...
            <div>
              <h3 className="font-semibold text-green-800 dark:text-green-400">Privacy First</h3>
        ...
        <CardContent className="space-y-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="p-4 bg-green-50 rounded-lg border border-green-200 dark:bg-green-900/20 dark:border-green-800">
              <h4 className="font-medium text-green-800 flex items-center gap-2 dark:text-green-400">
                <span>🌐</span> Chrome AI (Recommended)
              </h4>
              <ul className="mt-2 text-sm text-green-700 space-y-1 dark:text-green-300">
            ...
            <div className="p-4 bg-blue-50 rounded-lg border border-blue-200 dark:bg-blue-900/20 dark:border-blue-800">
              <h4 className="font-medium text-blue-800 flex items-center gap-2 dark:text-blue-400">
                <span>☁️</span> Cloud AI
              </h4>
              <ul className="mt-2 text-sm text-blue-700 space-y-1 dark:text-blue-300">
        ...
        <CardContent className="pt-6">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            <div className="flex items-center gap-4">
              <span className="text-3xl">❓</span>
              <div>
                <h3 className="font-semibold text-blue-800 dark:text-blue-400">Questions?</h3>
