...
export function StudyDetail() {
  ...
  const deleteMutation = useMutation({
    mutationFn: () => apiClient.studyService.deleteStudy(studyDbId!),
    onSuccess: () => {
        ...
        <TabsContent value="observations" className="mt-6">
          <Card>
            <CardContent className="p-12 text-center">
              ...
              <Button aria-label="Add Observation">➕ Add Observation</Button>
            </CardContent>
          </Card>
        </TabsContent>
        ...
        <TabsContent value="germplasm" className="mt-6">
          <Card>
            <CardContent className="p-12 text-center">
              ...
              <Button aria-label="Add Germplasm">➕ Add Germplasm</Button>
            </CardContent>
          </Card>
        </TabsContent>
      </Tabs>
