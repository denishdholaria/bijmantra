...
export function ImportExport() {
  ...
  const handleImport = async (data: Record<string, unknown>[], mappings: { mapped: boolean; sourceColumn?: string; targetColumn: string }[]) => {
    ...
    try {
        ...
        // Define a simple type for response if not imported
        ...
        return {
            ...
            importedRows: (response as unknown as ImportResponse).details?.count || data.length,
            skippedRows: 0,
            errors: []
        }
    } catch (error) {
  ...
  return (
    <div className="max-w-6xl mx-auto space-y-8 animate-fade-in">
      ...
      <div className="grid gap-6 md:grid-cols-2">
          {/* Import Card */}
          <Card className="border-blue-100 dark:border-blue-900 border-l-4 border-l-blue-500 dark:border-l-blue-500 shadow-sm">
             <CardHeader>
           ...
           {/* Export Card */}
           <Card className="border-green-100 dark:border-green-900 border-l-4 border-l-green-500 dark:border-l-green-500 shadow-sm">
             <CardHeader>
                 <CardTitle className="flex items-center gap-2">
                     <Download className="h-5 w-5 text-green-500 dark:text-green-400" />
                     Data Export
                 </CardTitle>
