...
export function Help() {
  ...
  const modules = [
    ...
    { name: 'Germplasm', icon: '🌱', path: '/germplasm', desc: 'Track genetic material with MCPD-aligned passport data' },
    { name: 'Seed Lots', icon: 'package', path: '/seedlots', desc: 'Inventory management and stock tracking' },
    ...
    { name: 'Seasons', icon: 'calendarDays', path: '/seasons', desc: 'Growing seasons and time periods' },
  ]
    ...
    <div className="max-w-4xl mx-auto space-y-6 animate-fade-in">
      ...
      <Tabs defaultValue="quickstart" className="w-full">
            ...
            <CardContent className="space-y-4">
              ...
              <div className="flex gap-4 p-4 bg-muted rounded-lg">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">Register your genetic material with MCPD-aligned passport data</p>
                ...
                <Card className="h-full hover:shadow-md transition-shadow cursor-pointer">
                  <CardContent className="p-4">
                    <div className="flex items-center gap-3 mb-2">
                      <SmartIcon icon={module.icon} size="xl" className="text-muted-foreground" />
        ...
        <TabsContent value="brapi" className="space-y-6 mt-6">
          <Card>
            <CardHeader>
              <CardTitle>BrAPI v2.1 Interoperability</CardTitle>
              <CardDescription>Breeding API integration across key workflow areas</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <p>Bijmantra publishes the 201 official BrAPI v2.1 operations and extends them through broader local /brapi/v2 routes for connected breeding workflows.</p>
              
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="p-4 bg-green-50 dark:bg-green-900/20 rounded-lg">
                  <h4 className="font-semibold text-green-800 dark:text-green-300">BrAPI-Core</h4>
                  <p className="text-sm text-green-700 dark:text-green-400">Programs, Trials, Studies, Locations, People, Lists, Seasons, Crops, Server Info</p>
                  <Badge className="mt-2 bg-green-600 dark:bg-green-500">Core resources surfaced</Badge>
                </div>
                <div className="p-4 bg-blue-50 dark:bg-blue-900/20 rounded-lg">
                  <h4 className="font-semibold text-blue-800 dark:text-blue-300">BrAPI-Germplasm</h4>
                  <p className="text-sm text-blue-700 dark:text-blue-400">Germplasm, Seed Lots, Crosses, Pedigree, Progeny, Attributes, Crossing Projects, Planned Crosses</p>
                  <Badge className="mt-2 bg-blue-600 dark:bg-blue-500">Germplasm resources surfaced</Badge>
                </div>
                <div className="p-4 bg-purple-50 dark:bg-purple-900/20 rounded-lg">
                  <h4 className="font-semibold text-purple-800 dark:text-purple-300">BrAPI-Phenotyping</h4>
                  <p className="text-sm text-purple-700 dark:text-purple-400">Variables/Traits, Observations, Units, Events, Images, Ontologies</p>
                  <Badge className="mt-2 bg-purple-600 dark:bg-purple-500">Phenotyping resources surfaced</Badge>
                </div>
                <div className="p-4 bg-orange-50 dark:bg-orange-900/20 rounded-lg">
                  <h4 className="font-semibold text-orange-800 dark:text-orange-300">BrAPI-Genotyping</h4>
                  <p className="text-sm text-orange-700 dark:text-orange-400">Samples, Variants, Variant Sets, Calls, Call Sets, Allele Matrix, Plates, References, Genome Maps, Markers, Vendor Orders</p>
                  <Badge className="mt-2 bg-orange-600 dark:bg-orange-500">Genotyping resources surfaced</Badge>
                </div>
              </div>

              <div className="p-4 bg-green-100 rounded-lg border border-green-300">
                <h4 className="font-semibold text-green-800 mb-2 flex items-center gap-2"><SmartIcon icon="sparkles" size="sm" className="text-green-700" /> Broad BrAPI Coverage</h4>
                <p className="text-sm text-green-700">Bijmantra surfaces BrAPI-related UI pages across Core, Germplasm, Phenotyping, and Genotyping workflows.</p>
              </div>
        ...
        <TabsContent value="about" className="space-y-6 mt-6">
          <Card>
            ...
            <CardContent className="space-y-4">
              <p>Bijmantra is a modern plant breeding management application with BrAPI-compatible interoperability. It provides comprehensive tools for managing breeding programs, germplasm, trials, and phenotypic data collection with AI-powered analysis.</p>
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                ...
                <div className="p-4 bg-muted rounded-lg text-center">
                  ...
                  <p className="text-2xl font-mono text-primary">{summary?.pages || '252'}+</p>
                </div>
                <div className="p-4 bg-muted rounded-lg text-center">
              ...
              <div className="p-4 bg-green-50 rounded-lg border border-green-200">
                ...
                <div className="grid grid-cols-2 gap-2 text-sm text-green-700">
                  <div>✓ BrAPI-compatible data exchange</div>
                  <div>✓ AI-powered analysis</div>
                  <div>✓ Chrome AI (local/private)</div>
                  <div>✓ Low-connectivity field capture</div>
