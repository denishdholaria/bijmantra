...
const mockServerInfo: ServerInfo = {
  ...
  calls: [
    ...
    { service: 'trials', dataTypes: ['application/json'], methods: ['GET', 'POST', 'PUT', 'DELETE'], versions: ['2.1'] },
    { service: 'studies', dataTypes: ['application/json'], methods: ['GET', 'POST', 'PUT', 'DELETE'], versions: ['2.1'] },
    { service: 'locations', dataTypes: ['application/json'], methods: ['GET', 'POST', 'PUT', 'DELETE'], versions: ['2.1'] },
    { service: 'germplasm', dataTypes: ['application/json'], methods: ['GET', 'POST', 'PUT', 'DELETE'], versions: ['2.1'] },
    { service: 'observations', dataTypes: ['application/json'], methods: ['GET', 'POST', 'PUT'], versions: ['2.1'] },
    { service: 'variables', dataTypes: ['application/json'], methods: ['GET', 'POST', 'PUT', 'DELETE'], versions: ['2.1'] },
    { service: 'samples', dataTypes: ['application/json'], methods: ['GET', 'POST', 'PUT'], versions: ['2.1'] },
    { service: 'variants', dataTypes: ['application/json'], methods: ['GET', 'POST'], versions: ['2.1'] },
    { service: 'allelematrix', dataTypes: ['application/json', 'text/tsv'], methods: ['GET', 'POST'], versions: ['2.1'] },
  ],
}
