...
const releases: Release[] = [
  {
    ...
    type: 'major',
    highlights: [
      'CALF Assessment Complete',
      'Version Updated to Preview',
      'Documentation Reorganized',
    ],
    features: [
      { title: 'CALF Assessment', description: 'Comprehensive analysis of all 221 pages', icon: '📊' },
      { title: 'MAHASARTHI Navigation', description: 'Dock, browser, and search system', icon: '🧭' },
      { title: 'Future Workspaces', description: '11 modules, ~304 pages planned', icon: '🔮' },
      { title: 'Zero Demo Data', description: 'Policy enforcement in progress', icon: '🗄️' },
      { title: 'Docs Reorganization', description: 'Standards, operations, modules folders', icon: '📁' },
      { title: 'Version Clarity', description: 'Honest preview-1 versioning', icon: '🏷️' },
    ],
    fixes: [
      'Identified 42 pages returning demo data instead of database queries',
      'Updated version references across all UI components',
    ],
  },
  {
    version: '1.3.0',
    ...
    highlights: [
      ...
      'Cloud AI Integration (Google Gemini, Groq, OpenAI, Anthropic)',
    ],
    features: [
      ...
      { title: 'Cloud AI Providers', description: 'Google Gemini, Groq, OpenAI, Anthropic integration', icon: '☁️' },
    ],
    fixes: [
  ...
  },
  {
    ...
    type: 'minor',
    highlights: [
      'REEVU with Multi-Provider Support',
      'Data Context Engine for AI',
      'About Page with R.E.E.V.A.i Story',
    ],
    features: [
      { title: 'REEVU', description: 'Chat interface for breeding data analysis', icon: '💬' },
  ...
  },
  {
    ...
    highlights: [
      '100+ Pages Milestone',
      '201 Official BrAPI v2.1 Operations Published',
  ...
  },
  {
    ...
    highlights: [
      ...
      'Low-Connectivity Field Capture',
    ],
    features: [
      ...
      <Card className="border-blue-200 bg-blue-50">
        <CardContent className="pt-6">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            ...
            <a 
              href="https://gitlab.com/denishdholaria/bijmantraorg" 
              target="_blank" 
