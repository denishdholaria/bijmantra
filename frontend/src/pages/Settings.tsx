    ...
    <div className="max-w-4xl mx-auto space-y-6 animate-fade-in">
      ...
      <Tabs defaultValue="profile" className="w-full">
        <TabsList className="grid w-full grid-cols-5">
          ...
          <TabsTrigger value="ai" onClick={() => navigate('/ai-settings')} className="text-amber-600 dark:text-amber-400">🤖 AI Agent</TabsTrigger>
            ...
            <CardContent>
              <div className="flex items-center gap-4">
                ...
                <span className="text-sm text-muted-foreground">
                  Supports BrAPI v2.1 interoperability
                </span>
              </div>
            </CardContent>
          </Card>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="pt-4 border-t">
                ...
                <div className="flex flex-wrap gap-2">
                  ...
                  <Badge variant="outline">Low-Connectivity Tools</Badge>
                </div>
              </div>
            </CardContent>
          </Card>
