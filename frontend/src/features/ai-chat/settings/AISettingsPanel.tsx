        ...
        <TabsContent value="diagnostics">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Open the dedicated REEVU diagnostics dashboard for step traces, retrieval quality, and benchmark status.
              </CardDescription>
            </CardHeader>
            <CardContent className="flex flex-col gap-3 text-sm text-muted-foreground md:flex-row md:items-center md:justify-between">
              <p>
                The diagnostics workspace now lives on its own admin route so operators can inspect runtime telemetry without crowding the configuration surface.
              </p>
              <Button asChild variant="outline">
                <Link to="/ai-diagnostics">Open Diagnostics</Link>
              </Button>
            </CardContent>
          </Card>
        </TabsContent>
