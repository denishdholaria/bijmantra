...
const SHORTCUTS: Shortcut[] = [
  ...
  // AI Assistant
  { id: 'cmd-shift-v', keys: ['⌘', '⇧', 'V'], description: 'Open REEVU AI', category: 'AI Assistant' },
  { id: 'cmd-shift-a', keys: ['⌘', '⇧', 'A'], description: 'Ask REEVU about selection', category: 'AI Assistant' },
