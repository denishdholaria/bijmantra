    ...
    <>
      ...
      >
        ...
        <div className="flex items-start gap-3 pr-6">
          {/* App Icon */}
          <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-emerald-500 to-emerald-600 flex items-center justify-center flex-shrink-0 overflow-hidden">
            <img src="/icons/icon-192x192.png" alt="Bijmantra" className="w-full h-full object-cover" />
          </div>
