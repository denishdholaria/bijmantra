...
const tourSteps: TourStep[] = [
  ...
  },
  {
    id: 'seed-commerce',
    title: 'Seed Commerce',
    description: 'Complete seed industry operations: lab testing, processing, inventory, dispatch, DUS testing, and variety licensing. Track seed lots from production to sale.',
    icon: Building2,
