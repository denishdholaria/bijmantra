...
const tourSteps: TourStep[] = [
  ...
  },
  {
    ...
    description: 'Start exploring Bijmantra. Check out the Dashboard for an overview, or dive into any module. Need help? Visit the Knowledge section or ask REEVU, our AI assistant.',
    icon: Sparkles,
