...
const tourSteps: TourStep[] = [
  ...
  },
  {
    id: 'seed-commerce',
    title: 'Seed Commerce',
    description: 'Complete seed commerce workflows: lab testing, processing, inventory, dispatch, DUS testing, traceability, and variety licensing. Track seed lots from production to sale.',
    icon: Building2,
  ...
  },
  {
    ...
    description: 'Press ⌘K to open the command palette, ? to see keyboard shortcuts, and ⌘/ to toggle REEVU when you need AI help.',
    icon: Keyboard,
  ...
  },
  {
    ...
    description: 'Start exploring Bijmantra. Check out the Dashboard for an overview, or dive into any module. Need help? Visit the Knowledge section or ask REEVU.',
    icon: Sparkles,
