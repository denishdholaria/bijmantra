  ...
  const steps: OnboardingStep[] = [
    {
      ...
      content: (
        <div className="space-y-6 text-center">
          <div className="w-24 h-24 mx-auto bg-primary/10 rounded-full flex items-center justify-center p-4">
            <img src="/icons/icon-192x192.png" alt="Bijmantra" className="w-full h-full object-contain" />
          </div>
          <div>
      ...
      content: (
        <div className="space-y-4">
          ...
          <div className="space-y-3">
            ...
            <div className="flex items-center justify-between p-3 bg-muted rounded-lg">
              <span>Toggle REEVU</span>
              <Badge variant="outline" className="font-mono">⌘ /</Badge>
            </div>
            <div className="flex items-center justify-between p-3 bg-muted rounded-lg">
              <span>Toggle Main Sidebar</span>
              <Badge variant="outline" className="font-mono">[ ]</Badge>
            </div>
            <div className="flex items-center justify-between p-3 bg-muted rounded-lg">
