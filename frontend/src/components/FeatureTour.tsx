...
import { LEGACY_REEVU_TOUR_TARGET } from '@/lib/legacyReevu';
...
export const DASHBOARD_TOUR: TourStep[] = [
  ...
  {
    target: `[data-tour="${LEGACY_REEVU_TOUR_TARGET}"]`,
    title: 'REEVU AI Assistant',
    content: 'Ask REEVU anything about plant breeding or get help with tasks. It can search your data and provide insights.',
    placement: 'left',
  },
];
