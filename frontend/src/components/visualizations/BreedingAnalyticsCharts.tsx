...
export function HeritabilityGauge({ value, trait, className }: HeritabilityGaugeProps) {
  ...
  return (
    <div className={cn('bg-card text-card-foreground rounded-xl border border-border p-4 text-center', className)}>
      <h4 className="text-sm font-medium text-muted-foreground mb-2">{trait}</h4>
