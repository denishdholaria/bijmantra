...
export function ReevuLogo({ className }: { className?: string }) {
  return (
    <svg
      viewBox="0 0 100 120"
      fill="none"
    ...
    >
      ...
      <g>
        ...
        {/* Core (brightest) */}
        <ellipse cx="50" cy="60" rx="8" ry="15" fill="#fef3c7" />
...
export function ReevuTrigger({
  ...
  return (
    <button
      ...
      title="Ask REEVU (Ctrl+/)"
      aria-label="Open REEVU AI Assistant"
    >
