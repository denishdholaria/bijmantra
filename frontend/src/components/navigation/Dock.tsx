...
export function Dock({ className, onDivisionSelect }: DockProps) {
  ...
  const { workspace, filteredDivisions, setWorkspace, workspaces, currentWorkspace } = useWorkspace()
      ...
      <div className={cn(
        ...
        <div className="h-14 flex items-center justify-center border-b border-gray-200 dark:border-slate-800">
          <Link to="/dashboard" className="group">
            <div className="w-9 h-9 bg-gradient-to-br from-green-500 to-emerald-600 rounded-xl flex items-center justify-center shadow-md group-hover:shadow-lg transition-shadow">
              ...
              <TooltipTrigger asChild>
                <DropdownMenuTrigger asChild>
                  <button className={cn(
                    ...
                    'bg-gradient-to-br', workspace.color, 'text-white shadow-md hover:shadow-lg'
                  )}>
                ...
                return (
                  <Tooltip key={`${fav.type}-${fav.id}`}>
                    ...
                    <TooltipContent side="right" sideOffset={8}>
                      ...
                      <p className="text-xs text-muted-foreground capitalize">{fav.type}</p>
                    </TooltipContent>
                  </Tooltip>
                )
              })}
          ...
          {canAddMore && (
            <Tooltip>
              ...
              <TooltipContent side="right" sideOffset={8}>
                ...
                <p className="text-xs text-muted-foreground">Star items to pin them here</p>
              </TooltipContent>
            </Tooltip>
          )}
