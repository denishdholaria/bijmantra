  ...
  return (
    <BrAPIListPage<ReferenceSet>
      ...
      columns={[
        ...
        {
          header: "Species",
          cell: (item: ReferenceSet) => item.species?.commonName || "-",
        },
        {
          header: "Assembly PUI",
          accessorKey: "assemblyPUI",
          cell: (item: ReferenceSet) => <div className="font-mono text-sm">{item.assemblyPUI}</div>,
        },
         {
          header: "Source",
          cell: (item: ReferenceSet) => item.sourceUri ? (
