  ...
  useEffect(() => {
    fetch('/api/v2/space/crops')
      ...
      .catch(() => {
        // Demo data
        setCrops([
          { id: 'SC001', name: 'Dwarf Wheat (Apogee)', species: 'Triticum aestivum', space_heritage: 'ISS Veggie, 2014-present', growth_cycle_days: 62, radiation_tolerance: 'Moderate', microgravity_adaptation: 'Good', caloric_yield: 3400, notes: 'NASA-developed dwarf variety' },
          { id: 'SC002', name: 'Red Romaine Lettuce', species: 'Lactuca sativa', space_heritage: 'ISS Veggie, 2015', growth_cycle_days: 28, radiation_tolerance: 'Low', microgravity_adaptation: 'Excellent', caloric_yield: 150, notes: 'First crop eaten in space' },
          { id: 'SC003', name: 'Mizuna', species: 'Brassica rapa', space_heritage: 'ISS, 2020', growth_cycle_days: 21, radiation_tolerance: 'Moderate', microgravity_adaptation: 'Excellent', caloric_yield: 230, notes: 'Fast-growing Asian green' },
        ]);
      });
  }, []);
  ...
  const fetchEnvironment = async (cropId: string) => {
    try {
      ...
      setEnvironment({
        ...
        light: { photoperiod_hours: 16, ppfd_umol: 400, spectrum: 'Red:Blue 4:1' },
        atmosphere: { co2_ppm: 1000, humidity_percent: 65 },
        temperature: { day_c: 24, night_c: 18 },
      });
    }
  };
