...
import type { YieldPredictionCreate } from '@/lib/api/ai/yield-prediction';
...
export default function YieldPrediction() {
  ...
  const { data: predictions, isLoading } = useQuery({
    ...
    queryFn: () => apiClient.yieldPredictionService.list(),
  });
  ...
  const createMutation = useMutation({
    mutationFn: (data: YieldPredictionCreate) => apiClient.yieldPredictionService.create(data),
    onSuccess: () => {
  ...
  const deleteMutation = useMutation({
    mutationFn: (id: number) => apiClient.yieldPredictionService.delete(id),
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: ['crop-intelligence-yield-predictions'] });
