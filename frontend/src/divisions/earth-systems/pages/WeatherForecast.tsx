    ...
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-gray-600 mt-1">14-day agricultural weather outlook</p>
              ...
              <div className="space-y-3">
                {activityWindows.map((window, i) => (
                  <div key={i} className="p-3 rounded-lg border bg-green-50 border-green-200">
                    ...
                    <div className="text-xs text-gray-500 mt-1">{window.conditions}</div>
                  </div>
                ))}
              </div>
            )}
              ...
              <>
                <div className="grid grid-cols-2 gap-4 mb-4">
                  <div className="p-3 rounded-lg bg-green-50">
                    ...
                    <div className="text-sm text-green-600">Accumulated GDD</div>
                  </div>
                  <div className="p-3 rounded-lg bg-blue-50">
                    <div className="text-2xl font-bold text-blue-700">
                      {forecast?.gdd_summary.base_temp || crops.find(c => c.id === selectedCrop)?.baseTemp}°C
                    </div>
                    <div className="text-sm text-blue-600">Base Temperature</div>
                  </div>
                </div>
          ...
          <CardContent>
            <div className="space-y-2">
              {forecast.alerts.map((alert, i) => (
                <div key={i} className="p-3 rounded-lg bg-white border border-yellow-200">
                  <div className="flex items-center gap-2">
