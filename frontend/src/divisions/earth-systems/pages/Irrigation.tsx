...
export function Irrigation() {
  ...
  const fetchData = async () => {
    ...
    try {
      ...
      setError('Failed to load irrigation data. Please check your connection.');
    } finally {
      setLoading(false);
    }
  };
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl lg:text-3xl font-bold text-gray-900 dark:text-gray-100">Irrigation</h1>
          <p className="text-gray-600 dark:text-gray-400 mt-1">Track water usage and irrigation events</p>
        </div>
