...
export function Dashboard() {
  ...
  const quickLinks = [
    ...
    { label: 'Yield Prediction', path: '/earth-systems/yield-prediction', icon: TrendingUp, color: 'text-emerald-600 bg-emerald-100' },
  ];
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          {error && <Badge variant="outline" className="mt-1 text-red-600 dark:text-red-400">{error}</Badge>}
        </div>
