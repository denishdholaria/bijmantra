...
export function ClimateAnalysis() {
  ...
  const { data: climateData, isLoading, error, refetch } = useQuery({
    ...
    queryFn: () => apiClient.climateService.getClimateAnalysis(locationId, 'Research Station', parseInt(years)),
  });
    ...
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        ...
        <div className="flex items-center gap-2">
          ...
          <Button variant="outline" size="icon" onClick={() => refetch()} disabled={isLoading} aria-label="Refresh climate data">
