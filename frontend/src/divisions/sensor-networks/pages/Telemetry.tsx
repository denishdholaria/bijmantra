...
import { Activity, Calendar, Download, RefreshCw, TrendingUp, AlertCircle } from 'lucide-react';
import {
  LineChart,
  Line,
  XAxis,
...
export function Telemetry() {
  ...
  useEffect(() => {
    if (!selectedDevice || !activeWorkspace) return;
    ...
    fetchTelemetry();
  }, [selectedDevice, timeRange, downsample, activeWorkspace]);
  ...
  return (
    <div className="space-y-6 animate-fade-in">
      <div className="flex items-center justify-between">
        ...
        <Button variant="outline" size="sm" onClick={() => { setLoading(true); setError(null); }} disabled={refreshing}>
