  ...
  return (
    <div className="space-y-6 animate-fade-in">
      ...
      <div className="flex items-center gap-4">
        <Button variant="ghost" size="icon" asChild aria-label="Back to forums">
            ...
            <div className="flex-1">
              ...
              <div className="flex items-center gap-4">
                ...
                <div className="ml-auto flex gap-2">
                  <Button variant="ghost" size="sm" aria-label="Share topic">
                    <Share2 className="h-4 w-4" />
                  </Button>
                  <Button variant="ghost" size="sm" aria-label="Report topic">
