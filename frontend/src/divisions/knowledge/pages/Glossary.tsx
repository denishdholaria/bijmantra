...
export function Glossary() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl lg:text-3xl font-bold text-gray-900">Glossary</h1>
        <p className="text-gray-600 mt-1">Plant breeding and agricultural terminology</p>
      </div>
          ...
          <Card key={item.term}>
            <CardContent className="p-4">
              <div className="flex items-start justify-between">
                <h3 className="font-bold text-lg text-green-700">{item.term}</h3>
                <span className="text-xs px-2 py-0.5 bg-gray-100 rounded">{item.category}</span>
              </div>
