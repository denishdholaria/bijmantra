...
const getSuitabilityInfo = (code: string | null) => {
  return SUITABILITY_CLASSES.find(s => s.value === (code as string)) || SUITABILITY_CLASSES[2]
}

function FactorBar({ label, score, icon: Icon }: { label: string; score: number | null; icon: React.ComponentType<any> }) {
  return (
