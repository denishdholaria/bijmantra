...
export function PlantVisionStrategy() {
  ...
  const getStatusBadge = (status: DetectionMethod['status']) => {
    switch (status) {
      case 'available':
        return <Badge className="bg-green-100 text-green-800 dark:bg-green-900/30 dark:text-green-400"><CheckCircle className="h-3 w-3 mr-1" />Available</Badge>;
      case 'coming_soon':
        return <Badge className="bg-blue-100 text-blue-800 dark:bg-blue-900/30 dark:text-blue-400"><Clock className="h-3 w-3 mr-1" />Coming Soon</Badge>;
      case 'research':
        return <Badge className="bg-purple-100 text-purple-800 dark:bg-purple-900/30 dark:text-purple-400"><Beaker className="h-3 w-3 mr-1" />Research</Badge>;
    }
  };
  ...
  const getCropStatusBadge = (status: string) => {
    switch (status) {
      case 'collecting':
        return <Badge className="bg-blue-100 text-blue-800 dark:bg-blue-900/30 dark:text-blue-400">Collecting Data</Badge>;
      case 'training':
        return <Badge className="bg-yellow-100 text-yellow-800 dark:bg-yellow-900/30 dark:text-yellow-400">Training</Badge>;
      case 'available':
        return <Badge className="bg-green-100 text-green-800 dark:bg-green-900/30 dark:text-green-400">Model Available</Badge>;
      default:
        ...
        <CardContent>
          <div className="grid md:grid-cols-4 gap-4 text-center">
            <div className="p-3 bg-white dark:bg-slate-800 rounded-lg">
              <p className="text-2xl font-bold text-amber-600 dark:text-amber-400">7,000+</p>
              <p className="text-sm text-muted-foreground">Cultivated Species</p>
            </div>
            <div className="p-3 bg-white dark:bg-slate-800 rounded-lg">
              <p className="text-2xl font-bold text-amber-600 dark:text-amber-400">10,000+</p>
              <p className="text-sm text-muted-foreground">Plant Pathogens</p>
            </div>
            <div className="p-3 bg-white dark:bg-slate-800 rounded-lg">
              <p className="text-2xl font-bold text-amber-600 dark:text-amber-400">Millions</p>
              <p className="text-sm text-muted-foreground">Visual Variations</p>
            </div>
            <div className="p-3 bg-white dark:bg-slate-800 rounded-lg">
              <p className="text-2xl font-bold text-amber-600 dark:text-amber-400">~87K</p>
