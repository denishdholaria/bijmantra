...
export function IrrigationSchedules() {
  ...
  const [newSchedule, setNewSchedule] = useState({
    ...
    water_requirement_mm: 25 as number | null,
    duration_minutes: 60 as number | null,
    start_time: '08:00',
    actual_applied_mm: null as number | null,
    soil_moisture_before: null as number | null,
    soil_moisture_after: null as number | null,
    et_reference: null as number | null,
    crop_coefficient: null as number | null,
  ...
  const handleEdit = (schedule: IrrigationSchedule) => {
    ...
    setNewSchedule({
      ...
      actual_applied_mm: schedule.actual_applied_mm,
      soil_moisture_before: schedule.soil_moisture_before,
      soil_moisture_after: schedule.soil_moisture_after,
      et_reference: schedule.et_reference,
      crop_coefficient: schedule.crop_coefficient,
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 py-4">
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      setNewSchedule((p) => ({ ...p, field_id: e.target.value ? Number(e.target.value) : null }))
                    }
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      setNewSchedule((p) => ({ ...p, start_time: e.target.value }))
                    }
                  />
                </div>
                <div className="space-y-2">
                ...
                <div className="space-y-2">
                  <Label htmlFor="water_requirement_mm">Water Requirement (mm)</Label>
                  <Input
                    ...
                    onChange={(e) =>
                      setNewSchedule((p) => ({
                        ...p,
                        water_requirement_mm: e.target.value ? Number(e.target.value) : null,
                      }))
                    }
                  />
                </div>
                ...
                <div className="space-y-2">
                  <Label htmlFor="actual_applied_mm">Actual Applied (mm)</Label>
                  <Input
                    id="actual_applied_mm"
                    type="number"
                    step="0.1"
                    value={newSchedule.actual_applied_mm ?? ''}
                    onChange={(e) =>
                      setNewSchedule((p) => ({
                        ...p,
                        actual_applied_mm: e.target.value ? Number(e.target.value) : null,
                      }))
                    }
                  />
                </div>
                <div className="space-y-2">
                  <Label htmlFor="soil_moisture_before">Soil Moisture Before (%)</Label>
                  <Input
                    id="soil_moisture_before"
                    type="number"
                    step="0.1"
                    value={newSchedule.soil_moisture_before ?? ''}
                    onChange={(e) =>
                      setNewSchedule((p) => ({
                        ...p,
                        soil_moisture_before: e.target.value ? Number(e.target.value) : null,
                      }))
                    }
                  />
                </div>
                <div className="space-y-2">
                  <Label htmlFor="soil_moisture_after">Soil Moisture After (%)</Label>
                  <Input
                    id="soil_moisture_after"
                    type="number"
                    step="0.1"
                    value={newSchedule.soil_moisture_after ?? ''}
                    onChange={(e) =>
                      setNewSchedule((p) => ({
                        ...p,
                        soil_moisture_after: e.target.value ? Number(e.target.value) : null,
                      }))
                    }
                  />
                </div>
                <div className="space-y-2">
                  <Label htmlFor="et_reference">ET Reference (mm/day)</Label>
                  <Input
                    id="et_reference"
                    type="number"
                    step="0.1"
                    value={newSchedule.et_reference ?? ''}
                    onChange={(e) =>
                      setNewSchedule((p) => ({
                        ...p,
                        et_reference: e.target.value ? Number(e.target.value) : null,
                      }))
                    }
                  />
                </div>
                <div className="space-y-2">
                  <Label htmlFor="crop_coefficient">Crop Coefficient (Kc)</Label>
                  <Input
                    id="crop_coefficient"
                    type="number"
                    step="0.01"
                    value={newSchedule.crop_coefficient ?? ''}
                    onChange={(e) =>
                      setNewSchedule((p) => ({
                        ...p,
                        crop_coefficient: e.target.value ? Number(e.target.value) : null,
                      }))
                    }
                  />
                </div>
