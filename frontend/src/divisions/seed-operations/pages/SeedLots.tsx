...
export function SeedLots() {
  ...
  const fetchData = async () => {
    ...
    try {
      ...
      const [lotsRes, sumRes] = await Promise.all([
        apiClient.inventoryService.getLots(),
  ...
  const handleCreateLot = async () => {
    try {
      ...
      await apiClient.inventoryService.registerLot({
        ...
        // Extended fields are not supported by registerLot strictly typed, adding to notes or ignoring
        // For now, we only pass supported fields
      });
          ...
          <Dialog open={showNewLotDialog} onOpenChange={setShowNewLotDialog}>
            ...
            <DialogContent className="max-w-lg">
              <DialogHeader>
                ...
                <DialogDescription>
                  Create a seed lot record with inventory, harvest, and viability details for traceability.
                </DialogDescription>
              </DialogHeader>
