...
export function QualityGate() {
  ...
  const handleScan = async () => {
    ...
    try {
      ...
      try {
        const qcRes = await apiClient.qualityControlService.getQCSamples(undefined); // Removed second arg as getQCSamples only takes status. Or update service to take lotNumber filter? For now, standard call.
