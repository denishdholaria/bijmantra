...
export function Certificates() {
  ...
  const fetchData = async () => {
    ...
    try {
      ...
      // Demo certificates (would come from a certificates endpoint)
      setCertificates([
        { certificate_id: 'CERT-2024-001', sample_id: 'QC-000010', lot_id: 'LOT-2024-010', variety: 'IR64', seed_class: 'certified', issue_date: '2024-11-01', expiry_date: '2025-10-31', status: 'valid', test_results: { germination: 94, purity: 98, moisture: 10 } },
        { certificate_id: 'CERT-2024-002', sample_id: 'QC-000011', lot_id: 'LOT-2024-011', variety: 'HD-2967', seed_class: 'foundation', issue_date: '2024-10-15', expiry_date: '2025-10-14', status: 'valid', test_results: { germination: 96, purity: 99, moisture: 9 } },
        { certificate_id: 'CERT-2024-003', sample_id: 'QC-000005', lot_id: 'LOT-2024-005', variety: 'JS-335', seed_class: 'certified', issue_date: '2024-06-01', expiry_date: '2024-11-30', status: 'expired', test_results: { germination: 88, purity: 97, moisture: 11 } },
      ]);
    } catch (err) {
      setPassedSamples([
        { sample_id: 'QC-000020', lot_id: 'LOT-2024-020', variety: 'BG-II' },
        { sample_id: 'QC-000021', lot_id: 'LOT-2024-021', variety: 'IR64' },
      ]);
      setCertificates([
        { certificate_id: 'CERT-2024-001', sample_id: 'QC-000010', lot_id: 'LOT-2024-010', variety: 'IR64', seed_class: 'certified', issue_date: '2024-11-01', expiry_date: '2025-10-31', status: 'valid' },
      ]);
    } finally {
      setLoading(false);
    }
