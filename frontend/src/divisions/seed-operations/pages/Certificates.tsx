...
export function Certificates() {
  ...
  const fetchData = async () => {
    ...
    try {
      ...
      const samplesRes = await apiClient.qualityControlService.getQCSamples('passed');
      setPassedSamples(samplesRes.samples || []);
      
      // Get certificates from API
      const certsRes = await apiClient.qualityControlService.getQCCertificates();
  ...
  const handleIssueCertificate = async () => {
    ...
    setIssuing(true);
    try {
      await apiClient.qualityControlService.issueQCCertificate(newCert);
          ...
          <Dialog open={showIssueDialog} onOpenChange={setShowIssueDialog}>
            ...
            <DialogContent>
              <DialogHeader>
                ...
                <DialogDescription>
                  Issue a certificate for a sample that has passed all required quality-control tests.
                </DialogDescription>
              </DialogHeader>
