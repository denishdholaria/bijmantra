...
export function StockAlerts() {
  ...
  const fetchAlerts = async () => {
    ...
    try {
      ...
      // Demo alerts
      setAlerts([
        { id: '1', type: 'low_stock', severity: 'critical', lot_id: 'LOT-2024-003', variety: 'JS-335', message: 'Stock below minimum threshold', value: 50, threshold: 100, created_at: '2024-12-06T08:00:00Z' },
        { id: '2', type: 'low_viability', severity: 'warning', lot_id: 'LOT-2024-015', variety: 'HD-2967', message: 'Germination dropped below 80%', value: 76, threshold: 80, created_at: '2024-12-05T14:30:00Z' },
        { id: '3', type: 'overdue_test', severity: 'warning', lot_id: 'LOT-2024-008', variety: 'IR64', message: 'Viability test overdue by 15 days', created_at: '2024-12-04T10:00:00Z' },
        { id: '4', type: 'low_stock', severity: 'warning', lot_id: 'LOT-2024-022', variety: 'BG-II', message: 'Stock running low', value: 120, threshold: 200, created_at: '2024-12-06T06:00:00Z' },
        { id: '5', type: 'expiring_cert', severity: 'info', lot_id: 'LOT-2024-001', variety: 'IR64', message: 'Certificate expires in 30 days', created_at: '2024-12-06T09:00:00Z' },
      ]);
    } finally {
      setLoading(false);
    }
