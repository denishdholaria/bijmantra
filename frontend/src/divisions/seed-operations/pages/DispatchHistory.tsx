...
export function DispatchHistory() {
  ...
  const fetchData = async () => {
    ...
    try {
      ...
      // For now, aggregate from traceability transfers
      const stats = await apiClient.getTraceabilityStatistics();
      // Demo data
      setDispatches([
        { 
          id: 'DSP-2024-001', 
          date: '2024-12-05', 
          recipient: 'ABC Agro Dealers', 
          recipient_address: 'Mumbai, Maharashtra',
          transfer_type: 'sale',
          lots: [
            { lot_id: 'LOT-2024-010', variety: 'IR64', quantity_kg: 200 },
            { lot_id: 'LOT-2024-011', variety: 'HD-2967', quantity_kg: 150 },
          ],
        ...
        { 
          id: 'DSP-2024-002', 
          date: '2024-12-04', 
          recipient: 'State Seed Corporation', 
          recipient_address: 'Hyderabad, Telangana',
          transfer_type: 'sale',
          lots: [
            { lot_id: 'LOT-2024-015', variety: 'BG-II', quantity_kg: 500 },
          ],
        ...
        { 
          id: 'DSP-2024-003', 
          date: '2024-12-03', 
          recipient: 'Agricultural University', 
          recipient_address: 'Ludhiana, Punjab',
          transfer_type: 'donation',
          lots: [
            { lot_id: 'LOT-2024-008', variety: 'JS-335', quantity_kg: 50 },
          ],
        ...
        { 
          id: 'DSP-2024-004', 
          date: '2024-12-02', 
          recipient: 'Regional Warehouse', 
          recipient_address: 'Nagpur, Maharashtra',
          transfer_type: 'internal',
          lots: [
            { lot_id: 'LOT-2024-020', variety: 'IR64', quantity_kg: 1000 },
            { lot_id: 'LOT-2024-021', variety: 'HD-2967', quantity_kg: 800 },
          ],
