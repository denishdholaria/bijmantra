  ...
  const fetchData = async () => {
    ...
    try {
      ...
      if (samplesRes?.samples) {
        ...
        // Demo data
        setRecentTests([
          { sample_id: 'QC-001', lot_id: 'LOT-2024-0156', test_type: 'Germination', status: 'passed', result: '94%' },
          { sample_id: 'QC-002', lot_id: 'LOT-2024-0155', test_type: 'Purity', status: 'pending', result: '--' },
          { sample_id: 'QC-003', lot_id: 'LOT-2024-0154', test_type: 'Moisture', status: 'passed', result: '8.2%' },
          { sample_id: 'QC-004', lot_id: 'LOT-2024-0153', test_type: 'Germination', status: 'failed', result: '72%' },
        ]);
      }
    } catch (err) {
      // Use demo data on error
      setStats({ pendingTests: 12, activeBatches: 5, dispatchReady: 8, lowStockAlerts: 3 });
      setRecentTests([
        { sample_id: 'QC-001', lot_id: 'LOT-2024-0156', test_type: 'Germination', status: 'passed', result: '94%' },
        { sample_id: 'QC-002', lot_id: 'LOT-2024-0155', test_type: 'Purity', status: 'pending', result: '--' },
        { sample_id: 'QC-003', lot_id: 'LOT-2024-0154', test_type: 'Moisture', status: 'passed', result: '8.2%' },
