...
export function Firms() {
  ...
  const fetchData = async () => {
    ...
    try {
      const [firmsRes, typesRes] = await Promise.all([
        apiClient.getFirms(filterType || undefined),
        apiClient.getFirmTypes(),
      ]);
      ...
      setFirms([
        { firm_id: '1', firm_code: 'AAD-001', name: 'ABC Agro Dealers', firm_type: 'dealer', address: '123 Market Road', city: 'Mumbai', state: 'Maharashtra', country: 'India', postal_code: '400001', contact_person: 'Rajesh Kumar', phone: '+91-9876543210', email: 'rajesh@abcagro.com', credit_limit: 500000, credit_used: 150000, status: 'active' },
        { firm_id: '2', firm_code: 'SSC-002', name: 'State Seed Corporation', firm_type: 'distributor', address: 'Seed Bhavan', city: 'Hyderabad', state: 'Telangana', country: 'India', postal_code: '500001', contact_person: 'Dr. Sharma', phone: '+91-9876543211', email: 'procurement@ssc.gov.in', credit_limit: 2000000, credit_used: 800000, status: 'active' },
        { firm_id: '3', firm_code: 'GFC-003', name: 'Green Fields Cooperative', firm_type: 'retailer', address: 'Village Center', city: 'Ludhiana', state: 'Punjab', country: 'India', postal_code: '141001', contact_person: 'Gurpreet Singh', phone: '+91-9876543212', email: 'greenfields@coop.in', credit_limit: 100000, credit_used: 25000, status: 'active' },
      ]);
      setFirmTypes([
  ...
  const handleCreateFirm = async () => {
    try {
      await apiClient.createFirm(newFirm);
