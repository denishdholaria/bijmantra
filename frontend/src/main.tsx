...
import { installFetchTracing } from '@/lib/tracing/http'
...
if (IS_PROD) {
  const updateSW = registerSW({
    onNeedRefresh() {
      const shouldUpdate = window.confirm('A new Bijmantra update is available. Refresh now?')
      if (shouldUpdate) {
        updateSW(true)
      }
    },
...
backgroundSyncService.attachOnlineSync()
