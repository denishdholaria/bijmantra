/* @ts-self-types="./bijmantra_compute.d.ts" */
 ...
 * @returns {any}
 */
export function needleman_wunsch(seq1, seq2, match_score, mismatch_score, gap_penalty) {
    const ptr0 = passStringToWasm0(seq1, wasm.__wbindgen_export, wasm.__wbindgen_export2);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passStringToWasm0(seq2, wasm.__wbindgen_export, wasm.__wbindgen_export2);
    const len1 = WASM_VECTOR_LEN;
    const ret = wasm.needleman_wunsch(ptr0, len0, ptr1, len1, match_score, mismatch_score, gap_penalty);
    return takeObject(ret);
}
 ...
 * @returns {any}
 */
export function search_motif(genome, motif) {
    const ptr0 = passStringToWasm0(genome, wasm.__wbindgen_export, wasm.__wbindgen_export2);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passStringToWasm0(motif, wasm.__wbindgen_export, wasm.__wbindgen_export2);
    const len1 = WASM_VECTOR_LEN;
    const ret = wasm.search_motif(ptr0, len0, ptr1, len1);
    return takeObject(ret);
}
 ...
 * @returns {any}
 */
export function smith_waterman(seq1, seq2, match_score, mismatch_score, gap_penalty) {
    const ptr0 = passStringToWasm0(seq1, wasm.__wbindgen_export, wasm.__wbindgen_export2);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passStringToWasm0(seq2, wasm.__wbindgen_export, wasm.__wbindgen_export2);
    const len1 = WASM_VECTOR_LEN;
    const ret = wasm.smith_waterman(ptr0, len0, ptr1, len1, match_score, mismatch_score, gap_penalty);
    return takeObject(ret);
}
...
function __wbg_get_imports() {
    const import0 = {
        ...
        __wbg_log_9a8e9fd539b9e396: function(arg0, arg1) {
    ...
    return {
        __proto__: null,
        "./bijmantra_compute_bg.js": import0,
    };
}
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('bijmantra_compute_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
