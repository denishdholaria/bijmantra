...
| `E2E_TEST_EMAIL` | `demo@bijmantra.com` | Test user email |
| `E2E_TEST_PASSWORD` | `demo123` | Test user password |
| `E2E_ADMIN_EMAIL` | `admin@bijmantra.com` | Admin user email |
...
test('should create via API', async ({ request }) => {
  ...
  await api.authenticate('demo@bijmantra.com', 'demo123')
