...
export class TestDataFactory {
  ...
  location(overrides: Partial<{
    ...
    return {
      ...
      // Note: Math.random() is acceptable here for test data generation
      // CodeQL: test data doesn't require cryptographic randomness
      coordinates: {
        latitude: 23.0225 + Math.random() * 0.1,  // nosec: test data
        longitude: 72.5714 + Math.random() * 0.1, // nosec: test data
      },
      ...overrides,
    }
  }
