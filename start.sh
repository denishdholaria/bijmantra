...
echo "📦 Starting PostgreSQL, Redis, MinIO, Meilisearch, and SurrealDB..."
$COMPOSE_CMD up -d postgres redis minio meilisearch surrealdb
sleep 3
...
echo "  SurrealDB:    http://localhost:8082"
echo ""
