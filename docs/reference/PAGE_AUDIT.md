...
**Status:** ✅ Functional (211) · 🧪 Experimental (2) · 🟡 Demo (0) · 🔴 UI Only (0) · 📦 Removed (12)
...
| Status | Meaning |
|:------:|:--------|
| ✅ | Functional — Connected to real backend API with database queries |
| 🧪 | Experimental — API exists but returns demo/simulated data (not production-ready) |
...
| Soil Analysis | `/soil` | `/api/v2/field-environment/soil-profiles` | ✅ |
...
| Offline Data Entry | `/seed-bank/offline` | `/api/v2/seed-bank/accessions` | ✅ |
...
| Dashboard | `/knowledge` | Static | ✅ |
| Help Center | `/help` | Static | ✅ |
| Training Hub | `/knowledge/training` | LocalStorage | ✅ |
| Glossary | `/glossary` | Static (46 terms) | ✅ |
| FAQ | `/faq` | Static (16 items) | ✅ |
| About | `/about` | Static | ✅ |
| Vision | `/vision` | Static | ✅ |
...
| Collaboration Hub | `/collaboration` | `/api/v2/collaboration-hub` | ✅ |
| Workflows | `/workflows` | `/api/v2/workflows` | ✅ |
| System Settings | `/system-settings` | `/api/v2/system-settings` | ✅ |
| Offline Mode | `/offline` | `/api/v2/offline-sync` | ✅ |
| Backup Restore | `/backup` | `/api/v2/backup` | ✅ |
| Data Dictionary | `/data-dictionary` | `/api/v2/data-dictionary` | ✅ |
| Language Settings | `/languages` | LocalStorage | ✅ |
| Notification Center | `/notification-center` | `/api/v2/notifications` | ✅ |
| Mobile App | `/mobile-app` | Static | ✅ |
| Keyboard Shortcuts | `/keyboard-shortcuts` | Static | ✅ |
...
| Apex Analytics | `/apex-analytics` | `/api/v2/analytics` | 🧪 |
...
| Advanced Reports | `/advanced-reports` | `/api/v2/reports` | ✅ |
| Data Sync | `/data-sync` | `/api/v2/data-sync` | ✅ |
| Data Validation | `/data-validation` | `/api/v2/data-validation` | ✅ |

> **Note:** 🧪 = Experimental (API returns demo/simulated data, not connected to real database)
