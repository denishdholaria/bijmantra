...
| Resource Allocation | Distribution math | `/resource-allocation` | 🟡 Client-side |
...
### Issue 2: Client-Side Only Calculations (6 pages)

**Severity**: 🟡 MEDIUM

**Pages**: FertilizerCalculator, TraitCalculator, CostAnalysis, ResourceAllocation, YieldMap, GrowthTracker

**Recommendation**: Move to backend for validation, persistence, and audit trail.
