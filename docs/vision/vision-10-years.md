...
- [x] 210+ pages, BrAPI v2.1 compliant
- [x] Veena AI assistant (UI complete)
...
1. **Open Source First** — Core platform remains open
2. **Privacy by Design** — Data sovereignty for users
3. **Accessibility** — Works on low-bandwidth, old devices
4. **Interoperability** — BrAPI compliance, no lock-in
