...
│  │  ┌───────┐ ┌───────┐ ┌───────┐ ┌───────┐ ┌───────┐ ┌───────┐│   │
│  │  │Plant  │ │Seed   │ │Enviro-│ │Commer-│ │Space  │ │Know-  ││   │
│  │  │Science│ │Bank   │ │nment  │ │cial   │ │Rsrch  │ │ledge  ││   │
│  │  └───────┘ └───────┘ └───────┘ └───────┘ └───────┘ └───────┘│   │
│  └──────────────────────────────────────────────────────────────┘   │
│                                 │                                    │
│  ┌──────────────────────────────┼───────────────────────────────┐   │
...
export const divisions: Division[] = [
  ...
  },
  {
    id: 'environment',
    name: 'Environment',
    description: 'Weather, climate, soil, solar, and photoperiod monitoring',
    icon: 'Globe',
    route: '/environment',
    loadComponent: () => import('@/divisions/environment'),
    requiredPermissions: ['read:environment'],
    featureFlag: 'ENVIRONMENT_ENABLED',
    status: 'active',
    version: '1.0.0',
    sections: [
      { id: 'weather', name: 'Weather & Climate', route: '/weather', icon: 'Cloud' },
      { id: 'field', name: 'Field Environment', route: '/field', icon: 'Mountain' },
      { id: 'solar', name: 'Solar & Light', route: '/solar', icon: 'Sun' },
    ],
  },
  // ... more divisions
];
