...
### Current Implementation Status (preview-1)
...
```
┌─────────────────────────────────────────────────────────────────────┐
│                      PARASHAKTI FRAMEWORK preview-1                 │
│                                                                      │
│  ┌────────────────────────────────────────────────────────────────┐ │
│  │                      SHELL LAYER                               │ │
...
- **Theme** — Light/Dark/System mode via dedicated themeStore
...
Self-contained feature domains loaded on demand. As of preview-1, there are **8 modules**:
...
> **Note:** The original spec used "Division" terminology. As of preview-1, we use "Module" to better reflect the 8-module architecture implemented Dec 25, 2025.
...
### 3.2 Current Module Registration (preview-1)
