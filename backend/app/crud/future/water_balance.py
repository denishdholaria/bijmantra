...
class CRUDWaterBalance(CRUDBase[WaterBalance, WaterBalanceCreate, WaterBalanceBase]):
    ...
    async def get_by_field(
        ...
        *,
        ...
        ).order_by(self.model.balance_date.desc())
    ...
    async def get_field_summary(
        ...
        *,
        ...
        query = select(
            ...
            func.sum(self.model.et_actual_mm).label("total_et"),
            func.avg(self.model.soil_water_content_mm).label("avg_soil_water_content"),
        ...
        if row:
            return {
                ...
                "average_soil_water_content_mm": float(row.avg_soil_water_content or 0),
        ...
        return {
            ...
            "average_soil_water_content_mm": 0,
            "record_count": 0
        }
