...
from app.models.core import Location, Organization, Person, Program, Study, Trial, User
...
class CRUDUser(CRUDBase[User, UserCreate, UserUpdate]):
    ...
    async def create(self, db: AsyncSession, *, obj_in: UserCreate, org_id: int | None = None) -> User:
