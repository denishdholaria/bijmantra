...
class SqlAlchemyKnowledgeGraphPersistence:
    ...
    async def upsert_edge(
        ...
        *,
        ...
        return _edge_record_from_model(edge)
    ...
    async def list_edges(
        ...
        *,
        ...
        return [_edge_record_from_model(edge) for edge in result.scalars().all()]
...
def _edge_record_from_model(edge: AgriculturalKnowledgeGraphEdge) -> KnowledgeGraphEdgeRecord:
    return KnowledgeGraphEdgeRecord(
        id=edge.id,
        organization_id=edge.organization_id,
        edge_id=edge.edge_id,
        source_asset_type=edge.source_asset_type,
        source_asset_id=edge.source_asset_id,
        relationship_type=edge.relationship_type,
        target_asset_type=edge.target_asset_type,
