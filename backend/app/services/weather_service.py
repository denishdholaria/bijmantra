...
class WeatherService:
    ...
    async def get_forecast(
        ...
        """
        # Generate mock forecast data (in production, call weather API)
        ...
        # Calculate GDD
        gdd_forecast = self._calculate_gdd(daily_forecast, crop)
    ...
    def _calculate_gdd(
        ...
        for day in forecast:
            # Simple GDD calculation: (Tmax + Tmin) / 2 - Tbase
            daily_gdd = max(0, (day.temp_max + day.temp_min) / 2 - base_temp)
