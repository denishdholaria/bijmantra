...
class VaultSensorService:
    ...
    def _generate_demo_alerts(self):
        ...
        demo_alerts = [
            ...
            },
            {
                ...
                "acknowledged_at": (datetime.utcnow() - timedelta(hours=5, minutes=45)).isoformat(),
            },
            {
                "id": str(uuid4()),
                "vault_id": "vault-cryo-1",
    ...
    def link_sensor_to_vault(
        ...
        sensor_record = {
            ...
            "current_readings": {},
            "last_reading": None,
            "installed_date": datetime.utcnow().strftime("%Y-%m-%d"),
    ...
    def get_statistics(self) -> Dict:
        ...
        return {
            ...
            "total_readings_24h": len([r for r in self.readings if r["timestamp"] >= (datetime.utcnow() - timedelta(hours=24)).isoformat()]),
