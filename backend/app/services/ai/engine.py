"""
Cloud-Based LLM Service for REEVU
...
class LLMCallResult:
    ...
    content: str
    model_from_response: str | None = None  # Actual model returned by API
...
Remember: A breeder making decisions based on your advice could affect crop yields for thousands of farmers. Truth matters more than comfort."""
    ...
    async def get_available_providers(self) -> list[LLMConfig]:
        ...
        # Check forced provider (REEVU canonical, VEENA for backward compatibility)
