...
Always consider the practical constraints of PhD research (time, resources, scope)."""
    ...
    async def generate_rag_response(
        ...
        from app.services.ai.memory import BreedingVectorService, VectorStoreService
...
Keep the response concise and actionable."""
    ...
    async def recommend_approach(self, scenario: str, project_id: str | None = None) -> dict[str, Any]:
        """
