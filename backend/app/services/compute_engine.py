...
class ComputeEngine:
    ...
    def _check_fortran(self) -> bool:
        ...
        try:
            ...
            logger.warning("Could not import bijmantra_compute. Fortran backend disabled.")
            return False
    ...
    def _reml_fortran(self, *args) -> REMLResult:
        """Fortran implementation via Rust FFI"""
        # TODO: Add REML binding to rust
        logger.warning("REML Fortran backend not available yet, falling back to NumPy")
