...
class PhenologyService:
    ...
    def _init_demo_data(self):
        ...
        base_date = datetime.utcnow() - timedelta(days=75)
    ...
    def create_record(self, data: dict) -> dict:
        ...
        sowing_date = datetime.fromisoformat(data.get("sowing_date", datetime.utcnow().isoformat()))
        days_from_sowing = (datetime.utcnow() - sowing_date).days
    ...
    def update_record(self, record_id: str, data: dict) -> Optional[dict]:
        ...
        if record.get("sowing_date"):
            ...
            record["days_from_sowing"] = (datetime.utcnow() - sowing_date).days
