...
PROGRESS_DATA: Dict[str, Any] = {
    ...
    "divisions": [
        ...
        {"id": "div-6", "name": "Commercial", "status": "completed", "progress": 95, "endpoints": 78, "pages": 18, "notes": "DUS Testing added"},
    ...
    "recent_features": [
        ...
        },
        {
            ...
            "description": "Trial management, character scoring UI",
            "status": "planned",
            "priority": "high",
        ...
        },
        {
            ...
            "description": "File upload, validation preview",
            "status": "planned",
            "priority": "high",
