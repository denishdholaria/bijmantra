...
from app.services.task_queue import ComputeType, TaskQueue, TaskStatus
...
class HeavyComputeWorker:
    ...
    def __init__(self, worker_id: str = "heavy-worker-1", max_concurrent: int = 2):
        ...
        self.failed_count = 0
        # Each worker owns its own queue — never mutate the shared module-level singleton.
    ...
    async def start(self):
        ...
        # Start this worker's own queue (not the shared module-level singleton)
