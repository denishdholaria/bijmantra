...
async def create_demo_data():
    ...
    async with AsyncSessionLocal() as db:
        try:
            ...
            await db.commit()
            print("✓ Created 4 emission factors\n")
            ...
            for (germ_id, name, _crop), days_ago, hectares, farmers, _yield_imp in zip(germplasm_ids, [730, 1095, 1460, 1825, 365], [15000, 12000, 25000, 18000, 8000], [3000, 2500, 5000, 3500, 1500], [18.5, 22.3, 16.8, 20.1, 25.4], strict=False):
