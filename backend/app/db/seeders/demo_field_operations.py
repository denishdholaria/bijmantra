...
from app.core.demo_dataset import demo_dataset_date, demo_dataset_datetime
    ...
    def seed(self) -> int:
        ...
        for data in observations_data:
            obs = FieldBookObservation(
                ...
                observation_timestamp=demo_dataset_datetime() - timedelta(days=5),
            )
            self.db.add(obs)
            count += 1
