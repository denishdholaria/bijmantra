...
class OrchestratorMission(BaseModel):
    ...
    queue_job_id: Mapped[str | None] = mapped_column(String(256), nullable=True, index=True)
    source_lane_id: Mapped[str | None] = mapped_column(String(128), nullable=True, index=True)
