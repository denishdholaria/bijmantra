...
class DiseaseRiskForecast(BaseModel):
    ...
    risk_level = Column(String(50), nullable=False, index=True)  # e.g., 'Low', 'Medium', 'High'
    ...
    recommended_actions = Column(JSON, nullable=True)  # JSON array of recommended actions
