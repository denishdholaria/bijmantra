...
class ReasoningStage(enum.StrEnum):
...
class ReasoningTrace(BaseModel):
    ...
    # Evidence/sources
    evidence_sources: Mapped[list[str] | None] = mapped_column(
    ...
    parent = relationship(
        "app.models.veena_core.ReasoningTrace",
        remote_side=lambda: [ReasoningTrace.id],
        backref="children"
    )
...
class UserContext(BaseModel):
    ...
    focus_programs: Mapped[list[int] | None] = mapped_column(
        ARRAY(Integer), nullable=True
    ...
    frequently_asked_topics: Mapped[list[str] | None] = mapped_column(
        ARRAY(String), nullable=True
    )
