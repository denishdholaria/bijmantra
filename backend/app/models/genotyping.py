...
class ReferenceSet(BaseModel):
    ...
    references = relationship(
        "Reference", back_populates="reference_set", cascade="all, delete-orphan"
    )
...
class GenomeMap(BaseModel):
    ...
    # Relationships
    organization = relationship("Organization")
    linkage_groups = relationship(
        "LinkageGroup", back_populates="genome_map", cascade="all, delete-orphan"
    )
    marker_positions = relationship(
        "MarkerPosition", back_populates="genome_map", cascade="all, delete-orphan"
    )
...
class MarkerPosition(BaseModel):
    ...
    # Relationships
    organization = relationship("Organization")
    # lazy="raise" — callers must use selectinload(MarkerPosition.genome_map)
    genome_map = relationship("GenomeMap", back_populates="marker_positions", lazy="raise")
...
class VariantSet(BaseModel):
    ...
    call_sets = relationship(
        "CallSet", secondary="variant_set_call_sets", back_populates="variant_sets"
    )
...
class Variant(BaseModel):
    ...
    # Relationships
    organization = relationship("Organization")
    # lazy="raise" — callers must use selectinload(Variant.variant_set)
    variant_set = relationship("VariantSet", back_populates="variants", lazy="raise")
...
class CallSet(BaseModel):
    ...
    # Relationships
    organization = relationship("Organization")
    # lazy="raise" — callers must use selectinload(CallSet.sample)
    sample = relationship("Sample", lazy="raise")
    calls = relationship("Call", back_populates="call_set", cascade="all, delete-orphan")
    variant_sets = relationship(
        "VariantSet", secondary="variant_set_call_sets", back_populates="call_sets"
    )
...
class Call(BaseModel):
    ...
    # Relationships
    organization = relationship("Organization")
    # lazy="raise" — callers must use selectinload(Call.variant) / selectinload(Call.call_set)
    variant = relationship("Variant", back_populates="calls", lazy="raise")
    call_set = relationship("CallSet", back_populates="calls", lazy="raise")
