...
class VeenaMemory(Base):
    ...
    __table_args__ = (
        ...
        Index("ix_veena_memories_v2_org_id", "organization_id"),
        Index("ix_veena_memories_v2_created_at", "created_at"),
    )

    id: Mapped[int] = mapped_column(Integer, primary_key=True)
    # ADR-006: Tenant ownership for RLS
...
class ReasoningTrace(Base):
    ...
    __table_args__ = (
        ...
        Index("ix_reasoning_trace_v2_org_id", "organization_id"),
    )
...
class UserContext(Base):
    ...
    __table_args__ = (
        ...
        Index("ix_veena_user_contexts_v2_org_id", "organization_id"),
    )
