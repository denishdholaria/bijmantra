...
class PhenomicModel(BaseModel):
    ...
    # Status
    status = Column(
        String(20), nullable=False, default="training", index=True
    )  # training, deployed, archived
    ...
    __table_args__ = (Index("ix_phenomic_models_dataset_status", "dataset_id", "status"),)
