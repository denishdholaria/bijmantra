...
async def create_expense(
    ...
    record = await crud.expense.create(db, obj_in=record_in, org_id=current_user.organization_id)
...
async def get_summary(
    db: AsyncSession = Depends(get_tenant_db), org_id: int = Depends(get_organization_id)
):
