...
async def block_target(request: BlockRequest):
    ...
    from app.modules.core.services.prahari.responder import ResponseAction

    if request.target_type == "ip":
        # Create a dummy assessment for the block action
        from app.modules.core.services.prahari.threat_analyzer import ThreatAssessment, ThreatCategory
