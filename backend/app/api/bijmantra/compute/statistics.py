...
from app.modules.ai.services.statistics_service import statistics_service
...
@router.get("/overview")
async def get_overview(trial_id: str | None = Query(None)):
...
async def get_summary_stats(
    ...
    trait_ids: str | None = Query(None, description="Comma-separated trait IDs"),
):
