...
@router.get("/projects")
async def list_projects(db: AsyncSession = Depends(get_tenant_db)):
...
async def get_project(project_id: str, db: AsyncSession = Depends(get_tenant_db)):
...
async def get_milestones(project_id: str, db: AsyncSession = Depends(get_tenant_db)):
...
async def update_milestone(project_id: str, milestone_id: str, data: MilestoneUpdate, db: AsyncSession = Depends(get_tenant_db)):
    """Update a milestone"""
    service = get_devguru_service(db)
...
async def get_timeline_analysis(project_id: str, db: AsyncSession = Depends(get_tenant_db)):
...
async def get_mentoring_suggestions(project_id: str, db: AsyncSession = Depends(get_tenant_db)):
...
@router.get("/status")
async def get_devguru_status(db: AsyncSession = Depends(get_tenant_db)):
...
async def link_project_to_program(project_id: str, request: LinkProgramRequest, db: AsyncSession = Depends(get_tenant_db)):
...
async def get_project_experiments(project_id: str, db: AsyncSession = Depends(get_tenant_db)):
...
async def get_experiment_studies(trial_id: int, db: AsyncSession = Depends(get_tenant_db)):
...
async def get_research_programs(db: AsyncSession = Depends(get_tenant_db)):
...
async def list_papers(project_id: str, db: AsyncSession = Depends(get_tenant_db)):
...
async def add_paper(project_id: str, data: PaperCreate, db: AsyncSession = Depends(get_tenant_db)):
...
async def update_paper(paper_id: str, data: PaperUpdate, db: AsyncSession = Depends(get_tenant_db)):
    """Update a paper"""
    service = get_devguru_service(db)
...
async def delete_paper(paper_id: str, db: AsyncSession = Depends(get_tenant_db)):
    """Delete a paper"""
    service = get_devguru_service(db)
...
async def link_paper_to_experiment(paper_id: str, data: PaperExperimentLinkCreate, db: AsyncSession = Depends(get_tenant_db)):
...
async def get_literature_stats(project_id: str, db: AsyncSession = Depends(get_tenant_db)):
...
async def list_chapters(project_id: str, db: AsyncSession = Depends(get_tenant_db)):
...
async def create_chapter(project_id: str, data: ChapterCreate, db: AsyncSession = Depends(get_tenant_db)):
...
async def generate_default_chapters(project_id: str, db: AsyncSession = Depends(get_tenant_db)):
...
async def update_chapter(chapter_id: str, data: ChapterUpdate, db: AsyncSession = Depends(get_tenant_db)):
    """Update a chapter"""
    service = get_devguru_service(db)
...
async def log_writing_session(chapter_id: str, data: WritingSessionCreate, db: AsyncSession = Depends(get_tenant_db)):
...
async def get_writing_stats(project_id: str, db: AsyncSession = Depends(get_tenant_db)):
...
async def list_committee_members(project_id: str, db: AsyncSession = Depends(get_tenant_db)):
...
async def add_committee_member(project_id: str, data: CommitteeMemberCreate, db: AsyncSession = Depends(get_tenant_db)):
...
async def update_committee_member(member_id: str, data: CommitteeMemberUpdate, db: AsyncSession = Depends(get_tenant_db)):
...
async def list_meetings(project_id: str, db: AsyncSession = Depends(get_tenant_db)):
...
async def schedule_meeting(project_id: str, data: MeetingCreate, db: AsyncSession = Depends(get_tenant_db)):
...
async def update_meeting(meeting_id: str, data: MeetingUpdate, db: AsyncSession = Depends(get_tenant_db)):
    """Update a meeting"""
    service = get_devguru_service(db)
...
async def list_feedback(project_id: str, status: str | None = None, db: AsyncSession = Depends(get_tenant_db)):
...
async def add_feedback(project_id: str, data: FeedbackCreate, db: AsyncSession = Depends(get_tenant_db)):
    """Add a feedback item"""
    service = get_devguru_service(db)
...
async def update_feedback(feedback_id: str, data: FeedbackUpdate, db: AsyncSession = Depends(get_tenant_db)):
...
async def get_collaboration_stats(project_id: str, db: AsyncSession = Depends(get_tenant_db)):
...
@router.get("/topics")
async def get_breeding_topics(db: AsyncSession = Depends(get_tenant_db)):
