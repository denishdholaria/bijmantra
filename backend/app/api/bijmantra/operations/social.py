...
from app.modules.core.services.social.content import ContentService
from app.modules.core.services.social.graph import SocialGraphService
from app.modules.core.services.social.groups import GroupService
from app.modules.core.services.social.moderation import ModerationService


router = APIRouter(dependencies=[Depends(get_current_user)])

# Dependencies
def get_graph_service(db: AsyncSession = Depends(get_tenant_db)) -> SocialGraphService:
    return SocialGraphService(db)

def get_content_service(db: AsyncSession = Depends(get_tenant_db)) -> ContentService:
    return ContentService(db)

def get_moderation_service(db: AsyncSession = Depends(get_tenant_db)) -> ModerationService:
    return ModerationService(db)

def get_group_service(db: AsyncSession = Depends(get_tenant_db)) -> GroupService:
