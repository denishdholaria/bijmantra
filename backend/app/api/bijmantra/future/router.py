...
from app.api.bijmantra.future import (
...
future_router.include_router(
    fertilizer_recommendation.router, prefix="/future", tags=["Fertilizer Recommendations"]
)
future_router.include_router(soil_health.router, prefix="/future", tags=["Soil Health"])
future_router.include_router(
    carbon_sequestration.router, prefix="/future", tags=["Carbon Sequestration"]
)
...
# Water & Irrigation
future_router.include_router(
    irrigation_schedule.router, prefix="/future", tags=["Irrigation Schedules"]
)
