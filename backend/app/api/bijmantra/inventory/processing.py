...
from app.modules.core.services.processing_batch_service import get_processing_service


router = APIRouter(prefix="/processing", tags=["Seed Processing"], dependencies=[Depends(get_current_user)])
...
class BatchCreate(BaseModel):
    ...
    target_output_kg: float | None = Field(None, description="Target output quantity")
...
class StageStart(BaseModel):
    ...
    input_quantity_kg: float | None = Field(None, description="Input quantity (defaults to current)")
    parameters: dict[str, Any] | None = Field(None, description="Stage parameters")
...
async def list_batches(
    ...
    lot_id: str | None = Query(None, description="Filter by lot ID"),
