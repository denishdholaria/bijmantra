...
from app.modules.core.services.data_quality import get_data_quality_service
...
async def list_issues(
    ...
    issueType: str | None = Query(None, description="Filter by issue type"),
...
async def run_validation(entity: str | None = Query(None, description="Entity to validate (all if not specified)")):
    """Run data validation"""
    service = get_data_quality_service()
