...
from app.services.rate_limiter import RateLimitType, rate_limiter
...
async def reset_rate_limit(
    ...
    # Verify reset token
    if not settings.RATE_LIMIT_RESET_TOKEN or x_ratelimit_reset_token != settings.RATE_LIMIT_RESET_TOKEN:
        raise HTTPException(
            status_code=status.HTTP_403_FORBIDDEN,
