...
router = APIRouter(prefix="/phenotype-comparison", tags=["Phenotype Comparison"], dependencies=[Depends(get_current_user)])
...
class ComparisonResult(BaseModel):
    ...
    vs_check: dict[str, float] | None = None
