...
from app.modules.breeding.services.pipeline_service import BreedingPipelineService
...
async def list_entries(
    ...
    status: str | None = Query(None, description="Filter by status (active, released, dropped)"),
    year: int | None = Query(None, description="Filter by year"),
    search: str | None = Query(None, description="Search by name, pedigree, or ID"),
