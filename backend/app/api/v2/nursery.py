...
from app.modules.breeding.services.nursery_service import get_nursery_service
...
class StatusUpdateRequest(BaseModel):
    ...
    harvest_date: str | None = Field(None, description="Harvest date (YYYY-MM-DD)")
...
async def list_nurseries(
    ...
    nursery_type: str | None = Query(None, description="Filter by type"),
