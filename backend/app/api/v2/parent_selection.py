...
from app.modules.breeding.services.parent_selection_service import parent_selection_service
...
async def list_parents(
    parent_type: str | None = Query(None, description="Filter by type: elite, donor, landrace"),
...
async def get_recommendations(
    target_traits: str | None = Query(None, description="Comma-separated target traits"),
