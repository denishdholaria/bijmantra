...
from app.modules.environment.services.weather_service import ActivityType, WeatherForecast, weather_service
...
async def get_activity_windows(
    location_id: str,
    location_name: str = Query("Location"),
    activity: ActivityType | None = Query(None, description="Filter by activity type"),
