...
from app.modules.genomics.services.molecular_breeding_service import molecular_breeding_service
...
async def list_schemes(
    scheme_type: str | None = Query(None, description="Filter by type (MABC, MARS, GS, Speed)"),
...
async def list_lines(
    scheme_id: str | None = Query(None, description="Filter by scheme"),
    foreground_status: str | None = Query(None, description="Filter by foreground status"),
    db: AsyncSession = Depends(get_db),
    current_user=Depends(get_current_user),
):
