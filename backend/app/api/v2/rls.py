...
async def test_rls_for_table(
    ...
    # Since table_name is validated against RLS_ENABLED_TABLES whitelist,
    # it's safe to use in the query. We use identifier quoting for safety.
    ...
    if is_superuser:
        ...
        # org_id is validated as integer from JWT
        await db.execute(
