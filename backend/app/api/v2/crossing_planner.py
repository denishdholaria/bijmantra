...
from app.modules.breeding.services.crossing_planner_service import crossing_planner_service
...
class CrossCreate(BaseModel):
    femaleParentId: str
    maleParentId: str
    femaleParentName: str | None = None
    maleParentName: str | None = None
