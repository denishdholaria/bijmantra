...
from app.modules.environment.services.sensor_network_service import sensor_network_service
...
async def get_readings(
    ...
    since: str | None = Query(None, description="Filter readings since timestamp"),
...
async def acknowledge_alert(
    event_id: str,
    user: str | None = Query(None, description="User acknowledging the alert"),
    db: AsyncSession = Depends(get_db),
    current_user: User = Depends(get_current_user)
):
