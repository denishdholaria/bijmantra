...
class PedigreeRecord(BaseModel):
    ...
    sire_id: str | None = Field(None, description="Sire (father) ID")
    dam_id: str | None = Field(None, description="Dam (mother) ID")
...
class RelationshipMatrixRequest(BaseModel):
    ...
    individual_ids: list[str] | None = Field(None, description="Subset of individuals (None = all)")
