...
apex_router.include_router(chat.router, tags=["REEVU AI Chat"])
apex_router.include_router(veena_ai.router, tags=["REEVU Cognitive Core"])
apex_router.include_router(voice.router, tags=["REEVU Voice"])
...
apex_router.include_router(ai_configuration.router, tags=["AI Configuration"])
apex_router.include_router(developer_control_plane.router, tags=["Developer Control Plane"])
...
apex_router.include_router(proposals.router, tags=["Proposals (Scribe)"])
...
apex_router.include_router(biosimulation.router, tags=["Biosimulation"])
...
# apex_router.include_router(germplasm_comparison.router, tags=["Germplasm Comparison"])  # Now in germplasm_router
...
apex_router.include_router(ld.router, tags=["Linkage Disequilibrium"])
...
# apex_router.include_router(germplasm_search.router, tags=["Germplasm Search"])  # Now in germplasm_router
...
# apex_router.include_router(germplasm_collection.router, tags=["Germplasm Collections"])  # Now in germplasm_router
...
apex_router.include_router(calculators.router, tags=["Calculators"])
