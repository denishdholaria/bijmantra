...
class ListCreate(BaseModel):
    ...
    listOwnerName: str | None = None
    listOwnerPersonDbId: str | None = None
    listSource: str | None = None
...
class ListUpdate(BaseModel):
    ...
    listOwnerPersonDbId: str | None = None
    listSource: str | None = None
    externalReferences: list[dict] | None = None
...
async def get_lists(
    ...
    listType: str | None = Query(None, description="Filter by list type"),
    listName: str | None = Query(None, description="Filter by list name"),
    listDbId: str | None = Query(None, description="Filter by list DbId"),
    listSource: str | None = Query(None, description="Filter by list source"),
    ...
    lists_data = [model_to_dict(item) for item in lists]
...
async def update_list(
    ...
    list_obj.date_modified = datetime.now(UTC).isoformat() + "Z"
