...
class ServerInfo(BaseModel):
    ...
    contactEmail: str | None = "support@bijmantra.org"
    documentationURL: str | None = "https://bijmantra.org/docs"
    location: str | None = "India"
    organizationName: str | None = "Bijmantra"
    organizationURL: str | None = "https://bijmantra.org"
    serverDescription: str | None = "Bijmantra - Plant Breeding Platform powered by Parashakti Framework"
    serverName: str | None = "Bijmantra BrAPI Server"
