...
from app.modules.breeding.services.performance_ranking_service import performance_ranking_service
...
async def get_rankings(
    ...
    search: str | None = Query(None, description="Search by name, ID, or traits"),
