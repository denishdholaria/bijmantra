...
async def get_rankings(
    ...
    """
    rankings = performance_ranking_service.get_rankings(
...
async def get_top_performers(
    ...
    top = performance_ranking_service.get_top_performers(
        program_id=program_id,
        trial_id=trial_id,
        limit=limit,
    )
...
async def get_statistics(
    ...
    stats = performance_ranking_service.get_statistics(
        program_id=program_id,
        trial_id=trial_id,
    )
...
async def get_entry(entry_id: str):
    ...
    entry = performance_ranking_service.get_entry(entry_id)
    if not entry:
...
@router.post("/compare")
async def compare_entries(data: CompareRequest):
    """Compare multiple entries side by side"""
    result = performance_ranking_service.compare_entries(data.entry_ids)
    if "error" in result:
...
async def get_programs():
    ...
    programs = performance_ranking_service.get_programs()
...
async def get_trials(
    ...
    trials = performance_ranking_service.get_trials(program_id=program_id)
