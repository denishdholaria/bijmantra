...
from app.modules.genomics.services.parentage_analysis_service import parentage_service
...
class VerifyParentageRequest(BaseModel):
    ...
    claimed_male_id: str | None = Field(None, description="ID of the claimed male parent (optional)")
...
class FindParentsRequest(BaseModel):
    ...
    candidate_ids: list[str] | None = Field(None, description="List of candidate parent IDs (optional, uses all if not specified)")
