...
from app.modules.breeding.services.stability_analysis_service import stability_analysis_service
...
async def list_varieties(
    ...
    min_yield: float | None = Query(None, description="Minimum mean yield"),
