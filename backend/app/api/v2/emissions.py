...
from app.models.climate import EmissionCategory, VarietyFootprint
from app.models.core import User
from app.modules.environment.services.emissions_calculator_service import get_emissions_calculator_service
...
class EmissionSourceCreate(BaseModel):
    ...
    trial_id: int | None = Field(None, description="Trial ID (optional)")
    study_id: int | None = Field(None, description="Study ID (optional)")
...
class EmissionsCalculateRequest(BaseModel):
    ...
    fertilizer: dict | None = Field(None, description="Fertilizer inputs {n_kg, p_kg, k_kg}")
    fuel: dict | None = Field(None, description="Fuel inputs {diesel_liters, petrol_liters}")
    irrigation: dict | None = Field(None, description="Irrigation inputs {kwh, energy_source}")


class EmissionsCalculateResponse(BaseModel):
    """Schema for emissions calculation response"""
    fertilizer_emissions: dict | None = None
    fuel_emissions: dict | None = None
    irrigation_emissions: dict | None = None
...
class VarietyFootprintResponse(BaseModel):
    ...
    emissions_by_category: dict | None
...
async def list_emission_sources(
    ...
    trial_id: int | None = Query(None, description="Filter by trial"),
    study_id: int | None = Query(None, description="Filter by study"),
    category: EmissionCategory | None = Query(None, description="Filter by category"),
