...
from app.modules.breeding.services.trial_network_service import trial_network_service
...
async def get_statistics(
    ...
    stats = await trial_network_service.get_statistics(
        db, current_user.organization_id, season=season
    )
