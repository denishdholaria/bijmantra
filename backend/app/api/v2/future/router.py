...
# Soil & Fertilizer
future_router.include_router(soil_test.router, tags=["Soil Tests"])
future_router.include_router(fertilizer_recommendation.router, tags=["Fertilizer Recommendations"])
future_router.include_router(soil_health.router, tags=["Soil Health"])
future_router.include_router(carbon_sequestration.router, tags=["Carbon Sequestration"])
...
# Water & Irrigation
future_router.include_router(irrigation_schedule.router, tags=["Irrigation Schedules"])
future_router.include_router(water_balance.router, tags=["Water Balance"])
