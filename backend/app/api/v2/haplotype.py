...
from app.modules.genomics.services.haplotype_analysis_service import haplotype_service
...
async def list_blocks(
    ...
    min_length: int | None = Query(None, description="Minimum block length in kb"),
...
async def get_associations(
    trait: str | None = Query(None, description="Filter by trait name"),
    chromosome: str | None = Query(None, description="Filter by chromosome"),
    db: AsyncSession = Depends(get_db),
    current_user=Depends(get_current_user),
):
