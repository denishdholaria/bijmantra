...
async def list_blocks(
    ...
    """
    blocks = haplotype_service.get_blocks(chromosome=chromosome, min_length=min_length)
    return {
        "success": True,
        "count": len(blocks),
        "blocks": blocks,
...
async def get_block(block_id: str):
    ...
    """
    block = haplotype_service.get_block(block_id)
    if not block:
...
async def get_block_haplotypes(block_id: str):
    """
    Get haplotypes for a specific block
    
    Returns all haplotypes with frequencies and associations.
    """
    haplotypes = haplotype_service.get_haplotypes(block_id)
    return {
        "success": True,
        "block_id": block_id,
...
async def get_associations(
    ...
    """
    associations = haplotype_service.get_associations(trait=trait, chromosome=chromosome)
    return {
        "success": True,
...
async def get_favorable_haplotypes(
    ...
    """
    favorable = haplotype_service.get_favorable_haplotypes(trait=trait)
    return {
        "success": True,
        "count": len(favorable),
...
async def get_diversity_summary():
    ...
    """
    summary = haplotype_service.get_diversity_summary()
    return {
        "success": True,
        "data": summary,
    }
...
async def get_statistics():
    ...
    """
    stats = haplotype_service.get_statistics()
    return {
        "success": True,
        "data": stats,
    }
...
async def get_traits():
    ...
    """
    associations = haplotype_service.get_associations()
    traits = {}
