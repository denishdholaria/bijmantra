...
async def stream_chat_with_veena(
    ...
    **Streaming Format:**
    ...
    Args:
        ...
        breeding_service: Injected breeding knowledge service for RAG context
    ...
    async def generate_stream() -> AsyncGenerator[str, None]:
        ...
        try:
            # Determine the actual provider that will be used
            # If user provided BYOK credentials, use those; otherwise fall back to server status
            ...
            # Check if we have a valid provider (either BYOK or server-configured)
            ...
            if not has_byok:
                ...
                if status.get("active_provider") == "template" and not any(
                    ...
                    yield 'data: {"type": "chunk", "content": "Please configure an LLM provider in AI Settings for full conversational capabilities."}\n\n'
