...
from app.modules.breeding.services.trial_planning_service import get_trial_planning_service
...
async def list_trials(
    ...
    type: str | None = Query(None, description="Filter by trial type"),
    season: str | None = Query(None, description="Filter by season"),
    year: int | None = Query(None, description="Filter by year"),
    crop: str | None = Query(None, description="Filter by crop"),
    search: str | None = Query(None, description="Search by name or objectives"),
