...
from app.modules.breeding.services.selection_decisions_service import selection_decisions_service
...
class DecisionRequest(BaseModel):
    ...
    notes: str | None = Field(None, description="Optional notes for the decision")
...
async def list_candidates(
    ...
    generation: str | None = Query(None, description="Filter by generation"),
    decision_status: str | None = Query(None, description="Filter by decision status: advance, reject, hold, pending"),
    min_gebv: float | None = Query(None, description="Minimum GEBV threshold"),
    search: str | None = Query(None, description="Search by name, pedigree, or traits"),
...
async def get_decision_history(
    ...
    candidate_id: str | None = Query(None, description="Filter by candidate"),
    db: AsyncSession = Depends(get_db),
    current_user=Depends(get_current_user),
):
