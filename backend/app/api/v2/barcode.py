...
from app.modules.germplasm.services.barcode_service import BarcodeFormat, EntityType, barcode_service
...
async def get_scan_history(
    ...
    barcode_value: str | None = Query(None, description="Filter by barcode"),
    db: AsyncSession = Depends(get_db),
    current_user=Depends(get_current_user),
):
    """Get scan history"""
