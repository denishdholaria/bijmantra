...
async def get_attributes(
    ...
    attributeCategory: str | None = Query(None),
    attributeDbId: str | None = Query(None),
    attributeName: str | None = Query(None),
    attributePUI: str | None = Query(None),
    commonCropName: str | None = Query(None),
    germplasmDbId: str | None = Query(None),
    programDbId: str | None = Query(None),
    traitDbId: str | None = Query(None),
    methodDbId: str | None = Query(None),
