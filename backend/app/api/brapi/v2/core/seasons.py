...
from app.modules.core.services.seasons.seasons_service import season_service
...
async def list_seasons(
    ...
    season_db_id: str | None = Query(None, alias="seasonDbId"),
    ...
    seasons, total_count = await season_service.list_seasons(
        db=db, org_id=org_id, page=page, page_size=page_size, year=year, season_db_id=season_db_id
    )
...
async def get_season(
    seasonDbId: str, db: AsyncSession = Depends(get_tenant_db), org_id: int = Depends(get_organization_id)
):
