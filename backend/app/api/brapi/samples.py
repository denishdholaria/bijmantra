...
async def create_sample(
    sample: SampleCreate, db: AsyncSession = Depends(get_db), current_user=Depends(get_current_user)
):
...
async def get_sample(
    sampleDbId: str, db: AsyncSession = Depends(get_db), current_user=Depends(get_optional_user)
):
