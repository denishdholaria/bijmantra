...
async def list_germplasm(
    ...
    """Get list of germplasm from database"""
...
async def get_germplasm_progeny(
    ...
    """Get progeny (offspring) of a germplasm"""
    ...
    # TODO: Query Cross table for actual progeny when populated
    progeny_data = {
        "germplasmDbId": germplasmDbId,
        "germplasmName": germ.germplasm_name,
        "progeny": []
    ...
    return _brapi_response(progeny_data, page, pageSize, total=0)
