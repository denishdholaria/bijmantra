...
async def create_observation(
    ...
    new_obs = Observation(
        ...
        observation_time_stamp=observation.observationTimeStamp or datetime.now(UTC).isoformat() + "Z",
...
async def get_observations_table(
    studyDbId: str | None = None,
    observationUnitDbId: list[str] | None = Query(None),
    observationVariableDbId: list[str] | None = Query(None),
