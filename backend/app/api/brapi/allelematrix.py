...
async def get_allele_matrix(
    ...
    preview: bool = False,
    dataMatrixAbbreviations: list[str] | None = Query(None),
    dataMatrixNames: list[str] | None = Query(None),
    germplasmDbId: list[str] | None = Query(None),
    germplasmName: list[str] | None = Query(None),
    germplasmPUI: list[str] | None = Query(None),
    callSetDbId: list[str] | None = Query(None),
    variantDbId: list[str] | None = Query(None),
    variantSetDbId: list[str] | None = Query(None),
