...
RLS_ENABLED_TABLES = [
    # Core BrAPI tables (INTEGER organization_id)
    "programs",
    "trials",
    "studies",
    "locations",
    "people",
    "users",
    # Seed Bank tables (INTEGER organization_id after migration 007)
    "seed_bank_vaults",
    "seed_bank_accessions",
    "seed_bank_viability_tests",
    "seed_bank_regeneration_tasks",
    "seed_bank_exchanges",
    # Security audit tables (optional - may want superuser-only)
    # "security_audit_log",
    # "security_threats",
    # "security_responses",
]
