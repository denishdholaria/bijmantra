...
from app.modules.breeding.services.speed_breeding_service import SpeedBreedingService
...
async def test_get_chamber_statistics():
    ...
    # Mock chambers
    chamber1 = SpeedBreedingChamber(
        id=1, organization_id=organization_id, status="active", capacity=100
    )
    chamber2 = SpeedBreedingChamber(
        id=2, organization_id=organization_id, status="maintenance", capacity=200
    )
    chamber3 = SpeedBreedingChamber(
        id=3, organization_id=organization_id, status="active", capacity=100
    )
