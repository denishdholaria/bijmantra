...
class VendorOrderBase(BaseModel):
    client_id: Optional[str] = Field(None, alias="clientId", description="A unique identifier for the client submitting the order")
    number_of_samples: Optional[int] = Field(None, alias="numberOfSamples", description="The number of samples in the order")
    required_service_info: Optional[Dict[str, Any]] = Field(None, alias="requiredServiceInfo", description="Additional information required by the requested service")
    service_ids: Optional[List[str]] = Field(None, alias="serviceIds", description="List of service identifiers requested")
...
class VendorOrder(VendorOrderBase):
    ...
    order_id: Optional[str] = Field(None, alias="orderId", description="Human readable order ID")
    status: Optional[str] = Field(None, description="The current status of the order")
    status_time_stamp: Optional[str] = Field(None, alias="statusTimeStamp", description="Timestamp of the last status update")
