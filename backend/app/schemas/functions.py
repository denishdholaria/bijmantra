...
BIJMANTRA_FUNCTIONS: List[Dict[str, Any]] = [
    ...
    {
        "name": "create_trial",
        "description": "Create a new breeding trial with specified parameters.",
        "parameters": {
            "type": "object",
            "properties": {
                "name": {
    ...
    {
        "name": "create_cross",
        "description": "Create a new cross record between two parents.",
        "parameters": {
            "type": "object",
            "properties": {
                "parent1_id": {
    ...
    # ========== OBSERVATIONS ==========
    {
        ...
        "description": "Record a phenotypic observation for a plot or plant.",
        "parameters": {
            "type": "object",
            "properties": {
                "trial_id": {
