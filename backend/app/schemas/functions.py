...
FUNCTION_LABELS: dict[str, str] = {
    ...
    "get_trait_distribution": "Get Trait Distribution",
    "get_seed_inventory": "Get Seed Inventory",
    "get_field_info": "Get Field Info",
    "get_crop_calendar": "Get Crop Calendar",
    ...
    "search_seedlots": "Search Seedlots",
...
FUNCTION_CATEGORY_BY_NAME: dict[str, str] = {
    ...
    "get_observations": "phenotyping_analytics",
    "get_trait_distribution": "phenotyping_analytics",
    "get_seed_inventory": "environment_operations",
    "get_field_info": "environment_operations",
    "get_crop_calendar": "environment_operations",
    ...
    "search_locations": "environment_operations",
    "search_seedlots": "environment_operations",
...
BIJMANTRA_FUNCTIONS: list[dict[str, Any]] = [
    ...
    {
        "name": "get_trait_distribution",
        "description": "Get distribution data for a phenotypic trait, including bins and quartiles.",
        "parameters": {
            "type": "object",
            "properties": {
                "query": {
                    "type": "string",
                    "description": "Original distribution request to plan and audit",
                },
                "trait": {
                    "type": "string",
                    "description": "Trait name",
                ...
                "study_id": {
                    "type": "string",
                    "description": "Optional study ID scope",
                },
                "germplasm_id": {
                    "type": "string",
                    "description": "Optional germplasm ID scope",
                },
                "date_from": {
                    "type": "string",
                    "description": "Start date (YYYY-MM-DD)",
    ...
    {
        "name": "search_seedlots",
        "description": "Search seed lots by name, storage location, germplasm, or accession context.",
        "parameters": {
            "type": "object",
            "properties": {
                "query": {
                    "type": "string",
                    "description": "Free-form seed lot search query",
                },
                "germplasm_id": {
                    "type": "string",
                    "description": "Optional germplasm ID scope",
                ...
                "location_id": {
                    "type": "string",
                    "description": "Optional storage location ID scope",
                },
            },
        },
    },
    {
        ...
        "description": "Retrieve seed inventory and availability for seed lots, germplasm, or accessions.",
        "parameters": {
            "type": "object",
            "properties": {
                "query": {
                    "type": "string",
                    "description": "Original seed inventory request to plan and audit",
                },
                "germplasm": {
                    "type": "string",
                    "description": "Optional germplasm or accession name",
                },
                "germplasm_id": {
                    "type": "string",
                    "description": "Optional exact germplasm ID",
                },
                "location": {
                    "type": "string",
                    "description": "Optional storage location query or ID",
                },
            },
        },
    },
    ...
    # ========== WEATHER & ENVIRONMENT ==========
    {
        ...
        "description": "Search field locations, stations, and spatial trial sites by name, region, country, or type.",
        "parameters": {
            "type": "object",
            "properties": {
                "query": {
                    "type": "string",
                    "description": "Free-form location or field search query",
                },
                "country": {
                    "type": "string",
                ...
                "location_type": {
                    "type": "string",
                    "description": "Optional location type or station category",
                },
            },
        },
    },
    {
        "name": "get_field_info",
        "description": "Retrieve field or location details, coordinates, layouts, and season context.",
        "parameters": {
            "type": "object",
            "properties": {
                "query": {
                    "type": "string",
                    "description": "Original field information request to plan and audit",
                },
                "location": {
                    "type": "string",
                    "description": "Optional field, station, or location name",
                },
                "crop": {
                    "type": "string",
                    "description": "Optional crop filter for field season context",
                },
                "season": {
                    "type": "string",
                    "description": "Optional season or crop-year filter",
                },
            },
        },
    },
    {
        ...
        "description": "Retrieve crop calendar events such as planting, sowing, growth-stage, and harvest dates.",
        "parameters": {
            "type": "object",
            "properties": {
                "query": {
                    "type": "string",
                    "description": "Original crop calendar request to plan and audit",
                },
                "crop": {
                    "type": "string",
                    "description": "Crop name such as wheat, rice, or maize",
                },
                "location": {
                    "type": "string",
                    "description": "Optional field, station, or location name",
