...
class BreedingKnowledgeBase:
    ...
    TOPICS = {
        "genomic_selection": {
            ...
            "key_methods": [
                ...
                "rrBLUP",
                "Bayesian Alphabet (BayesA, BayesB, BayesCpi)",
        ...
        "high_throughput_phenotyping": {
            ...
            "key_methods": [
                "Remote Sensing (UAV/Drone)",
                "Ground-based Platforms",
                "Computer Vision",
                "Spectral Imaging (RGB, Multispectral, Hyperspectral)",
            ],
            "citations": [
                {
    ...
    @classmethod
    def get_topic_info(cls, topic_key: str) -> dict[str, Any] | None:
        """Get detailed info for a topic by key"""
        return cls.TOPICS.get(topic_key)

    @classmethod
    def find_topic(cls, query: str) -> dict[str, Any] | None:
