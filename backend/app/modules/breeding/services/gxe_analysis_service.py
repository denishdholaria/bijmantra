...
class FinlayWilkinsonResult:
    ...
    def _classify_stability(self) -> list[dict[str, Any]]:
        ...
        for i, name in enumerate(self.genotype_names):
            ...
            performance = "high_yielding" if mean > mean_yield else "low_yielding"
...
class GxEAnalysisService:
    ...
    def identify_mega_environments(
        ...
        mega_envs = {}
        for _i, (name, cluster) in enumerate(zip(gge_result.environment_names, clusters, strict=False)):
        ...
        return {
            ...
            "cluster_assignments": dict(zip(gge_result.environment_names, clusters.tolist(), strict=False)),
        }
...
# Singleton instance
_gxe_service: GxEAnalysisService | None = None
