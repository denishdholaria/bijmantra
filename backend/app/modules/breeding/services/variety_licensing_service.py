...
class VarietyLicensingService:
    ...
    def get_variety(self, variety_id: str) -> dict | None:
        """Get variety details"""
    ...
    def create_license(
        ...
        minimum_royalty: float | None = None,
    ...
    def list_licenses(
        ...
        if variety_id:
            licenses = [lic for lic in licenses if lic["variety_id"] == variety_id]
        if licensee_id:
            licenses = [lic for lic in licenses if lic["licensee_id"] == licensee_id]
        if license_type:
            licenses = [lic for lic in licenses if lic["license_type"] == license_type]
        if status:
    ...
    def get_statistics(self) -> dict:
        ...
        for lic in licenses:
            ...
            lstatus = lic["status"]
            license_by_status[lstatus] = license_by_status.get(lstatus, 0) + 1
