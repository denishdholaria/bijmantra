...
class BenefitSharingType(enum.StrEnum):
...
class MTAService:
    ...
    def create_mta(
        ...
        crops: list,
        purpose: str,
        benefit_sharing: dict | None = None,
    ...
    def list_mtas(
        self,
        mta_type: MTAType | None = None,
        status: MTAStatus | None = None,
    ...
    def get_mta(self, mta_id: str) -> dict | None:
        """Get MTA by ID"""
        return self.mtas.get(mta_id)

    def get_mta_by_number(self, mta_number: str) -> dict | None:
        """Get MTA by number"""
    ...
    def submit_for_review(self, mta_id: str) -> dict | None:
    ...
    def approve_mta(self, mta_id: str, approver: str) -> dict | None:
    ...
    def reject_mta(self, mta_id: str, reason: str, rejector: str) -> dict | None:
        """Reject MTA"""
        mta = self.mtas.get(mta_id)
        if not mta:
            return None
    ...
    def sign_mta(self, mta_id: str, signatory: str) -> dict | None:
    ...
    def terminate_mta(self, mta_id: str, reason: str, terminator: str) -> dict | None:
    ...
    def get_mta_for_exchange(self, exchange_id: str) -> dict | None:
