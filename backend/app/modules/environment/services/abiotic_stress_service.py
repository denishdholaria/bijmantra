...
class AbioticStressService:
        ...
        stresses = [
            {
                ...
                "name": "Drought",
                "category": "water",
                "description": "Water deficit stress",
            },
            {
                "stress_id": "STR-002",
                "name": "Heat",
            ...
            },
            {
                ...
                "name": "Cold",
                "category": "temperature",
                "description": "Low temperature/chilling stress",
            },
            {
                "stress_id": "STR-004",
                "name": "Salinity",
                "category": "soil",
                "description": "Salt stress in soil",
            },
            {
                "stress_id": "STR-005",
                "name": "Submergence",
                "category": "water",
                "description": "Flooding/waterlogging",
            },
            {
                "stress_id": "STR-006",
            ...
            },
            {
                ...
                "name": "Heavy Metal",
                "category": "soil",
                "description": "Toxic metal accumulation",
            },
            {
                "stress_id": "STR-008",
                "name": "UV Radiation",
                "category": "radiation",
                "description": "High UV exposure",
            },
        ]
    ...
    def get_stress_type(self, stress_id: str) -> dict | None:
    ...
    def list_genes(
        ...
        if crop:
            genes = [
                g for g in genes if g["crop"].lower() == crop.lower() or g["crop"] == "Multiple"
            ]
    ...
    def record_screening(
        ...
        reduction = (
            ((control_value - stress_value) / control_value) * 100 if control_value > 0 else 0
        )
    ...
    def calculate_stress_indices(
        ...
        # Harmonic Mean (HM)
        hm = (
            (2 * control_yield * stress_yield) / (control_yield + stress_yield)
            if (control_yield + stress_yield) > 0
            else 0
        )
    ...
    def get_tolerance_profile(self, genotype_id: str) -> dict:
        ...
        for stress_id, screenings in self.screenings.items():
            ...
            if genotype_screenings:
                ...
                avg_index = sum(s["stress_index"] for s in genotype_screenings) / len(
                    genotype_screenings
                )
