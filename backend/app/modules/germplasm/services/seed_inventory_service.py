...
class SeedLotDTO:
    ...
    accession_uuid: str | None # UUID link
    species: str
    variety: str
    harvest_date: date
    ...
    current_viability: float | None = None
    last_viability_test: date | None = None
    status: str = "active"
    notes: str = ""
...
class SeedInventoryService:
    ...
    async def get_lot(self, db: AsyncSession, lot_id: str) -> dict[str, Any] | None:
    ...
    async def approve_request(
        ...
        if not lot:
             raise ValueError("Lot for request not found")
...
# Singleton
_seed_inventory_service: SeedInventoryService | None = None
