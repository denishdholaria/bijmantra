...
class SeedTraceabilityService:
    ...
    def list_lots(
        ...
        if crop:
            lots = [lot for lot in lots if lot["crop"].lower() == crop.lower()]
        if variety_id:
            lots = [lot for lot in lots if lot["variety_id"] == variety_id]
        if seed_class:
            lots = [lot for lot in lots if lot["seed_class"] == seed_class]
        if status:
