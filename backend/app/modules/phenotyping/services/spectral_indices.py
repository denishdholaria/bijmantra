...
def _prepare_image(
    ...
    channels: tuple[np.ndarray, ...] | None = None
    ...
    if image_path:
        if cv2 is None:
            logger.warning("OpenCV not installed, skipping image loading")
...
def calculate_ccc(
    ...
    r_image_path: str | None = None,
    g_image_path: str | None = None,
    b_image_path: str | None = None,
