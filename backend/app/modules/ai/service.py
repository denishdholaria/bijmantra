		...
		*,
		...
		for provider in providers:
			...
			if provider_type is None:
				logger.warning("[REEVU] Skipping unsupported persisted provider: %s", provider.provider_key)
				continue
			...
			if not model_name:
				logger.warning("[REEVU] Skipping provider %s without a model", provider.provider_key)
				continue
