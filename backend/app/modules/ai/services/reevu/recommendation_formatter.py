...
class RecommendationFormatter:
    ...
    def format_comparison(
        ...
        *,
        ...
        - ``calculation_method_refs``: deterministic scoring methods (optional)
        ...
        for rank, candidate in enumerate(sorted_candidates, start=1):
            ...
            items.append(
                RankedItem(
                    ...
                    calculation_method_refs=candidate.get("calculation_method_refs", []),
        ...
        return ComparisonResult(
            ...
            calculation_method_refs=calculation_method_refs or [],
