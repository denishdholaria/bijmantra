...
Always consider the practical constraints of PhD research (time, resources, scope)."""
    ...
    async def generate_rag_response(
        ...
        3. Reasoning Trace Logging (REEVU cognitive layer)
        """
        ...
        reevu_service = ReevuService(self.db)
        ...
        try:
            ...
            if user:
                ...
                concept_trace = await reevu_service.log_reasoning_trace(
                    user=user,
                ...
                # Log the "Conclusion"
                await reevu_service.log_reasoning_trace(
                    user=user,
