...
async def handle_get(
    ...
    *,
    ...
    # Resolved via deferred import to avoid service → API layer dependency in tools.py
    if shared.get_trial_summary is not None:
        get_trial_summary = shared.get_trial_summary
    else:
        from app.api.bijmantra.trials.trial_summary import get_trial_summary  # noqa: PLC0415
    if shared.get_comparison_statistics is not None:
        get_comparison_statistics = shared.get_comparison_statistics
    else:
        from app.api.bijmantra.phenotyping.phenotype_comparison import get_comparison_statistics  # noqa: PLC0415
    ...
    if function_name == "get_germplasm_details":
        ...
        try:
            ...
            plan_execution_summary = _build_single_contract_plan_execution_summary(
                ...
                completed=True,
                services=["app.api.bijmantra.trial_summary.get_trial_summary"],
