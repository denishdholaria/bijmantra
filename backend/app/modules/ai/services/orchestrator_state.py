    ...
    async def list_missions(
        ...
        *,
        ...
        if owner is not None:
            missions = [mission for mission in missions if mission.owner == owner]
        if queue_job_id is not None:
            missions = [mission for mission in missions if mission.queue_job_id == queue_job_id]
        if source_lane_id is not None:
            missions = [mission for mission in missions if mission.source_lane_id == source_lane_id]
        return missions
