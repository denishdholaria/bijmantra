...
from app.modules.ai.services.reevu_cognitive_service import ReevuCognitiveService
...
class VeenaService:
    def __init__(self, db: AsyncSession):
        self.db = db
        self.cognitive = ReevuCognitiveService(db)
    ...
    async def store_memory(
        ...
        return await self.cognitive.store_memory(
            user_id,
            interaction_data,
