...
class GroupService:
    ...
    async def update_group(self, group_id: int, user_id: int, group_in: GroupUpdate) -> Group | None:
    ...
    async def join_group(self, user_id: int, group_id: int) -> GroupMember | None:
        # Verify group exists
