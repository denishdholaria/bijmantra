...
from app.models.social import Comment, Post, Reaction, TargetType
from app.schemas.social import CommentCreate, PostCreate, PostUpdate, ReactionCreate
...
class ContentService:
    ...
    async def update_post(self, post_id: int, user_id: int, post_in: PostUpdate) -> Post | None:
    ...
    async def create_comment(self, user_id: int, post_id: int, comment_in: CommentCreate) -> Comment | None:
