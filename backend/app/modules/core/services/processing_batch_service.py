...
class ProcessingBatchService:
    ...
    def start_stage(
        ...
        operator: str,
        equipment: str = "",
        input_quantity_kg: float | None = None,
    ...
    def complete_stage(
        ...
        stage_record.loss_percent = (
            (stage_record.loss_kg / stage_record.input_quantity_kg * 100)
            if stage_record.input_quantity_kg > 0
            else 0
        )
    ...
    def get_stage_summary(self, batch_id: str) -> dict:
        ...
        total_loss_percent = (
            (total_loss / batch.input_quantity_kg * 100) if batch.input_quantity_kg > 0 else 0
        )
        ...
        return {
            ...
            "stages_completed": sum(
                1 for s in batch.stages if isinstance(s, StageRecord) and s.status == "completed"
            ),
        ...
        return [
            {
                ...
                "name": "Receiving",
                "order": 1,
                "description": "Receive raw seed from field",
            },
            {
                "id": "pre_cleaning",
                "name": "Pre-Cleaning",
                "order": 2,
                "description": "Remove large debris and foreign matter",
            },
            {
                "id": "drying",
                "name": "Drying",
                "order": 3,
                "description": "Reduce moisture content",
            },
            {
                "id": "cleaning",
                "name": "Cleaning",
                "order": 4,
                "description": "Remove weed seeds and inert matter",
            },
            {
                "id": "grading",
                "name": "Grading",
                "order": 5,
                "description": "Size grading and separation",
            },
            {
                "id": "treating",
                "name": "Treating",
                "order": 6,
                "description": "Apply seed treatment chemicals",
            },
            {
                "id": "packaging",
                "name": "Packaging",
                "order": 7,
                "description": "Pack into bags/containers",
            },
            {
                "id": "labeling",
                "name": "Labeling",
                "order": 8,
                "description": "Apply labels and tags",
            },
            {
                "id": "storage",
                "name": "Storage",
                "order": 9,
                "description": "Move to storage location",
            },
            {
                "id": "completed",
                "name": "Completed",
