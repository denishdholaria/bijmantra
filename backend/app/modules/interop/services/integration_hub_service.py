...
class IntegrationHubService:
    ...
    def __init__(self):
        ...
        if not key:
            ...
            print("[IntegrationHub] Generated encryption key (set INTEGRATION_ENCRYPTION_KEY in production)")
    ...
    def get_integration(self, integration_id: str) -> UserIntegration | None:
        """Get a specific integration"""
        return self._integrations.get(integration_id)

    def get_decrypted_credentials(self, integration_id: str) -> dict[str, str] | None:
