...
from app.models.dus import DUSEntry as DUSEntryModel
from app.models.dus import DUSScore as DUSScoreModel
from app.models.dus import DUSTrial as DUSTrialModel
...
try:
    from app.modules.interop.services.dus_crops_service import ADDITIONAL_CROP_TEMPLATES
...
class DUSTestingService:
    ...
    def get_crop_template(self, crop_code: str) -> CropTemplate | None:
