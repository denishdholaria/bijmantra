...
class MapsService:
    ...
    async def get_map(self, db: AsyncSession, map_db_id: str) -> GenomeMap | None:
    ...
    async def update_map(self, db: AsyncSession, map_db_id: str, map_data: GenomeMapUpdate) -> GenomeMap | None:
