...
from app.modules.genomics.compute.analytics.etl_service import etl_service
...
class PhenotypeExtractor:
    """
    Service for extracting phenotype data from PostgreSQL and syncing analytical exports to MinIO.
    """

    def run_daily_sync(self) -> dict:
        """
        Run the daily sync job for phenotype data.
        Extracts key tables and uploads them as parquet files to the raw export bucket.
        """
        tables = [
            "observations",
            "observation_units",
