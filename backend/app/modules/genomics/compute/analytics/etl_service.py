...
class ETLService:
    """
    ETL service for analytical exports.
    ...
    def extract_to_parquet(
        self, query: str, bucket: str, folder: str, filename_prefix: str
    ) -> dict:
        """
        Execute SQL query, convert to Parquet, and upload to object storage.
