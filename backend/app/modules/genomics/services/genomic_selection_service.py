...
from app.models.genotyping import CallSet, Variant
...
class GenomicSelectionService:
    ...
    def run_gblup(
        ...
        V_star = G + identity_matrix * lambda_val
    ...
    async def list_models(
        ...
        """
        stmt = select(GSModel).where(GSModel.organization_id == organization_id)
