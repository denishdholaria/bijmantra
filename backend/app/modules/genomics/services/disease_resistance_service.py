...
class DiseaseResistanceService:
    ...
    def _init_sample_data(self):
        ...
        genes = [
            ...
            },
            {
                ...
                "chromosome": "1B",
                "type": "R-gene",
                "mechanism": "hypersensitive response",
            },
            {
                "gene_id": "GENE-008",
                "name": "Lr34",
    ...
    def get_pyramid(self, pyramid_id: str) -> dict | None:
        ...
        return [
            {
                ...
                "score_range": "0-1",
                "description": "No visible symptoms",
            },
            {
                "code": "R",
                "name": "Resistant",
                "score_range": "1-3",
                "description": "Minor symptoms, no yield loss",
            },
            {
                "code": "MR",
                "name": "Moderately Resistant",
                "score_range": "3-5",
                "description": "Some symptoms, minimal yield loss",
            },
            {
                "code": "MS",
                "name": "Moderately Susceptible",
                "score_range": "5-7",
                "description": "Moderate symptoms and yield loss",
            },
            {
                "code": "S",
                "name": "Susceptible",
                "score_range": "7-9",
                "description": "Severe symptoms, significant yield loss",
            },
            {
                "code": "HS",
                "name": "Highly Susceptible",
                "score_range": "9",
                "description": "Plant death or complete yield loss",
            },
        ]
