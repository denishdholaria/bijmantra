...
class MolecularBreedingService:
    ...
    async def get_introgression_lines(
        ...
        foreground_status: str | None = None,
    ) -> list[dict[str, Any]]:
    ...
    async def get_statistics(
        ...
        return {
            ...
            "fixed_lines": len([line for line in lines if line.get("foreground_status") == "fixed"]),
    ...
    async def get_pyramiding_matrix(
        ...
        genes = list({line.get("target_gene") for line in lines if line.get("target_gene")})
