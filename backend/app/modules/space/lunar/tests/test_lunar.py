...
class TestGravityModel:
    ...
    def test_determinism(self):
        ...
        self.engine.simulate(self.profile_base, generation=1, germplasm_id=456)
    ...
    def test_photoperiod_stress(self):
        ...
        profile_better = self.profile_base.model_copy(
            update={"light_cycle_days": 1.0, "dark_cycle_days": 1.0}
        )
    ...
    def test_anchorage_failure(self):
        ...
        profile = self.profile_base.model_copy(
            update={"root_support_factor": 0.0, "gravity_factor": 0.1}
        )
