...
class FractionalGravityEnvironmentEngine:
    def simulate(
        self, profile: LunarEnvironmentProfileBase, generation: int, germplasm_id: int
    ) -> dict:
        """
        ...
        morphology_stability = gravity_stability * (
            1.0 - (photoperiod_stress / photoperiod_tolerance)
        )
