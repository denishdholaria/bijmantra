...
async def get_integration_info(integration_id: str):
    ...
    adapter = adapter_class(IntegrationConfig())
    return {
        "id": integration_id,
        ...
        "capability_tags": adapter.capability_tags,
        "function_mappings": adapter.function_mappings,
        "adapter_type": adapter.adapter_type,
        "performance_profile": adapter.performance_profile,
    }
