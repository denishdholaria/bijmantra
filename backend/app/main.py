...
app.include_router(crop_suitability.router, prefix="/api/v2", tags=["Crop Suitability"])
app.include_router(gdd.router, prefix="/api/v2", tags=["Growing Degree Days"])
app.include_router(soil_test.router, prefix="/api/v2", tags=["Soil Tests"])
app.include_router(fertilizer_recommendation.router, prefix="/api/v2", tags=["Fertilizer Recommendations"])
app.include_router(soil_health.router, prefix="/api/v2", tags=["Soil Health"])
app.include_router(carbon_sequestration.router, prefix="/api/v2", tags=["Carbon Sequestration"])
app.include_router(pest_observation.router, prefix="/api/v2", tags=["Pest Observations"])
app.include_router(disease_risk_forecast.router, prefix="/api/v2", tags=["Disease Risk Forecasts"])
app.include_router(spray_application.router, prefix="/api/v2", tags=["Spray Applications"])
app.include_router(ipm_strategy.router, prefix="/api/v2", tags=["IPM Strategies"])
app.include_router(irrigation_schedule.router, prefix="/api/v2", tags=["Irrigation Schedules"])
app.include_router(water_balance.router, prefix="/api/v2", tags=["Water Balance"])
app.include_router(soil_moisture.router, prefix="/api/v2", tags=["Soil Moisture"])
