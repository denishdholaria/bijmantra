...
# Health check — dependency-aware (ADR-003)
@app.get("/health")
...
def _load_metrics_sync(path: Path) -> dict[str, int]:
    ...
    return {
        ...
        "brapiEndpoints": api_metrics.get("brapiEndpoints", 202),
...
# Core Domain Module (Authorization, Audit, System Management)
...
# Worker Monitoring
from app.api.v2 import workers, monitoring
...
# app.include_router(weather.router, prefix="/api/v2", tags=["Weather Intelligence"])  # Now in environment_router

# Weather Module
# from app.modules.weather.router import router as weather_module_router
# app.include_router(weather_module_router, prefix="/api/v2", tags=["Weather Service Connection"])  # Now in environment_router

# app.include_router(climate.router, prefix="/api/v2", tags=["Climate Analysis"])  # Now in environment_router
...
# app.include_router(environmental_router, prefix="/api/v2/environmental", tags=["Environmental Physics"])  # Now in environment_router
...
# Spatial Analysis (GIS & Remote Sensing) - NOW CONSOLIDATED IN spatial_router above
...
# app.include_router(chat.router, prefix="/api/v2", tags=["Veena AI Chat"])  # Now in ai_router
app.include_router(proposals.router, prefix="/api/v2", tags=["Proposals (AI Scribe)"])
# app.include_router(crosses.router, prefix="/api/v2", tags=["Cross Prediction"])  # Now in breeding_router
# app.include_router(integrations.router, prefix="/api/v2", tags=["Integration Hub"])  # Now in interop_router
...
# app.include_router(field_environment.router, prefix="/api/v2", tags=["Field Environment"])  # Now in environment_router
# app.include_router(voice.router, prefix="/api/v2", tags=["Veena Voice"])  # Now in ai_router
app.include_router(gxe.router, prefix="/api/v2", tags=["G×E Analysis"])
# app.include_router(gwas.router, prefix="/api/v2", tags=["GWAS"])  # Now in genomics_router
app.include_router(bioinformatics.router, prefix="/api/v2", tags=["Bioinformatics"])
# app.include_router(pedigree.router, prefix="/api/v2", tags=["Pedigree Analysis"])  # Now in breeding_router
# app.include_router(phenotype.router, prefix="/api/v2", tags=["Phenotype Analysis"])  # Now in phenotyping_router
# app.include_router(mas.router, prefix="/api/v2", tags=["Marker-Assisted Selection"])  # Now in genomics_router
# app.include_router(trial_design.router, prefix="/api/v2", tags=["Trial Design"])  # Now in breeding_router
...
# ============================================
# BREEDING DOMAIN ROUTER (Consolidated)
# ============================================
# Consolidates all breeding-related endpoints under domain organization
# Individual routers below are now included via the breeding domain router
app.include_router(breeding_router)

# ============================================
# GENOMICS DOMAIN ROUTER (Consolidated)
# ============================================
# Consolidates all genomics-related endpoints under domain organization
# Individual routers below are now included via the genomics domain router
app.include_router(genomics_router)

# ============================================
# PHENOTYPING DOMAIN ROUTER (Consolidated)
# ============================================
# Consolidates all phenotyping-related endpoints under domain organization
# Individual routers below are now included via the phenotyping domain router
app.include_router(phenotyping_router)

# ============================================
# GERMPLASM DOMAIN ROUTER (Consolidated)
# ============================================
# Consolidates all germplasm-related endpoints under domain organization
# Individual routers below are now included via the germplasm domain router
app.include_router(germplasm_router)

# ============================================
# ENVIRONMENT DOMAIN ROUTER (Consolidated)
# ============================================
# Consolidates all environment-related endpoints under domain organization
# Includes: Weather Intelligence, Climate Analysis, Field Environment, Environmental Physics, Weather Service
# Individual routers below are now included via the environment domain router
app.include_router(environment_router)

# ============================================
# SPATIAL DOMAIN ROUTER (Consolidated)
# ============================================
# Consolidates all spatial-related endpoints under domain organization
# Includes: Spatial Analysis (GIS queries), Field Mapping, Yield Mapping
# Individual routers below are now included via the spatial domain router
app.include_router(spatial_router)

# ============================================
# AI DOMAIN ROUTER (Consolidated)
# ============================================
# Consolidates all AI-related endpoints under domain organization
# Includes: Veena AI, DevGuru, REEVU Chat, Computer Vision, Voice Interaction
# Individual routers below are now included via the AI domain router
from app.modules.ai.router import router as ai_router
app.include_router(ai_router)

# ============================================
# INTEROP DOMAIN ROUTER (Consolidated)
# ============================================
# Consolidates all interoperability and external integration endpoints under domain organization
# Includes: Integration Hub, GRIN-Global, Genesys, BrAPI
# Individual routers below are now included via the interop domain router
...
# app.include_router(passport.router, prefix="/api/v2", tags=["Germplasm Passport"])  # Now in germplasm_router
app.include_router(ontology.router, prefix="/api/v2", tags=["Trait Ontology"])

# Breeding-related routers - NOW CONSOLIDATED IN breeding_router above
...
# app.include_router(selection.router, prefix="/api/v2", tags=["Selection Index"])  # Now in breeding_router
...
# app.include_router(spatial.router, prefix="/api/v2", tags=["Spatial Analysis"])  # Now in spatial_router
# app.include_router(breeding_value.router, prefix="/api/v2", tags=["Breeding Value"])  # Now in breeding_router
...
# app.include_router(vision.router, prefix="/api/v2", tags=["Vision Training Ground"])  # Now in ai_router
...
# app.include_router(grin.router, prefix="/api/v2", tags=["GRIN-Global Integration"])  # Now in interop_router
...
# app.include_router(devguru.router, prefix="/api/v2", tags=["DevGuru PhD Mentor"])  # Now in ai_router
# app.include_router(selection_decisions.router, prefix="/api/v2", tags=["Selection Decisions"])  # Now in breeding_router
# app.include_router(parent_selection.router, prefix="/api/v2", tags=["Parent Selection"])  # Now in breeding_router
...
# app.include_router(germplasm_comparison.router, prefix="/api/v2", tags=["Germplasm Comparison"])  # Now in germplasm_router
# app.include_router(breeding_pipeline.router, prefix="/api/v2", tags=["Breeding Pipeline"])  # Now in breeding_router
app.include_router(genetic_diversity.router, prefix="/api/v2", tags=["Genetic Diversity"])
# app.include_router(population_genetics.router, prefix="/api/v2", tags=["Population Genetics"])  # Now in genomics_router
# app.include_router(qtl_mapping.router, prefix="/api/v2", tags=["QTL Mapping"])  # Now in genomics_router
# app.include_router(genomic_selection.router, prefix="/api/v2", tags=["Genomic Selection"])  # Now in genomics_router
# app.include_router(genotyping.router, prefix="/api/v2", tags=["BrAPI Genotyping"])  # Now in genomics_router
# app.include_router(crossing_planner.router, prefix="/api/v2", tags=["Crossing Planner"])  # Now in breeding_router
# app.include_router(field_map.router, prefix="/api/v2", tags=["Field Map"])  # Now in spatial_router
# app.include_router(trial_planning.router, prefix="/api/v2", tags=["Trial Planning"])  # Now in breeding_router
app.include_router(data_quality.router, prefix="/api/v2", tags=["Data Quality"])
# app.include_router(parentage.router, prefix="/api/v2", tags=["Parentage Analysis"])  # Now in genomics_router
# app.include_router(haplotype.router, prefix="/api/v2", tags=["Haplotype Analysis"])  # Now in genomics_router
# app.include_router(trial_network.router, prefix="/api/v2", tags=["Trial Network"])  # Now in breeding_router
# app.include_router(germplasm_search.router, prefix="/api/v2", tags=["Germplasm Search"])  # Now in germplasm_router
# app.include_router(molecular_breeding.router, prefix="/api/v2", tags=["Molecular Breeding"])  # Now in genomics_router
# app.include_router(phenomic_selection.router, prefix="/api/v2", tags=["Phenomic Selection"])  # Now in phenotyping_router
# app.include_router(speed_breeding.router, prefix="/api/v2", tags=["Speed Breeding"])  # Now in breeding_router
...
# app.include_router(phenology.router, prefix="/api/v2", tags=["Phenology Tracker"])  # Now in phenotyping_router
...
# app.include_router(germplasm_collection.router, prefix="/api/v2", tags=["Germplasm Collections"])  # Now in germplasm_router
...
# Yield Map - NOW CONSOLIDATED IN spatial_router above
# app.include_router(yield_map.router, prefix="/api/v2", tags=["Yield Map"])

# Phenotype Comparison - NOW CONSOLIDATED IN phenotyping_router above
