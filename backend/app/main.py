...
try:
    ...
    print("[Audit] Audit middleware enabled")
except Exception as e:
    print(f"[Audit] Audit middleware not available: {e}")
...
if os.getenv("ENVIRONMENT", "development") == "development":
    try:
        ...
        print("[DX] Route profiler middleware enabled")
    except Exception as e:
        print(f"[DX] Route profiler unavailable: {e}")
...
from app.api.v2 import pwa_sync, pwa_notifications
...
from app.api.v2 import (
    ...
    carbon, emissions, impact, proposals, yield_gap
)
