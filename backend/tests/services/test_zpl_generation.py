import pytest
from app.modules.core.services.label_printing_service import generate_zpl_label, label_printing_service
...
def test_generate_zpl_barcodes():
    ...
    # QR Code
    template_qr = {"width_mm": 50, "height_mm": 25, "fields": ["barcode"], "barcode_type": "qr"}
...
def test_service_generate_label():
    ...
    data = {"plot_id": "P001", "germplasm": "Wheat-1", "rep": "1", "barcode": "BARCODE123"}
