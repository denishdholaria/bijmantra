...
from app.modules.genomics.compute.analytics.etl_phenotype_extractor import PhenotypeExtractor
...
@patch("app.modules.genomics.compute.analytics.etl_phenotype_extractor.etl_service")
