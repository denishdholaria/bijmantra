...
from app.services.analytics.custom_report_weasyprint_engine import CustomReportEngine

# Mock weasyprint availability for testing
@pytest.fixture
def mock_weasyprint():
    with patch("app.services.analytics.custom_report_weasyprint_engine.WEASYPRINT_AVAILABLE", True), \
         patch("app.services.analytics.custom_report_weasyprint_engine.HTML") as MockHTML, \
         patch("app.services.analytics.custom_report_weasyprint_engine.CSS") as MockCSS:
...
def mock_weasyprint_unavailable():
    with patch("app.services.analytics.custom_report_weasyprint_engine.WEASYPRINT_AVAILABLE", False):
        yield
