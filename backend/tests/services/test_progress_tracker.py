...
from app.modules.core.services.progress_tracker_service import ProgressTrackerService, load_metrics_json
...
async def test_get_data_async(progress_service):
    with patch("app.modules.core.services.progress_tracker_service.load_metrics_json", return_value=MOCK_METRICS) as mock_load:
...
async def test_get_summary_async(progress_service):
    with patch("app.modules.core.services.progress_tracker_service.load_metrics_json", return_value=MOCK_METRICS):
