...
cv2 = pytest.importorskip(
    ...
    reason="OpenCV native runtime is unavailable; antivirus may quarantine bundled dylibs.",
)

from app.modules.ai.services.ml_bounding_box_extractor_service import ml_bounding_box_extractor
...
class TestMLBoundingBoxExtractor:
    ...
    @patch("app.modules.ai.services.ml_bounding_box_extractor_service.vision_model_service")
