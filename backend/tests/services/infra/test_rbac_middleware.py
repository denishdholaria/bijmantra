...
# Import middleware
from app.services.infra.rbac_row_level_security_middleware import (
...
def test_middleware_extracts_token_context():
    async def _run():
        ...
        from app.services.infra.rbac_row_level_security_middleware import decode_access_token
...
def test_middleware_fetches_missing_context(mock_session):
    async def _run():
        ...
        from app.services.infra.rbac_row_level_security_middleware import decode_access_token, AsyncSessionLocal
        decode_access_token.return_value = mock_payload
...
def test_get_rbac_db_sets_session_variables(mock_session):
    async def _run():
        ...
        from app.services.infra.rbac_row_level_security_middleware import AsyncSessionLocal
        AsyncSessionLocal.return_value.__aenter__.return_value = mock_session
