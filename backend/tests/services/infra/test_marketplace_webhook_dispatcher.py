...
from app.services.infra.marketplace_webhook_dispatcher import MarketplaceWebhookDispatcher, WebhookPayload
...
def override_dependency(mock_dispatcher):
    ...
    from app.services.infra.marketplace_webhook_dispatcher import dispatcher
