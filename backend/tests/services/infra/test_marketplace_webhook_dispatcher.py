...
from app.api.bijmantra.system.marketplace import router
...
def override_dependency(mock_dispatcher):
    ...
    # In api/bijmantra/system/marketplace.py:
    ...
    import app.api.bijmantra.system.marketplace as marketplace_module
