...
from app.api.bijmantra.ai.chat import get_reevu_service
from app.services.chat.message_service import MessageService

# Compatibility aliases for extracted functions
_build_evidence_pack = MessageService.build_evidence_pack
_build_safe_failure_payload = MessageService.build_safe_failure_payload
_extract_claims_for_validation = MessageService.extract_claims_for_validation
...
class TestChatPolicyValidationEndpoint:
    ...
    def client(self, mock_breeding_service):
        ...
        from app.api.bijmantra.ai.chat import get_breeding_service, router
    ...
    def test_chat_function_path_policy_validation_emits_actionable_safe_failure(self, client):
        ...
        with patch(
            ...
            "app.modules.ai.services.tools.FunctionExecutor.execute",
