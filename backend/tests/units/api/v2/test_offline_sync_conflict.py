...
from app.api.bijmantra.data.offline_sync import resolve_conflict
...
class TestResolveConflict:
    ...
    @patch("app.api.bijmantra.offline_sync.get_model_class", return_value=Trial)
    ...
    async def test_resolve_conflict_merge_deep_merge_json(self, mock_get_model):
        ...
        self.db.get.return_value = existing_trial
        self.sync_item.local_data = {"additional_info": {"b": {"d": 3}, "e": 4}}
