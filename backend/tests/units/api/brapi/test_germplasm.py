...
def auto_patch_deps():
    with patch('app.api.brapi.v2.germplasm.get_db', return_value=mock_db), \
         patch('app.api.brapi.v2.germplasm.get_current_user', return_value=mock_user), \
         patch('app.api.brapi.v2.germplasm.get_optional_user', return_value=mock_user):
        yield
