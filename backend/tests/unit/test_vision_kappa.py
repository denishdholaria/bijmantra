...
from app.modules.phenotyping.services.vision.annotation_service import QualityControlService
...
class TestKappaCalculationService(unittest.TestCase):
    ...
    def test_perfect_agreement(self):
        ...
        result = self.run_async(
            self.service.calculate_inter_annotator_agreement(self.db, self.org_id, annotations)
        )
    ...
    def test_random_agreement(self):
        ...
        self.assertEqual(
            result["interpretation"], "Poor agreement"
        )  # 0.0 is <= 0.2? Wait, 0.0 is Poor?
