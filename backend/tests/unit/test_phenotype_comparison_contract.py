...
async def test_observations_endpoint_includes_contract_metadata():
    ...
    with patch(
        "app.api.bijmantra.phenotyping.phenotype_comparison._load_germplasm_by_external_ids",
        new=AsyncMock(return_value=[observation.germplasm]),
    ), patch(
        "app.api.bijmantra.phenotyping.phenotype_comparison._load_observations",
...
async def test_compare_endpoint_includes_contract_metadata_and_interpretation():
    ...
    with patch(
        ...
        "app.api.bijmantra.phenotyping.phenotype_comparison._build_interpretation_records",
        return_value=[],
    ), patch(
        "app.api.bijmantra.phenotyping.phenotype_comparison.phenotype_interpretation_service.build_interpretation",
...
async def test_statistics_endpoint_includes_contract_metadata_and_summary():
    ...
    with patch(
        ...
        "app.api.bijmantra.phenotyping.phenotype_comparison.select",
    ):
