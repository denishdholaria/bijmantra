...
from app.api.bijmantra.trials.trial_summary import (
...
async def test_trial_summary_response_includes_trust_contract_metadata():
    ...
    with patch(
        "app.api.bijmantra.trials.trial_summary._resolve_trial",
        new=AsyncMock(return_value=trial),
    ), patch(
        "app.api.bijmantra.trials.trial_summary._load_trial_numeric_records",
        new=AsyncMock(return_value=[]),
    ), patch(
        "app.api.bijmantra.trials.trial_summary._build_trial_info",
        return_value={"trialDbId": "TRIAL-1", "trialName": "Yield Trial"},
    ), patch(
        "app.api.bijmantra.trials.trial_summary._build_top_performers_from_interpretation",
        return_value=[],
    ), patch(
        "app.api.bijmantra.trials.trial_summary._build_trait_summary",
        return_value=[],
    ), patch(
        "app.api.bijmantra.trials.trial_summary._build_location_performance",
        return_value=[],
    ), patch(
        "app.api.bijmantra.trials.trial_summary._build_trial_statistics",
        return_value={"grand_mean": 0.0},
    ), patch(
        "app.api.bijmantra.trials.trial_summary._build_trial_interpretation_records",
        return_value=[],
    ), patch(
        "app.api.bijmantra.trials.trial_summary._select_trial_baseline",
        return_value=(None, None, None),
    ), patch(
        "app.api.bijmantra.trials.trial_summary.phenotype_interpretation_service.build_interpretation",
