...
def test_intelligence_knowledge_graph_root_files_are_compatibility_shims() -> None:
    legacy_files = (
        ...
        "backend/app/domains/intelligence/adapters/knowledge_graph_legacy.py",
...
def test_new_backend_code_imports_knowledge_graph_capability_pack_not_root_shims() -> None:
    allowed_compatibility_files = {
        ...
        REPO_ROOT / "backend/app/domains/intelligence/adapters/knowledge_graph_legacy.py",
    ...
    forbidden_imports = (
        ...
        "app.domains.intelligence.adapters.knowledge_graph_legacy",
...
def test_intelligence_knowledge_graph_retrieval_candidate_builder_owns_grouping() -> None:
    ...
    assert "KnowledgeGraphRetrievalCandidatesBuilder" in service_source
    assert "LegacyKnowledgeGraphRetrievalDataSource" in service_source
...
def test_intelligence_knowledge_graph_persistence_adapter_owns_sqlalchemy_queries() -> None:
    ...
    assert "SqlAlchemyKnowledgeGraphPersistence" in service_source
...
def test_intelligence_knowledge_graph_evidence_search_builder_owns_response_assembly() -> None:
    ...
    assert "KnowledgeGraphEvidenceSearchBuilder" in service_source
    assert "LegacyKnowledgeGraphEvidenceSearchDataSource" in service_source
...
def test_intelligence_knowledge_graph_evidence_pack_builder_owns_response_assembly() -> None:
    ...
    assert "KnowledgeGraphEvidencePackBuilder" in service_source
    assert "LegacyKnowledgeGraphEvidencePackDataSource" in service_source
