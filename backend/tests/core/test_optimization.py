...
class TestOptimization:
    ...
    @pytest.mark.asyncio
    @pytest.mark.skip(reason="run_async_task method not implemented in ComputeEngine")
    ...
    @pytest.mark.skip(reason="compute_grm_numpy_kernel function not implemented")
