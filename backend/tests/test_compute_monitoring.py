...
from app.api.bijmantra.monitoring.monitoring import (
...
def mock_task_queue():
    ...
    with patch("app.api.bijmantra.monitoring.monitoring.task_queue") as mock:
...
def mock_redis():
    """Mock Redis client"""
    with patch("app.api.bijmantra.monitoring.monitoring.redis_client") as mock:
