...
async def test_stats_unread_messages(
    ...
    conversation = Conversation(
        organization_id=test_user.organization_id, name="Test Chat", type=ConversationType.DIRECT
    )
    ...
    part2 = ConversationParticipant(conversation_id=conversation.id, user_id=second_user.id)
    ...
    msg = Message(conversation_id=conversation.id, sender_id=second_user.id, content="Hello")
