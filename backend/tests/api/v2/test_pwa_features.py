...
@pytest.mark.asyncio
async def test_pwa_subscribe_returns_503_when_redis_is_required(authenticated_client: AsyncClient, monkeypatch: pytest.MonkeyPatch):
    ...
    response = await authenticated_client.post("/api/v2/pwa/notifications/subscribe", json={
