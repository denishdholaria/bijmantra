...
class TestWeatherSyncLogic:
    ...
    def test_weather_data_response_structure(self):
        ...
        response = WeatherDataResponse(
            ...
            quality_score=0.95,
            confidence={"type": "qualitative", "value": 0.95, "basis": "data_quality_validation"},
            validity_conditions=["temperature_data_within_climatological_norms"],
            provenance={
    ...
    def test_batch_sync_response_format(self):
        ...
        response = {
            ...
            "metadata": {
                ...
                "validity_conditions": ["successful_syncs_2_of_2"],
                "provenance": {
    ...
    def test_sync_status_response_format(self):
        ...
        response = {
            ...
            "metadata": {
                ...
                "validity_conditions": ["cache_coverage_93percent", "redis_connection_available"],
                "provenance": {
