...
def check_migrations():
    ...
    try:
        ...
        result = subprocess.run(
            ["venv/bin/alembic", "check"], cwd=str(BASE_DIR), capture_output=True, text=True
        )
...
def run_verification_scripts():
    ...
    scripts = ["scripts/verify_veena_chat.py", "scripts/verify_space.py"]
