...
- [Architecture Stabilization Spec](.kiro/specs/architecture-stabilization/)
- [Architecture Rules](../docs-private/architecture/ARCHITECTURE_RULES.md)
- [Domain Registry](../app/domain_registry.yaml)
- [Service Migration Map](../docs-private/architecture/service_migration_map.md)
