...
|---------|-----|-------------|
| Frontend | http://localhost:5173 | React PWA (249 pages) |
| Backend API | http://localhost:8000 | FastAPI server (1,728 endpoints) |
| API Docs | http://localhost:8000/docs | Swagger UI |
| ReDoc | http://localhost:8000/redoc | Alternative docs |
| BrAPI | http://localhost:8000/brapi/v2 | BrAPI v2.1 (202 endpoints, 100% coverage) |
...
3. **Review contributor workflow**: See `CONTRIBUTING.md` and `AGENTS.md`
4. **Check metrics**: See `metrics.json` for current stats
5. **Start coding**: Follow the active repo workflow in `.github/copilot-instructions.md`
...
### Backend ✅ (1,728 API Endpoints)

| Module | Endpoints | Description |
|--------|-----------|-------------|
| BrAPI v2.1 | 202 | 100% coverage (Core, Germplasm, Phenotyping, Genotyping) |
...
### Frontend ✅ (249 Pages, 239 Functional)
