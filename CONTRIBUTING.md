...
- active `.ai/decisions/` and `.ai/tasks/` artifacts relevant to your work

If you disagree with the philosophy, discuss before coding.

For repeatable work, prefer the packaged repo surfaces instead of rewriting operator instructions:
- `.github/instructions/` for path-scoped rules
- `.github/prompts/` for repeatable task kickoffs
- `.github/skills/` for repeatable specialist workflows
...
2. **Read the active workflow surfaces**: `AGENTS.md`, `.github/copilot-instructions.md`, and `metrics.json`
...
> *"Understanding one domain without seeing its interaction with others produces incomplete, sometimes misleading conclusions."* — Hare Krishna
...
All claims must be evidence-based. Documentation that overstates readiness undermines trust. We'd rather correct errors publicly than have users discover them unexpectedly.
