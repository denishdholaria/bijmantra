...
surreal_url = os.getenv("SURREALDB_URL", "http://localhost:8082")
surreal_ns = os.getenv("SURREALDB_NAMESPACE", "bijmantra")
surreal_db = os.getenv("SURREALDB_DATABASE", "science")
surreal_user = os.getenv("SURREALDB_USER", "root")
surreal_pass = os.getenv("SURREALDB_PASSWORD", "root")

auth_str = f"{surreal_user}:{surreal_pass}"
...
headers = {
    ...
    "NS": surreal_ns,
    "DB": surreal_db,
    # Auth: using env vars or default root:root
...
init_sql = f"DEFINE NAMESPACE {surreal_ns}; DEFINE DATABASE {surreal_db};"
try:
